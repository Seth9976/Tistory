...
public final class d extends LinearLayout {
    ...
    public d(TabLayout tabLayout0, Context context0) {
        this.b = tabLayout0;
        super(context0);
    ...
    public final void a(int v) {
        ...
        if(tabLayout0.U != 0 && (tabLayout0.getTabSelectedIndicator().getBounds().left != -1 || tabLayout0.getTabSelectedIndicator().getBounds().right != -1)) {
            return;
        }
        View view0 = this.getChildAt(v);
        Drawable drawable0 = tabLayout0.o;
        tabLayout0.I.getClass();
    ...
    public final void c(View view0, View view1, float f) {
        ...
        if(view0 == null || view0.getWidth() <= 0) {
            ...
            tabLayout0.I.b(tabLayout0, view0, view1, f, tabLayout0.o);
        }
