...
public final class d extends Lambda implements Function4 {
    ...
    public d(CarouselState carouselState0, CarouselPageSize carouselPageSize0, Function4 function40) {
    ...
    public final Object invoke(Object object0, Object object1, Object object2, Object object3) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-817308503, v1, -1, "androidx.compose.material3.carousel.Carousel.<anonymous> (Carousel.kt:310)");
        }
        ...
        CarouselKt.Carousel.2.clipShape.1.1 carouselKt$Carousel$2$clipShape$1$10 = composer0.rememberedValue();
        if(carouselKt$Carousel$2$clipShape$1$10 == composer$Companion0.getEmpty()) {
            carouselKt$Carousel$2$clipShape$1$10 = new CarouselKt.Carousel.2.clipShape.1.1(carouselItemInfoImpl0);
            composer0.updateRememberedValue(carouselKt$Carousel$2$clipShape$1$10);
        }
        ...
        if(z || b0 == composer$Companion0.getEmpty()) {
            b0 = new b(carouselPageSize0, 1);
            composer0.updateRememberedValue(b0);
        }
        Modifier modifier0 = CarouselKt.carouselItem(modifier$Companion0, v, this.w, b0, carouselItemInfoImpl0, carouselKt$Carousel$2$clipShape$1$10);
