...
public final class k extends SuspendLambda implements Function2 {
    ...
    public k(PullToRefreshModifierNode pullToRefreshModifierNode0, Continuation continuation0) {
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(this.o) {
            case 0: {
                ...
                float f = PullToRefreshModifierNode.access$getVerticalOffset(this.p) / ((float)this.p.f());
                this.o = 1;
                return this.p.getState().snapTo(f, this) == object1 ? object1 : Unit.INSTANCE;
            }
            case 1: {
                ResultKt.throwOnFailure(object0);
