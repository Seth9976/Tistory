...
public final class n extends SuspendLambda implements Function2 {
    ...
    public n(PullToRefreshModifierNode pullToRefreshModifierNode0, Continuation continuation0) {
        ...
        switch(this.o) {
            case 0: {
                ...
                if(pullToRefreshModifierNode0.isRefreshing()) {
                    this.o = 2;
                    if(pullToRefreshModifierNode0.d(this) == object1) {
                        return object1;
                    }
                }
                else {
                    this.o = 1;
                    if(pullToRefreshModifierNode0.c(this) == object1) {
                        return object1;
                    }
                }
