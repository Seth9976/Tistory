...
public final class u1 extends FragmentTransitionImpl {
    // 去混淆评级： 低(30)
    ...
    public final void addTargets(Object object0, ArrayList arrayList0) {
        ...
        if(!u1.a(((Transition)object0)) && FragmentTransitionImpl.isNullOrEmpty(((Transition)object0).getTargets())) {
    ...
    public final void scheduleHideFragmentView(Object object0, View view0, ArrayList arrayList0) {
        ((Transition)object0).addListener(new r1(view0, arrayList0));
    }
    ...
    public final void scheduleRemoveTargets(Object object0, Object object1, ArrayList arrayList0, Object object2, ArrayList arrayList1, Object object3, ArrayList arrayList2) {
        ((Transition)object0).addListener(new s1(this, object1, arrayList0, object2, arrayList1, object3, arrayList2));
    }

    @Override  // androidx.fragment.app.FragmentTransitionImpl
    public final void setEpicenter(Object object0, Rect rect0) {
        if(object0 != null) {
            ((Transition)object0).setEpicenterCallback(new q1(1, rect0));
        }
    }
    ...
    public final void setEpicenter(Object object0, View view0) {
        if(view0 != null) {
            ...
            ((Transition)object0).setEpicenterCallback(new q1(0, rect0));
        }
    }

    @Override  // androidx.fragment.app.FragmentTransitionImpl
    public final void setListenerForTransitionEnd(Fragment fragment0, Object object0, CancellationSignal cancellationSignal0, Runnable runnable0) {
        ((Transition)object0).addListener(new t1(runnable0));
    }
