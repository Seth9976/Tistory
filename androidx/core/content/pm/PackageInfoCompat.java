...
public final class PackageInfoCompat {
    public static long getLongVersionCode(@NonNull PackageInfo packageInfo0) {
        return Build.VERSION.SDK_INT < 28 ? ((long)packageInfo0.versionCode) : a.b(packageInfo0);
    }

    @NonNull
    public static List getSignatures(@NonNull PackageManager packageManager0, @NonNull String s) throws PackageManager.NameNotFoundException {
        Signature[] arr_signature;
        if(Build.VERSION.SDK_INT >= 28) {
            SigningInfo signingInfo0 = androidx.work.impl.background.systemjob.a.d(packageManager0.getPackageInfo(s, 0x8000000));
            if(a.d(signingInfo0)) {
                arr_signature = a.a(signingInfo0);
                return arr_signature == null ? Collections.emptyList() : Arrays.asList(arr_signature);
            }
            arr_signature = a.c(signingInfo0);
            return arr_signature == null ? Collections.emptyList() : Arrays.asList(arr_signature);
        }
    ...
    public static boolean hasSignatures(@NonNull PackageManager packageManager0, @NonNull String s, @NonNull @Size(min = 1L) Map map0, boolean z) throws PackageManager.NameNotFoundException {
        byte[] arr_b1;
        byte[][] arr2_b;
        if(map0.isEmpty()) {
            return false;
    ...
    label_4:
        ...
        if(!z && Build.VERSION.SDK_INT >= 28) {
            for(Object object1: set0) {
                if(!a.e(packageManager0, s, ((byte[])object1), ((int)(((Integer)map0.get(((byte[])object1))))))) {
                    return false;
                }
                if(false) {
                    break;
        ...
        if(list0.size() != 0 && map0.size() <= list0.size() && (!z || map0.size() == list0.size())) {
            if(map0.containsValue(1)) {
                ...
                for(int v = 0; v < list0.size(); ++v) {
                    byte[] arr_b = ((Signature)list0.get(v)).toByteArray();
                    try {
                        arr_b1 = MessageDigest.getInstance("SHA256").digest(arr_b);
                    }
                ...
                switch(((int)integer1)) {
                    ...
                    case 1: {
                        ...
                        while(v1 < arr2_b.length) {
                            if(!Arrays.equals(((byte[])object2), arr2_b[v1])) {
                                ++v1;
                                continue;
                            }
                            return true;
