...
public final class HandlerKt {
    @NotNull
    public static final Runnable postAtTime(@NotNull Handler handler0, long v, @Nullable Object object0, @NotNull Function0 function00) {
    ...
    @NotNull
    public static final Runnable postDelayed(@NotNull Handler handler0, long v, @Nullable Object object0, @NotNull Function0 function00) {
        Runnable runnable0 = new Runnable() {
            @Override
            public final void run() {
                function00.invoke();
