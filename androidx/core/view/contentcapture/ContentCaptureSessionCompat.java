...
public class ContentCaptureSessionCompat {
    ...
    public AutofillId newAutofillId(long v) {
        if(Build.VERSION.SDK_INT >= 29) {
            AutofillIdCompat autofillIdCompat0 = ViewCompat.getAutofillId(this.b);
            Objects.requireNonNull(autofillIdCompat0);
            return b.a(k.l(this.a), autofillIdCompat0.toAutofillId(), v);
        }
        return null;
    }
    ...
    public void notifyViewsDisappeared(@NonNull long[] arr_v) {
        ...
        View view0 = this.b;
        if(v >= 34) {
            AutofillIdCompat autofillIdCompat0 = ViewCompat.getAutofillId(view0);
            Objects.requireNonNull(autofillIdCompat0);
        ...
        if(v >= 29) {
            ...
            a.a(viewStructure0).putBoolean("TREAT_AS_VIEW_TREE_APPEARING", true);
            b.d(((ContentCaptureSession)object0), viewStructure0);
            AutofillIdCompat autofillIdCompat1 = ViewCompat.getAutofillId(view0);
