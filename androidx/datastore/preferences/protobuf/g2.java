...
public abstract class g2 {
    ...
    public static void a(int v, StringBuilder stringBuilder0) {
        while(true) {
            ...
            stringBuilder0.append(g2.a, 0, v1);
            v -= v1;
        }
    }
    ...
    public static void b(StringBuilder stringBuilder0, int v, String s, Object object0) {
        if(object0 instanceof List) {
            for(Object object1: ((List)object0)) {
                g2.b(stringBuilder0, v, s, object1);
            }
            return;
        }
        if(object0 instanceof Map) {
            for(Object object2: ((Map)object0).entrySet()) {
                g2.b(stringBuilder0, v, s, ((Map.Entry)object2));
            }
            return;
        }
        stringBuilder0.append('\n');
        g2.a(v, stringBuilder0);
        if(!s.isEmpty()) {
        ...
        if(object0 instanceof String) {
            stringBuilder0.append(": \"");
            stringBuilder0.append(e4.i(ByteString.copyFromUtf8(((String)object0))));
            stringBuilder0.append('\"');
            return;
        }
        if(object0 instanceof ByteString) {
            stringBuilder0.append(": \"");
            stringBuilder0.append(e4.i(((ByteString)object0)));
            stringBuilder0.append('\"');
            return;
        }
        if(object0 instanceof GeneratedMessageLite) {
            stringBuilder0.append(" {");
            g2.c(((GeneratedMessageLite)object0), stringBuilder0, v + 2);
            stringBuilder0.append("\n");
            g2.a(v, stringBuilder0);
            stringBuilder0.append("}");
            return;
        ...
        if(object0 instanceof Map.Entry) {
            stringBuilder0.append(" {");
            g2.b(stringBuilder0, v + 2, "key", ((Map.Entry)object0).getKey());
            g2.b(stringBuilder0, v + 2, "value", ((Map.Entry)object0).getValue());
            stringBuilder0.append("\n");
            g2.a(v, stringBuilder0);
            stringBuilder0.append("}");
            return;
    ...
    public static void c(GeneratedMessageLite generatedMessageLite0, StringBuilder stringBuilder0, int v) {
        int v3;
        HashSet hashSet0 = new HashSet();
        HashMap hashMap0 = new HashMap();
        TreeMap treeMap0 = new TreeMap();
        Method[] arr_method = generatedMessageLite0.getClass().getDeclaredMethods();
        ...
        for(Object object0: treeMap0.entrySet()) {
            ...
            if(s.endsWith("List") && !s.endsWith("OrBuilderList") && !s.equals("List")) {
                ...
                if(method1 != null && method1.getReturnType().equals(List.class)) {
                    g2.b(stringBuilder0, v, s.substring(0, s.length() - 4), GeneratedMessageLite.i(method1, generatedMessageLite0, new Object[0]));
                    continue;
                }
            }
            if(s.endsWith("Map") && !s.equals("Map")) {
                ...
                if(method2 != null && method2.getReturnType().equals(Map.class) && !method2.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method2.getModifiers())) {
                    g2.b(stringBuilder0, v, s.substring(0, s.length() - 3), GeneratedMessageLite.i(method2, generatedMessageLite0, new Object[0]));
                    continue;
                }
            }
            if(hashSet0.contains("set" + s) && (!s.endsWith("Bytes") || !treeMap0.containsKey("get" + s.substring(0, s.length() - 5)))) {
                ...
                if(method3 != null) {
                    boolean z = true;
                    Object object1 = GeneratedMessageLite.i(method3, generatedMessageLite0, new Object[0]);
                    if(method4 == null) {
                            ...
                            if(!(object1 instanceof Integer)) {
                                if(!(object1 instanceof Float)) {
                                    if(!(object1 instanceof Double)) {
                                        ...
                                        else if(object1 instanceof ByteString) {
                                            v3 = object1.equals(ByteString.EMPTY);
                                            goto label_71;
                                        }
                                        else if(!(object1 instanceof MessageLite)) {
                                            if(!(object1 instanceof Enum) || ((Enum)object1).ordinal() != 0) {
                                                v3 = 0;
                                                goto label_71;
                                            }
                                        }
                                        else if(object1 != ((MessageLite)object1).getDefaultInstanceForType()) {
                                            v3 = 0;
                                            goto label_71;
                                        }
                                    }
                    ...
                    label_71:
                        ...
                        z = ((Boolean)GeneratedMessageLite.i(method4, generatedMessageLite0, new Object[0])).booleanValue();
                    }
                    if(z) {
                        g2.b(stringBuilder0, v, s, object1);
                    }
        ...
        if(generatedMessageLite0 instanceof ExtendableMessage) {
            Iterator iterator1 = ((ExtendableMessage)generatedMessageLite0).extensions.m();
            while(iterator1.hasNext()) {
                Object object2 = iterator1.next();
                StringBuilder stringBuilder1 = new StringBuilder("[");
                g2.b(stringBuilder0, v, a.c(((j1)((Map.Entry)object2).getKey()).b, "]", stringBuilder1), ((Map.Entry)object2).getValue());
            }
        }
        UnknownFieldSetLite unknownFieldSetLite0 = generatedMessageLite0.unknownFields;
        if(unknownFieldSetLite0 != null) {
            for(int v1 = 0; v1 < unknownFieldSetLite0.a; ++v1) {
                g2.b(stringBuilder0, v, String.valueOf(WireFormat.getTagFieldNumber(unknownFieldSetLite0.b[v1])), unknownFieldSetLite0.c[v1]);
            }
        }
    }
}
