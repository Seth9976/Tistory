...
public final class wo extends Lambda implements Function2 {
    public final long A;
    ...
    public wo(String s, Modifier modifier0, long v, long v1, FontStyle fontStyle0, FontWeight fontWeight0, FontFamily fontFamily0, long v2, TextDecoration textDecoration0, TextAlign textAlign0, long v3, int v4, boolean z, int v5, int v6, Function1 function10, TextStyle textStyle0, int v7, int v8, int v9, int v10) {
        this.w = v10;
        this.x = s;
        this.y = modifier0;
        this.z = v;
