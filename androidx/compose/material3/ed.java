...
public final class ed extends SuspendLambda implements Function2 {
    ...
    public ed(Animatable animatable0, BackEvent backEvent0, Continuation continuation0) {
        this.p = animatable0;
        this.q = backEvent0;
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new ed(this.p, this.q, continuation0);
    }

    @Override  // kotlin.jvm.functions.Function2
    public final Object invoke(Object object0, Object object1) {
        return ((ed)this.create(((CoroutineScope)object0), ((Continuation)object1))).invokeSuspend(Unit.INSTANCE);
    }
