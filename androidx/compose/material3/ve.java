...
public final class ve extends Lambda implements Function1 {
    ...
    public ve(int v, int v1, int v2, int v3, int v4, int v5, Placeable placeable0, Placeable placeable1, Placeable placeable2) {
        this.w = placeable0;
        this.x = placeable1;
        this.y = v;
        this.z = v1;
