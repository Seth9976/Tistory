...
public final class dp extends SuspendLambda implements Function2 {
    ...
    public dp(ip ip0, float f, Continuation continuation0) {
        this.p = ip0;
        this.q = f;
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new dp(this.p, this.q, continuation0);
    }

    @Override  // kotlin.jvm.functions.Function2
    public final Object invoke(Object object0, Object object1) {
        return ((dp)this.create(((CoroutineScope)object0), ((Continuation)object1))).invokeSuspend(Unit.INSTANCE);
    }
