...
public final class er extends Lambda implements Function2 {
    public final long w;
    public final Function2 x;

    public er(long v, Function2 function20) {
        this.w = v;
        this.x = function20;
        super(2);
    }
    ...
    public final Object invoke(Object object0, Object object1) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(0x553DDA6F, v, -1, "androidx.compose.material3.PlainTooltip.<anonymous> (Tooltip.android.kt:97)");
        }
        Modifier modifier0 = PaddingKt.padding(SizeKt.sizeIn-qDBjuR0$default(Modifier.Companion, 40.0f, 24.0f, 200.0f, 0.0f, 8, null), TooltipKt.getPlainTooltipContentPadding());
        ...
        TextStyle textStyle0 = TypographyKt.getValue(PlainTooltipTokens.INSTANCE.getSupportingTextFont(), ((Composer)object0), 6);
        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.box-impl(this.w)), TextKt.getLocalTextStyle().provides(textStyle0)}, this.x, ((Composer)object0), ProvidedValue.$stable);
