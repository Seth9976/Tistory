...
public final class om extends Lambda implements Function2 {
    ...
    public om(Modifier modifier0, Shape shape0, long v, float f, BorderStroke borderStroke0, float f1, boolean z, MutableInteractionSource mutableInteractionSource0, boolean z1, Function0 function00, Function2 function20) {
        this.w = 1;
        this.x = modifier0;
        this.y = shape0;
        this.z = v;
    ...
    public om(Modifier modifier0, Shape shape0, long v, float f, BorderStroke borderStroke0, boolean z, MutableInteractionSource mutableInteractionSource0, boolean z1, Function0 function00, float f1, Function2 function20) {
        this.w = 0;
        this.x = modifier0;
        this.y = shape0;
        this.z = v;
    ...
    public final Object invoke(Object object0, Object object1) {
        if(this.w != 0) {
            ...
            if(ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(0xAD13FB31, v, -1, "androidx.compose.material.Surface.<anonymous> (Surface.kt:342)");
            }
            ...
            Modifier modifier2 = SelectableKt.selectable-O2vRcR0$default(modifier1, this.D, this.E, indication0, this.F, null, this.G, 16, null);
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(0xBA966880, v3, -1, "androidx.compose.material3.Surface.<anonymous> (Surface.kt:312)");
        }
        ...
        Modifier modifier5 = SelectableKt.selectable-O2vRcR0$default(modifier4, this.D, this.E, indication1, this.F, null, this.G, 16, null);
