...
public final class mm extends Lambda implements Function2 {
    ...
    public mm(Modifier modifier0, Shape shape0, long v, float f, BorderStroke borderStroke0, float f1, Function2 function20, int v1) {
        this.w = v1;
        this.x = modifier0;
        this.y = shape0;
        this.z = v;
    ...
    public final Object invoke(Object object0, Object object1) {
        if(this.w != 0) {
            ...
            if(ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(0x9364083A, v, -1, "androidx.compose.material.Surface.<anonymous> (Surface.kt:118)");
            }
            ...
            Modifier modifier0 = SemanticsModifierKt.semantics(SurfaceKt.access$surface-8ww4TTg(this.x, this.y, v1, this.B, this.C), false, r.N);
            i9 i90 = new i9(2, null);  // 初始化器: Lkotlin/coroutines/jvm/internal/SuspendLambda;-><init>(ILkotlin/coroutines/Continuation;)V
            Modifier modifier1 = SuspendingPointerInputFilterKt.pointerInput(modifier0, Unit.INSTANCE, i90);
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-70914509, v3, -1, "androidx.compose.material3.Surface.<anonymous> (Surface.kt:108)");
        }
        ...
        Modifier modifier2 = SemanticsModifierKt.semantics(androidx.compose.material3.SurfaceKt.access$surface-XO-JAsU(this.x, this.y, v4, this.B, f), false, a5.X);
        lm lm0 = new lm(2, null);  // 初始化器: Lkotlin/coroutines/jvm/internal/SuspendLambda;-><init>(ILkotlin/coroutines/Continuation;)V
        Modifier modifier3 = SuspendingPointerInputFilterKt.pointerInput(modifier2, Unit.INSTANCE, lm0);
        ...
        Integer integer0 = a.l(composeUiNode$Companion1, composer1, modifier4, 0);
        if(a.B(this.D, ((Composer)object0), integer0)) {
            ComposerKt.traceEventEnd();
        }
        return Unit.INSTANCE;
    }
