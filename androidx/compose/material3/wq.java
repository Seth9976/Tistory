...
public final class wq extends Lambda implements Function2 {
    public final Transition w;
    public final Function3 x;
    public final TooltipScopeImpl y;

    public wq(Transition transition0, Function3 function30, TooltipScopeImpl tooltipScopeImpl0) {
        this.w = transition0;
        this.x = function30;
        this.y = tooltipScopeImpl0;
        super(2);
    }
    ...
    public final Object invoke(Object object0, Object object1) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(0xF7151BE8, v, -1, "androidx.compose.material3.TooltipBox.<anonymous> (Tooltip.kt:143)");
        }
        Modifier modifier0 = TooltipKt.animateTooltip(Modifier.Companion, this.w);
        ...
        Integer integer0 = r0.a.l(composeUiNode$Companion0, composer0, modifier1, 6);
        this.x.invoke(this.y, ((Composer)object0), integer0);
