...
public final class pm extends Lambda implements Function2 {
    ...
    public pm(Modifier modifier0, Shape shape0, long v, float f, BorderStroke borderStroke0, float f1, boolean z, MutableInteractionSource mutableInteractionSource0, boolean z1, Function1 function10, Function2 function20) {
        this.w = 1;
        this.x = modifier0;
        this.y = shape0;
        this.z = v;
    ...
    public pm(Modifier modifier0, Shape shape0, long v, float f, BorderStroke borderStroke0, boolean z, MutableInteractionSource mutableInteractionSource0, boolean z1, Function1 function10, float f1, Function2 function20) {
        this.w = 0;
        this.x = modifier0;
        this.y = shape0;
        this.z = v;
    ...
    public final Object invoke(Object object0, Object object1) {
        if(this.w != 0) {
            ...
            if(ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(0xED6C7C50, v, -1, "androidx.compose.material.Surface.<anonymous> (Surface.kt:457)");
            }
            ...
            Modifier modifier2 = ToggleableKt.toggleable-O2vRcR0$default(modifier1, this.D, this.E, indication0, this.F, null, this.G, 16, null);
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(0x2A7B421F, v3, -1, "androidx.compose.material3.Surface.<anonymous> (Surface.kt:416)");
        }
        ...
        Modifier modifier5 = ToggleableKt.toggleable-O2vRcR0$default(modifier4, this.D, this.E, indication1, this.F, null, this.G, 16, null);
        ...
        if(a.B(this.H, ((Composer)object0), integer0)) {
            ComposerKt.traceEventEnd();
        }
        return Unit.INSTANCE;
    }
