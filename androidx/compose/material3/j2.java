...
public final class j2 extends SuspendLambda implements Function2 {
    ...
    public final ButtonElevation s;
    public final Interaction t;

    public j2(Animatable animatable0, float f, boolean z, ButtonElevation buttonElevation0, Interaction interaction0, Continuation continuation0) {
        this.p = animatable0;
        this.q = f;
        this.r = z;
        this.s = buttonElevation0;
        this.t = interaction0;
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new j2(this.p, this.q, this.r, this.s, this.t, continuation0);
    }
            ...
            case 0: {
                ...
                if(!Dp.equals-impl0(f, f1)) {
                    if(this.r) {
                        ...
                        ButtonElevation buttonElevation0 = this.s;
                        Press pressInteraction$Press0 = null;
                        if(Dp.equals-impl0(f2, buttonElevation0.b)) {
                            pressInteraction$Press0 = new Press(0L, null);
                        }
                        else if(Dp.equals-impl0(f2, buttonElevation0.d)) {
                            pressInteraction$Press0 = new Enter();
                        }
                        else if(Dp.equals-impl0(f2, buttonElevation0.c)) {
