...
public final class dc extends Lambda implements Function2 {
    public final ListItemColors w;
    public final Function2 x;

    public dc(ListItemColors listItemColors0, Function2 function20) {
    ...
    public final Object invoke(Object object0, Object object1) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1400509200, v, -1, "androidx.compose.material3.ListItem.<anonymous>.<anonymous> (ListItem.kt:134)");
        }
        Modifier modifier0 = PaddingKt.padding-qDBjuR0$default(Modifier.Companion, 0.0f, 0.0f, 16.0f, 0.0f, 11, null);
        ...
        CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.box-impl(this.w.leadingIconColor-vNxB06k$material3_release(true))), this.x, ((Composer)object0), ProvidedValue.$stable);
