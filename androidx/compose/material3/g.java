...
public final class g extends Lambda implements Function1 {
    ...
    public g(ArrayList arrayList0, MeasureScope measureScope0, float f, int v, ArrayList arrayList1) {
        this.w = arrayList0;
    ...
    public final Object invoke(Object object0) {
        ...
        for(int v1 = 0; v1 < v; ++v1) {
            ...
            Horizontal arrangement$Horizontal0 = Arrangement.INSTANCE.getEnd();
            int[] arr_v1 = new int[v2];
            for(int v4 = 0; v4 < v2; ++v4) {
                arr_v1[v4] = 0;
            }
            LayoutDirection layoutDirection0 = measureScope0.getLayoutDirection();
            arrangement$Horizontal0.arrange(measureScope0, this.z, arr_v, layoutDirection0, arr_v1);
            int v5 = list0.size();
