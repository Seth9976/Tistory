...
public final class te implements MeasurePolicy {
    public final Function0 a;
    public final Function2 b;
    public final boolean c;

    public te(Function0 function00, Function2 function20, boolean z) {
        this.a = function00;
        this.b = function20;
        this.c = z;
    }
        ...
        while(v3 < v2) {
            ...
            if(Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable0), "icon")) {
                ...
                while(v8 < v7) {
                    ...
                    label_42:
                        if(function20 == null) {
                            return NavigationBarKt.access$placeIcon-X9ElhV4(measureScope0, placeable0, placeable1, placeable2, v);
                        }
                        Intrinsics.checkNotNull(placeable3);
                        return NavigationBarKt.access$placeLabelAndIcon-zUg2_y0(measureScope0, placeable3, placeable0, placeable1, placeable2, v, this.c, f);
                    }
                    ++v8;
                }
                throw new NoSuchElementException("Collection contains no element matching the predicate.");
