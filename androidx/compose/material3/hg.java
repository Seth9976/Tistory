...
public final class hg extends Lambda implements Function1 {
    public final int A;
    public final int B;
    ...
    public hg(Placeable placeable0, int v, int v1, Placeable placeable1, int v2, int v3, Placeable placeable2, int v4, int v5, Placeable placeable3, int v6, int v7) {
        this.w = placeable0;
        this.x = v;
        this.y = v1;
        this.z = placeable1;
