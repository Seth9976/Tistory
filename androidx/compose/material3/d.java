...
public final class d extends Lambda implements Function2 {
    ...
    public d(ColumnScopeInstance columnScopeInstance0, Function2 function20) {
    ...
    public final Object invoke(Object object0, Object object1) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(0xD0812105, v, -1, "androidx.compose.material3.AlertDialogContent.<anonymous>.<anonymous>.<anonymous>.<anonymous> (AlertDialog.kt:334)");
        }
        Modifier modifier0 = PaddingKt.padding(this.w.weight(Modifier.Companion, 1.0f, false), AlertDialogKt.h);
        Modifier modifier1 = this.w.align(modifier0, Alignment.Companion.getStart());
