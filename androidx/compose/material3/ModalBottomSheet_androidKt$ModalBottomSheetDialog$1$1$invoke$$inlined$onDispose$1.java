...
public final class ModalBottomSheet_androidKt.ModalBottomSheetDialog.1.1.invoke..inlined.onDispose.1 implements DisposableEffectResult {
    public final jd a;

    public ModalBottomSheet_androidKt.ModalBottomSheetDialog.1.1.invoke..inlined.onDispose.1(jd jd0) {
        this.a = jd0;
        super();
    }
