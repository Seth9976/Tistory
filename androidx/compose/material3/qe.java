...
public final class qe extends Lambda implements Function2 {
    public final boolean A;
    public final Function2 B;
    public final NavigationBarItemColors w;
    public final boolean x;
    public final boolean y;
    public final Function2 z;

    public qe(NavigationBarItemColors navigationBarItemColors0, boolean z, boolean z1, Function2 function20, boolean z2, Function2 function21) {
        this.w = navigationBarItemColors0;
        this.x = z;
        this.y = z1;
        this.z = function20;
        this.A = z2;
    ...
    public final Object invoke(Object object0, Object object1) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1419576100, v, -1, "androidx.compose.material3.NavigationBarItem.<anonymous> (NavigationBar.kt:186)");
        }
        State state0 = SingleValueAnimationKt.animateColorAsState-euL9pac(this.w.iconColor-WaAFU9c$material3_release(this.x, this.y), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, ((Composer)object0), 0x30, 12);
        Modifier modifier0 = this.z == null || !this.A && !this.x ? Modifier.Companion : SemanticsModifierKt.clearAndSetSemantics(Modifier.Companion, a5.Q);
