...
public final class hn extends Lambda implements Function1 {
    public final int A;
    ...
    public hn(Placeable placeable0, Placeable placeable1, MeasureScope measureScope0, int v, int v1, Integer integer0, Integer integer1) {
        this.w = placeable0;
        this.x = placeable1;
