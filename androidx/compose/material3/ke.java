...
public final class ke extends Lambda implements Function2 {
    public final WindowInsets w;
    public final Function3 x;

    public ke(WindowInsets windowInsets0, Function3 function30) {
    ...
    public final Object invoke(Object object0, Object object1) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(105663120, v, -1, "androidx.compose.material3.NavigationBar.<anonymous> (NavigationBar.kt:123)");
        }
        Modifier modifier0 = SelectableGroupKt.selectableGroup(SizeKt.defaultMinSize-VpY3zN4$default(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), this.w), 0.0f, 0.0f, 1, null));
        MeasurePolicy measurePolicy0 = RowKt.rowMeasurePolicy(Arrangement.INSTANCE.spacedBy-0680j_4(0.0f), Alignment.Companion.getCenterVertically(), ((Composer)object0), 54);
        ...
        this.x.invoke(RowScopeInstance.INSTANCE, ((Composer)object0), 6);
