...
public final class rc extends Lambda implements Function2 {
    public final Modifier w;
    public final ScrollState x;
    public final Function3 y;

    public rc(Modifier modifier0, ScrollState scrollState0, Function3 function30) {
        this.w = modifier0;
        this.x = scrollState0;
        this.y = function30;
        super(2);
    ...
    public final Object invoke(Object object0, Object object1) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(0x5DCA9B0D, v, -1, "androidx.compose.material3.DropdownMenuContent.<anonymous> (Menu.kt:429)");
        }
        Modifier modifier0 = ScrollKt.verticalScroll$default(IntrinsicKt.width(PaddingKt.padding-VpY3zN4$default(this.w, 0.0f, 8.0f, 1, null), IntrinsicSize.Max), this.x, false, null, false, 14, null);
