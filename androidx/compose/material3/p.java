...
public final class p extends SuspendLambda implements Function1 {
    ...
    public p(AnalogTimePickerState analogTimePickerState0, float f, Continuation continuation0) {
    ...
    public final Continuation create(Continuation continuation0) {
        return new p(this.p, this.q, continuation0);
    }

    @Override  // kotlin.jvm.functions.Function1
    public final Object invoke(Object object0) {
        return ((p)this.create(((Continuation)object0))).invokeSuspend(Unit.INSTANCE);
    }
