...
public final class b extends Lambda implements Function2 {
    ...
    public b(ColumnScopeInstance columnScopeInstance0, Function2 function20) {
    ...
    public final Object invoke(Object object0, Object object1) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(0x37B5BEE5, v, -1, "androidx.compose.material3.AlertDialogContent.<anonymous>.<anonymous>.<anonymous>.<anonymous> (AlertDialog.kt:303)");
        }
        Modifier modifier0 = PaddingKt.padding(Modifier.Companion, AlertDialogKt.f);
        Modifier modifier1 = this.w.align(modifier0, Alignment.Companion.getCenterHorizontally());
