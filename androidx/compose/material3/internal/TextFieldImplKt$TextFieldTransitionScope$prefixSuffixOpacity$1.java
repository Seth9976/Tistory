...
public final class TextFieldImplKt.TextFieldTransitionScope.prefixSuffixOpacity.1 extends Lambda implements Function3 {
    public static final TextFieldImplKt.TextFieldTransitionScope.prefixSuffixOpacity.1 INSTANCE;

    static {
        TextFieldImplKt.TextFieldTransitionScope.prefixSuffixOpacity.1.INSTANCE = new TextFieldImplKt.TextFieldTransitionScope.prefixSuffixOpacity.1();
    }
    ...
    public final FiniteAnimationSpec invoke(@NotNull Segment transition$Segment0, @Nullable Composer composer0, int v) {
        composer0.startReplaceGroup(0x90A7E59E);
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(0x90A7E59E, v, -1, "androidx.compose.material3.internal.TextFieldTransitionScope.<anonymous> (TextFieldImpl.kt:396)");
        }
