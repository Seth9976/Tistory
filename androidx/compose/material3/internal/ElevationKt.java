...
public final class ElevationKt {
    ...
    static {
        CubicBezierEasing cubicBezierEasing0 = new CubicBezierEasing(0.4f, 0.0f, 0.6f, 1.0f);
        ElevationKt.a = new TweenSpec(120, 0, EasingKt.getFastOutSlowInEasing(), 2, null);
        ElevationKt.b = new TweenSpec(150, 0, cubicBezierEasing0, 2, null);
        ElevationKt.c = new TweenSpec(120, 0, cubicBezierEasing0, 2, null);
    }
