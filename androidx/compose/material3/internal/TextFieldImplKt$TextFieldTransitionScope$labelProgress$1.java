...
public final class TextFieldImplKt.TextFieldTransitionScope.labelProgress.1 extends Lambda implements Function3 {
    public static final TextFieldImplKt.TextFieldTransitionScope.labelProgress.1 INSTANCE;

    static {
        TextFieldImplKt.TextFieldTransitionScope.labelProgress.1.INSTANCE = new TextFieldImplKt.TextFieldTransitionScope.labelProgress.1();
    }
    ...
    public final FiniteAnimationSpec invoke(@NotNull Segment transition$Segment0, @Nullable Composer composer0, int v) {
        composer0.startReplaceGroup(0x4C116805);
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(0x4C116805, v, -1, "androidx.compose.material3.internal.TextFieldTransitionScope.<anonymous> (TextFieldImpl.kt:354)");
        }
