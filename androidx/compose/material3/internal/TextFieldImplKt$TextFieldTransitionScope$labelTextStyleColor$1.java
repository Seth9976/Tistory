...
public final class TextFieldImplKt.TextFieldTransitionScope.labelTextStyleColor.1 extends Lambda implements Function3 {
    public static final TextFieldImplKt.TextFieldTransitionScope.labelTextStyleColor.1 INSTANCE;

    static {
        TextFieldImplKt.TextFieldTransitionScope.labelTextStyleColor.1.INSTANCE = new TextFieldImplKt.TextFieldTransitionScope.labelTextStyleColor.1();
    }
    ...
    public final FiniteAnimationSpec invoke(@NotNull Segment transition$Segment0, @Nullable Composer composer0, int v) {
        composer0.startReplaceGroup(0x5B1C500C);
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(0x5B1C500C, v, -1, "androidx.compose.material3.internal.TextFieldTransitionScope.<anonymous> (TextFieldImpl.kt:407)");
        }
