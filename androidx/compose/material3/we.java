...
public final class we extends Lambda implements Function1 {
    public final int A;
    ...
    public we(Placeable placeable0, boolean z, float f, Placeable placeable1, int v, float f1, float f2, Placeable placeable2, int v1, float f3, Placeable placeable3, int v2, float f4, int v3, MeasureScope measureScope0) {
        this.w = placeable0;
        this.x = z;
        this.y = f;
        this.z = placeable1;
    ...
    public final Object invoke(Object object0) {
        ...
        if(placeable0 != null) {
            int v = c.roundToInt(f - ((float)this.K.roundToPx-0680j_4(NavigationBarKt.getIndicatorVerticalPadding())) + f1);
