...
public final class ie extends Lambda implements Function2 {
    public final State w;

    public ie(State state0) {
        this.w = state0;
        super(2);
    }
    ...
    public final Object invoke(Object object0, Object object1) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1560960657, v, -1, "androidx.compose.material3.ModalBottomSheetDialog.<anonymous>.<anonymous>.<anonymous> (ModalBottomSheet.android.kt:296)");
        }
        Modifier modifier0 = SemanticsModifierKt.semantics$default(Modifier.Companion, false, a5.P, 1, null);
        ...
        ModalBottomSheet_androidKt.access$ModalBottomSheetDialog$lambda$0(this.w).invoke(((Composer)object0), 0);
