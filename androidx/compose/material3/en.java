...
public final class en extends Lambda implements Function2 {
    ...
    public en(Modifier modifier0, boolean z, MutableInteractionSource mutableInteractionSource0, Indication indication0, boolean z1, Function0 function00, Function3 function30) {
        this.w = modifier0;
        this.x = z;
    ...
    public final Object invoke(Object object0, Object object1) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(0xDF1ABBB4, v, -1, "androidx.compose.material3.Tab.<anonymous> (Tab.kt:249)");
        }
        Role role0 = Role.box-impl(4);
        Modifier modifier0 = SizeKt.fillMaxWidth$default(SelectableKt.selectable-O2vRcR0(this.w, this.x, this.y, this.z, this.A, role0, this.B), 0.0f, 1, null);
        MeasurePolicy measurePolicy0 = ColumnKt.columnMeasurePolicy(Arrangement.INSTANCE.getCenter(), Alignment.Companion.getCenterHorizontally(), ((Composer)object0), 54);
        ...
        this.C.invoke(ColumnScopeInstance.INSTANCE, ((Composer)object0), 6);
