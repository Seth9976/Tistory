...
public final class xc extends Lambda implements Function2 {
    public final Function2 w;

    public xc(Function2 function20) {
        this.w = function20;
        super(2);
    }
    ...
    public final Object invoke(Object object0, Object object1) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(580312062, v, -1, "androidx.compose.material3.DropdownMenuItemContent.<anonymous>.<anonymous>.<anonymous> (Menu.kt:507)");
        }
        Modifier modifier0 = SizeKt.defaultMinSize-VpY3zN4$default(Modifier.Companion, ListTokens.INSTANCE.getListItemTrailingIconSize-D9Ej5fM(), 0.0f, 2, null);
        ...
        if(r0.a.B(this.w, ((Composer)object0), integer0)) {
