...
public final class yg extends Lambda implements Function2 {
    ...
    public final Object invoke(Object object0, Object object1) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(0x8F873243, v, -1, "androidx.compose.material3.OutlinedTextField.<anonymous> (OutlinedTextField.kt:207)");
        }
        Modifier modifier0 = this.x == null ? Modifier.Companion : PaddingKt.padding-qDBjuR0$default(SemanticsModifierKt.semantics(Modifier.Companion, true, a5.T), 0.0f, this.y.toDp-GaN1DYA(0L), 0.0f, 0.0f, 13, null);
        ...
        ComposableLambda composableLambda0 = ComposableLambdaKt.rememberComposableLambda(0x57E4C9CD, true, new xg(this.B, this.D, this.I, this.L, this.M, this.z, this.x, this.N, this.O, this.P, this.Q, this.R, this.S, this.A, this.T), ((Composer)object0), 54);
