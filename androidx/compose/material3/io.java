...
public final class io extends Lambda implements Function1 {
    public final long A;
    public final int B;
    ...
    public io(ArrayList arrayList0, SubcomposeMeasureScope subcomposeMeasureScope0, Function2 function20, IntRef ref$IntRef0, long v, int v1, Function3 function30, ArrayList arrayList1, int v2) {
        this.w = arrayList0;
    ...
    public final Object invoke(Object object0) {
        ...
        List list0 = subcomposeMeasureScope0.subcompose(lo.b, this.y);
        int v3 = list0.size();
        ...
        ComposableLambda composableLambda0 = ComposableLambdaKt.composableLambdaInstance(0x60ADA49C, true, new ho(this.C, this.D));
