...
public final class CommonRipple extends Ripple {
    ...
    public CommonRipple(boolean z, float f, State state0, DefaultConstructorMarker defaultConstructorMarker0) {
    ...
    public RippleIndicationInstance rememberUpdatedRippleInstance-942rkJo(@NotNull InteractionSource interactionSource0, boolean z, float f, @NotNull State state0, @NotNull State state1, @Nullable Composer composer0, int v) {
        composer0.startReplaceGroup(-1768051227);
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1768051227, v, -1, "androidx.compose.material.ripple.CommonRipple.rememberUpdatedRippleInstance (CommonRipple.kt:59)");
        }
        int v1 = 0;
        ...
        if((v2 | v1) != 0 || c0 == Composer.Companion.getEmpty()) {
            c0 = new c(z, f, state0, state1);
