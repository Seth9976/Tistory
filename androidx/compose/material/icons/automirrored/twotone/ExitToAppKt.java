...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0004\u001A\u00020\u0001*\u00020\u00008F¢\u0006\u0006\u001A\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, d2 = {"Landroidx/compose/material/icons/Icons$AutoMirrored$TwoTone;", "Landroidx/compose/ui/graphics/vector/ImageVector;", "getExitToApp", "(Landroidx/compose/material/icons/Icons$AutoMirrored$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "ExitToApp", "material-icons-core_release"}, k = 2, mv = {1, 8, 0}, xi = 0x30)
...
public final class ExitToAppKt {
    ...
    @NotNull
    public static final ImageVector getExitToApp(@NotNull TwoTone icons$AutoMirrored$TwoTone0) {
        ImageVector imageVector0 = ExitToAppKt.a;
        if(imageVector0 != null) {
            Intrinsics.checkNotNull(imageVector0);
            return imageVector0;
        }
        Builder imageVector$Builder0 = new Builder("AutoMirrored.TwoTone.ExitToApp", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, true, 0x60, null);
