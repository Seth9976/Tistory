...
public final class InternalMutatorMutex {
    ...
    public static final void access$tryMutateOrCancel(InternalMutatorMutex internalMutatorMutex0, t4 t40) {
        while(true) {
            AtomicReference atomicReference0 = internalMutatorMutex0.a;
            t4 t41 = (t4)atomicReference0.get();
            if(t41 != null && t40.a.compareTo(t41.a) < 0) {
                throw new CancellationException("Current mutation had a higher priority");
            }
            do {
                if(atomicReference0.compareAndSet(t41, t40)) {
                    if(t41 != null) {
                        DefaultImpls.cancel$default(t41.b, null, 1, null);
                    }
                    return;
                }
            }
            while(atomicReference0.get() == t41);
        }
    }
    ...
    public final Object mutate(@NotNull MutatePriority mutatePriority0, @NotNull Function1 function10, @NotNull Continuation continuation0) {
        return CoroutineScopeKt.coroutineScope(new u4(mutatePriority0, this, function10, null), continuation0);
    }
    ...
    public final Object mutateWith(Object object0, @NotNull MutatePriority mutatePriority0, @NotNull Function2 function20, @NotNull Continuation continuation0) {
        return CoroutineScopeKt.coroutineScope(new v4(mutatePriority0, this, function20, object0, null), continuation0);
    }
