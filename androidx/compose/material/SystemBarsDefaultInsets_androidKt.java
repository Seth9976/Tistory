...
public final class SystemBarsDefaultInsets_androidKt {
    ...
    public static final WindowInsets getSystemBarsForVisualComponents(@NotNull Companion windowInsets$Companion0, @Nullable Composer composer0, int v) {
        composer0.startReplaceableGroup(-1520067638);
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1520067638, v, -1, "androidx.compose.material.<get-systemBarsForVisualComponents> (SystemBarsDefaultInsets.android.kt:24)");
        }
        WindowInsets windowInsets0 = WindowInsets_androidKt.getSystemBars(windowInsets$Companion0, composer0, 8);
        if(ComposerKt.isTraceInProgress()) {
