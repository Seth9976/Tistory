...
public final class k extends Lambda implements Function0 {
    ...
    public k(MultiParagraphIntrinsics multiParagraphIntrinsics0) {
    ...
    public final Object invoke() {
        ...
        if(list0.isEmpty()) {
            ...
            float f = ((ParagraphIntrinsicInfo)object1).getIntrinsics().getMinIntrinsicWidth();
            int v = CollectionsKt__CollectionsKt.getLastIndex(list0);
            if(1 <= v) {
                for(int v1 = 1; true; ++v1) {
                    Object object2 = list0.get(v1);
                    float f1 = ((ParagraphIntrinsicInfo)object2).getIntrinsics().getMinIntrinsicWidth();
        ...
        if(((ParagraphIntrinsicInfo)object0) != null) {
            ...
            return paragraphIntrinsics0 == null ? 0.0f : paragraphIntrinsics0.getMinIntrinsicWidth();
        }
        return 0.0f;
    }
}
