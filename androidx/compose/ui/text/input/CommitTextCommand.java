...
public final class CommitTextCommand implements EditCommand {
    ...
    public CommitTextCommand(@NotNull AnnotatedString annotatedString0, int v) {
        this.a = annotatedString0;
        this.b = v;
    }

    public CommitTextCommand(@NotNull String s, int v) {
    ...
    public void applyTo(@NotNull EditingBuffer editingBuffer0) {
        ...
        editingBuffer0.setCursor$ui_text_release(c.coerceIn((this.b <= 0 ? v + this.b - this.getText().length() : v + this.b - 1), 0, editingBuffer0.getLength$ui_text_release()));
    }
    ...
    public boolean equals(@Nullable Object object0) {
        ...
        return Intrinsics.areEqual(this.getText(), ((CommitTextCommand)object0).getText()) ? this.b == ((CommitTextCommand)object0).b : false;
    }
