...
public final class LayoutNodeAlignmentLines extends AlignmentLines {
    ...
    public LayoutNodeAlignmentLines(@NotNull AlignmentLinesOwner alignmentLinesOwner0) {
    ...
    public long calculatePositionInParent-R5De75A(@NotNull NodeCoordinator nodeCoordinator0, long v) {
        return NodeCoordinator.toParentPosition-8S9VItk$default(nodeCoordinator0, v, false, 2, null);
    }

    @Override  // androidx.compose.ui.node.AlignmentLines
    @NotNull
    public Map getAlignmentLinesMap(@NotNull NodeCoordinator nodeCoordinator0) {
        return nodeCoordinator0.getMeasureResult$ui_release().getAlignmentLines();
    }

    @Override  // androidx.compose.ui.node.AlignmentLines
    public int getPositionFor(@NotNull NodeCoordinator nodeCoordinator0, @NotNull AlignmentLine alignmentLine0) {
        return nodeCoordinator0.get(alignmentLine0);
    }
}
