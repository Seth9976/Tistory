...
public final class SolidColor extends Brush {
    ...
    public void applyTo-Pq9zytI(long v, @NotNull Paint paint0, float f) {
        paint0.setAlpha(1.0f);
        paint0.setColor-8_81llA((f == 1.0f ? this.d : Color.copy-wmQWz5c$default(this.d, Color.getAlpha-impl(this.d) * f, 0.0f, 0.0f, 0.0f, 14, null)));
    ...
    public boolean equals(@Nullable Object object0) {
        ...
        return object0 instanceof SolidColor ? Color.equals-impl0(this.d, ((SolidColor)object0).d) : false;
    }
    ...
    @Override
    public int hashCode() {
        return Color.hashCode-impl(this.d);
    }

    @Override
    @NotNull
    public String toString() {
        return "SolidColor(value=" + Color.toString-impl(this.d) + ')';
    }
}
