...
public final class CompositionLocalMapInjectionElement extends ModifierNodeElement {
    ...
    public CompositionLocalMapInjectionElement(@NotNull CompositionLocalMap compositionLocalMap0) {
        this.b = compositionLocalMap0;
    }
    ...
    public boolean equals(@Nullable Object object0) {
        return object0 instanceof CompositionLocalMapInjectionElement && Intrinsics.areEqual(((CompositionLocalMapInjectionElement)object0).b, this.b);
    }
    ...
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo0) {
        inspectorInfo0.setName("<Injected CompositionLocalMap>");
    }

    public void update(@NotNull CompositionLocalMapInjectionNode compositionLocalMapInjectionNode0) {
        compositionLocalMapInjectionNode0.setMap(this.b);
    }

    @Override  // androidx.compose.ui.node.ModifierNodeElement
    public void update(Node modifier$Node0) {
        this.update(((CompositionLocalMapInjectionNode)modifier$Node0));
    }
}
