...
public final class CoreTextFieldKt.CoreTextField.3.1.invoke..inlined.onDispose.1 implements DisposableEffectResult {
    public final TextFieldSelectionManager a;

    public CoreTextFieldKt.CoreTextField.3.1.invoke..inlined.onDispose.1(TextFieldSelectionManager textFieldSelectionManager0) {
    ...
    public void dispose() {
        this.a.hideSelectionToolbar$foundation_release();
    }
}
