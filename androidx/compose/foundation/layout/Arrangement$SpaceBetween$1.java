...
public final class Arrangement.SpaceBetween.1 implements HorizontalOrVertical {
    ...
    public void arrange(@NotNull Density density0, int v, @NotNull int[] arr_v, @NotNull LayoutDirection layoutDirection0, @NotNull int[] arr_v1) {
        if(layoutDirection0 == LayoutDirection.Ltr) {
            Arrangement.INSTANCE.placeSpaceBetween$foundation_layout_release(v, arr_v, arr_v1, false);
            return;
        }
        Arrangement.INSTANCE.placeSpaceBetween$foundation_layout_release(v, arr_v, arr_v1, true);
    }
