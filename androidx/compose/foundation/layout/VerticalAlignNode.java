...
public final class VerticalAlignNode extends Node implements ParentDataModifierNode {
    ...
    public RowColumnParentData modifyParentData(@NotNull Density density0, @Nullable Object object0) {
        ...
        rowColumnParentData0.setCrossAxisAlignment(CrossAxisAlignment.Companion.vertical$foundation_layout_release(this.n));
    ...
    public final void setVertical(@NotNull Vertical alignment$Vertical0) {
        this.n = alignment$Vertical0;
    }
}
