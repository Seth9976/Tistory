...
public final class SideCalculator.Companion.TopSideCalculator.1 implements SideCalculator {
    ...
    public Insets adjustInsets(@NotNull Insets insets0, int v) {
        return Insets.of(insets0.left, v, insets0.right, insets0.bottom);
    }

    @Override  // androidx.compose.foundation.layout.SideCalculator
    public long consumedOffsets-MK-Hz9U(long v) {
        return OffsetKt.Offset(0.0f, Offset.getY-impl(v));
    }

    @Override  // androidx.compose.foundation.layout.SideCalculator
    public long consumedVelocity-QWom1Mo(long v, float f) {
        return VelocityKt.Velocity(0.0f, Velocity.getY-impl(v) - f);
    }
