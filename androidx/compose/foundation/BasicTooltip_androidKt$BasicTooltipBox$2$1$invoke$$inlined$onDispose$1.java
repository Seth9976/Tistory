...
public final class BasicTooltip_androidKt.BasicTooltipBox.2.1.invoke..inlined.onDispose.1 implements DisposableEffectResult {
    public final BasicTooltipState a;

    public BasicTooltip_androidKt.BasicTooltipBox.2.1.invoke..inlined.onDispose.1(BasicTooltipState basicTooltipState0) {
        this.a = basicTooltipState0;
        super();
    }
