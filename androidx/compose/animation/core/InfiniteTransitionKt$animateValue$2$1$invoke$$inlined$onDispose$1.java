...
public final class InfiniteTransitionKt.animateValue.2.1.invoke..inlined.onDispose.1 implements DisposableEffectResult {
    ...
    public InfiniteTransitionKt.animateValue.2.1.invoke..inlined.onDispose.1(InfiniteTransition infiniteTransition0, TransitionAnimationState infiniteTransition$TransitionAnimationState0) {
        this.a = infiniteTransition0;
        this.b = infiniteTransition$TransitionAnimationState0;
        super();
    }
