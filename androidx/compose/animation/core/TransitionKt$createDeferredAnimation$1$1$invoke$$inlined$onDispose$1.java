...
public final class TransitionKt.createDeferredAnimation.1.1.invoke..inlined.onDispose.1 implements DisposableEffectResult {
    ...
    public TransitionKt.createDeferredAnimation.1.1.invoke..inlined.onDispose.1(Transition transition0, DeferredAnimation transition$DeferredAnimation0) {
        this.a = transition0;
        this.b = transition$DeferredAnimation0;
        super();
    }
