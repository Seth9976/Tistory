...
public final class TransitionKt.createTransitionAnimation.1.1.invoke..inlined.onDispose.1 implements DisposableEffectResult {
    ...
    public TransitionKt.createTransitionAnimation.1.1.invoke..inlined.onDispose.1(Transition transition0, TransitionAnimationState transition$TransitionAnimationState0) {
        this.a = transition0;
        this.b = transition$TransitionAnimationState0;
        super();
    }
