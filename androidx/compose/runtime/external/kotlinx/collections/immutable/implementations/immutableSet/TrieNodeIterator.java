...
public final class TrieNodeIterator {
    ...
    public TrieNodeIterator() {
        this.a = TrieNode.Companion.getEMPTY$runtime_release().getBuffer();
    }
    ...
    public final TrieNode currentNode() {
        ...
        Intrinsics.checkNotNull(object0, "null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNodeIterator>");
