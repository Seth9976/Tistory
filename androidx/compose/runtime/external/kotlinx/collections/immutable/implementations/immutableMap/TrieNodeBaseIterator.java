...
public abstract class TrieNodeBaseIterator implements Iterator, KMappedMarker {
    ...
    public TrieNodeBaseIterator() {
        this.a = TrieNode.Companion.getEMPTY$runtime_release().getBuffer$runtime_release();
    }
