...
public final class PersistentOrderedMapBuilderKeysIterator implements Iterator, KMutableIterator {
    ...
    public PersistentOrderedMapBuilderKeysIterator(@NotNull PersistentOrderedMapBuilder persistentOrderedMapBuilder0) {
    ...
    public Object next() {
        this.a.next();
        return this.a.getLastIteratedKey$runtime_release();
    }
