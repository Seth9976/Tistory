...
public final class PersistentVectorMutableIterator extends AbstractListIterator implements ListIterator, KMutableListIterator {
    ...
    public PersistentVectorMutableIterator(@NotNull PersistentVectorBuilder persistentVectorBuilder0, int v) {
        ...
        this.d = persistentVectorBuilder0.getModCount$runtime_release();
        this.f = -1;
        this.b();
    }
    ...
    public final void b() {
        ...
        Object[] arr_object = persistentVectorBuilder0.getRoot$runtime_release();
        if(arr_object == null) {
            this.e = null;
            return;
        }
        ...
        int v2 = persistentVectorBuilder0.getRootShift$runtime_release() / 5 + 1;
    ...
    public Object next() {
        ...
        if(trieIterator0 == null) {
            int v = this.getIndex();
            this.setIndex(v + 1);
            return persistentVectorBuilder0.getTail$runtime_release()[v];
        }
        ...
        this.setIndex(v1 + 1);
        return persistentVectorBuilder0.getTail$runtime_release()[v1 - trieIterator0.getSize()];
    }
    ...
    public Object previous() {
        ...
        if(trieIterator0 == null) {
            this.setIndex(this.getIndex() - 1);
            return persistentVectorBuilder0.getTail$runtime_release()[this.getIndex()];
        }
        if(this.getIndex() > trieIterator0.getSize()) {
            this.setIndex(this.getIndex() - 1);
            return persistentVectorBuilder0.getTail$runtime_release()[this.getIndex() - trieIterator0.getSize()];
        }
        this.setIndex(this.getIndex() - 1);
