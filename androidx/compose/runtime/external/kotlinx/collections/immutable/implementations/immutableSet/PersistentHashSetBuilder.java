...
public final class PersistentHashSetBuilder extends AbstractMutableSet implements Builder {
    ...
    public boolean addAll(@NotNull Collection collection0) {
        ...
        if(persistentHashSet0 != null) {
            ...
            int v = this.size();
            TrieNode trieNode0 = this.c.mutableAddAll(persistentHashSet0.getNode$runtime_release(), 0, deltaCounter0, this);
    ...
    public void clear() {
        ...
        Intrinsics.checkNotNull(trieNode0, "null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.PersistentHashSetBuilder>");
        this.c = trieNode0;
        this.setSize(0);
    }
    ...
    public boolean containsAll(@NotNull Collection collection0) {
        if(collection0 instanceof PersistentHashSet) {
            return this.c.containsAll(((PersistentHashSet)collection0).getNode$runtime_release(), 0);
        }
    ...
    public boolean removeAll(@NotNull Collection collection0) {
        ...
        if(persistentHashSet0 != null) {
            DeltaCounter deltaCounter0 = new DeltaCounter(0, 1, null);
            int v = this.size();
            Object object0 = this.c.mutableRemoveAll(persistentHashSet0.getNode$runtime_release(), 0, deltaCounter0, this);
            ...
            if(v1 != v) {
                Intrinsics.checkNotNull(object0, "null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.PersistentHashSetBuilder>");
    ...
    public boolean retainAll(@NotNull Collection collection0) {
        ...
        if(persistentHashSet0 != null) {
            DeltaCounter deltaCounter0 = new DeltaCounter(0, 1, null);
            int v = this.size();
            Object object0 = this.c.mutableRetainAll(persistentHashSet0.getNode$runtime_release(), 0, deltaCounter0, this);
