...
public final class LiveDataAdapterKt.observeAsState.1.1.invoke..inlined.onDispose.1 implements DisposableEffectResult {
    public final LiveData a;
    public final Observer b;

    public LiveDataAdapterKt.observeAsState.1.1.invoke..inlined.onDispose.1(LiveData liveData0, Observer observer0) {
        this.a = liveData0;
        this.b = observer0;
        super();
    }
