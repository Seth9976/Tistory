...
public final class NavHostKt.NavHost.27.1.invoke..inlined.onDispose.1 implements DisposableEffectResult {
    ...
    public final ComposeNavigator b;

    public NavHostKt.NavHost.27.1.invoke..inlined.onDispose.1(State state0, ComposeNavigator composeNavigator0) {
        this.a = state0;
        this.b = composeNavigator0;
        super();
    }

    @Override  // androidx.compose.runtime.DisposableEffectResult
    public void dispose() {
        for(Object object0: NavHostKt.access$NavHost$lambda$17(this.a)) {
            this.b.onTransitionComplete(((NavBackStackEntry)object0));
        }
    }
}
