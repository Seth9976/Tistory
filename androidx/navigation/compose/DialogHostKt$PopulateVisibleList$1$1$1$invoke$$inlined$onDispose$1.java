...
public final class DialogHostKt.PopulateVisibleList.1.1.1.invoke..inlined.onDispose.1 implements DisposableEffectResult {
    ...
    public DialogHostKt.PopulateVisibleList.1.1.1.invoke..inlined.onDispose.1(NavBackStackEntry navBackStackEntry0, LifecycleEventObserver lifecycleEventObserver0) {
        this.a = navBackStackEntry0;
