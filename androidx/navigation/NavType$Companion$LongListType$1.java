...
public final class NavType.Companion.LongListType.1 extends CollectionNavType {
    ...
    public List get(@NotNull Bundle bundle0, @NotNull String s) {
        long[] arr_v = (long[])q.i(bundle0, "bundle", s, "key", s);
    ...
    public List parseValue(@NotNull String s) {
        ...
        return k.listOf(NavType.LongType.parseValue(s));
    }
    ...
    public void put(@NotNull Bundle bundle0, @NotNull String s, @Nullable List list0) {
        ...
        bundle0.putLongArray(s, (list0 == null ? null : CollectionsKt___CollectionsKt.toLongArray(list0)));
    }
    ...
    public boolean valueEquals(@Nullable List list0, @Nullable List list1) {
        Long[] arr_long = null;
        Long[] arr_long1 = list0 == null ? null : ((Long[])list0.toArray(new Long[0]));
        if(list1 != null) {
            arr_long = (Long[])list1.toArray(new Long[0]);
        }
