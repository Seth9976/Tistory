...
public final class NavType.Companion.FloatType.1 extends NavType {
    ...
    public void put(@NotNull Bundle bundle0, @NotNull String s, float f) {
    ...
    public void put(Bundle bundle0, String s, Object object0) {
        this.put(bundle0, s, ((Number)object0).floatValue());
    }
}
