...
public final class NavType.Companion.IntListType.1 extends CollectionNavType {
    ...
    public List get(@NotNull Bundle bundle0, @NotNull String s) {
        int[] arr_v = (int[])q.i(bundle0, "bundle", s, "key", s);
        return arr_v == null ? null : ArraysKt___ArraysKt.toList(arr_v);
    }
    ...
    public List parseValue(@NotNull String s) {
        ...
        return k.listOf(NavType.IntType.parseValue(s));
    }
    ...
    public void put(@NotNull Bundle bundle0, @NotNull String s, @Nullable List list0) {
        ...
        bundle0.putIntArray(s, (list0 == null ? null : CollectionsKt___CollectionsKt.toIntArray(list0)));
    }
    ...
    public boolean valueEquals(@Nullable List list0, @Nullable List list1) {
        ...
        Integer[] arr_integer1 = list0 == null ? null : ((Integer[])list0.toArray(new Integer[0]));
        if(list1 != null) {
            arr_integer = (Integer[])list1.toArray(new Integer[0]);
        }
