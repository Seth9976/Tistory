...
public final class NavType.Companion.BoolListType.1 extends CollectionNavType {
    ...
    public List get(@NotNull Bundle bundle0, @NotNull String s) {
        boolean[] arr_z = (boolean[])q.i(bundle0, "bundle", s, "key", s);
        return arr_z == null ? null : ArraysKt___ArraysKt.toList(arr_z);
    }
    ...
    public List parseValue(@NotNull String s) {
        ...
        return k.listOf(NavType.BoolType.parseValue(s));
    }
    ...
    public void put(@NotNull Bundle bundle0, @NotNull String s, @Nullable List list0) {
        ...
        bundle0.putBooleanArray(s, (list0 == null ? null : CollectionsKt___CollectionsKt.toBooleanArray(list0)));
    }
    ...
    public boolean valueEquals(@Nullable List list0, @Nullable List list1) {
        ...
        Boolean[] arr_boolean1 = list0 == null ? null : ((Boolean[])list0.toArray(new Boolean[0]));
        if(list1 != null) {
            arr_boolean = (Boolean[])list1.toArray(new Boolean[0]);
        }
