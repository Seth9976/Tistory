...
public abstract class FloatLongMap {
    ...
    public final long getOrElse(float f, @NotNull Function0 function00) {
            ...
            while(true) {
                ...
                while(v5 < v4) {
                    if((v3 & 0xFFL) < 0x80L) {
                        ...
                        stringBuilder0.append(((CharSequence)function20.invoke(f, v7)));
                        ++v2;
                    }
                    v3 >>= 8;
                    ++v5;
    ...
    public static String joinToString$default(FloatLongMap floatLongMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        ...
        return floatLongMap0.joinToString(charSequence0, charSequence5, charSequence4, v, charSequence3);
    }
