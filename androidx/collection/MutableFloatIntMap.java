...
public final class MutableFloatIntMap extends FloatIntMap {
    ...
    public final int getOrPut(float f, @NotNull Function0 function00) {
    ...
    public final void plusAssign(@NotNull FloatIntMap floatIntMap0) {
    ...
    public final void putAll(@NotNull FloatIntMap floatIntMap0) {
        Intrinsics.checkNotNullParameter(floatIntMap0, "from");
