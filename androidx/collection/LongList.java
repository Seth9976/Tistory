...
public abstract class LongList {
    ...
    public final boolean containsAll(@NotNull LongList longList0) {
        Intrinsics.checkNotNullParameter(longList0, "elements");
        IntRange intRange0 = c.until(0, longList0._size);
    ...
    public final long elementAt(@androidx.annotation.IntRange(from = 0L) int v) {
        if(v >= 0 && v < this._size) {
    ...
    public final long elementAtOrElse(@androidx.annotation.IntRange(from = 0L) int v, @NotNull Function1 function10) {
    ...
    public final long get(@androidx.annotation.IntRange(from = 0L) int v) {
        if(v >= 0 && v < this._size) {
            return this.content[v];
        }
        StringBuilder stringBuilder0 = b.s(v, "Index ", " must be in 0..");
    ...
    public int hashCode() {
        ...
        int v2 = 0;
        for(int v1 = 0; v1 < v; ++v1) {
            v2 += Long.hashCode(arr_v[v1]) * 0x1F;
        }
        return v2;
    }
    ...
    public static String joinToString$default(LongList longList0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        ...
        return longList0.joinToString(charSequence0, charSequence5, charSequence4, v, charSequence3);
    }
    ...
    public final long last(@NotNull Function1 function10) {
        Intrinsics.checkNotNullParameter(function10, "predicate");
        long[] arr_v = this.content;
        for(int v = this._size - 1; -1 < v; --v) {
            long v1 = arr_v[v];
