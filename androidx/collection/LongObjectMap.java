...
public abstract class LongObjectMap {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; v4 = v6 + 1) {
                        if((0xFFL & v2) < 0x80L) {
                            ...
                            if(object1 == null) {
                                if(((LongObjectMap)object0).get(v7) != null || !((LongObjectMap)object0).containsKey(v7)) {
                                    return false;
                                }
                            }
                            else if(!Intrinsics.areEqual(object1, ((LongObjectMap)object0).get(v7))) {
                                return false;
                            }
                        }
                        else {
    ...
    public final Object getOrElse(long v, @NotNull Function0 function00) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L) {
                            ...
                            v2 += (object0 == null ? 0 : object0.hashCode()) ^ Long.hashCode(v7);
                        }
                        v3 >>= 8;
                    }
                    if(v4 != 8) {
    ...
    public static String joinToString$default(LongObjectMap longObjectMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        ...
        return longObjectMap0.joinToString(charSequence0, charSequence5, charSequence4, v, charSequence3);
    }
