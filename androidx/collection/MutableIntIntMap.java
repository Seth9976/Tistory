...
public final class MutableIntIntMap extends IntIntMap {
    ...
    public final int getOrPut(int v, @NotNull Function0 function00) {
    ...
    public final void plusAssign(@NotNull IntIntMap intIntMap0) {
    ...
    public final void putAll(@NotNull IntIntMap intIntMap0) {
        Intrinsics.checkNotNullParameter(intIntMap0, "from");
