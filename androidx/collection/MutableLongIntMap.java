...
public final class MutableLongIntMap extends LongIntMap {
    ...
    public final int getOrPut(long v, @NotNull Function0 function00) {
    ...
    public final void plusAssign(@NotNull LongIntMap longIntMap0) {
    ...
    public final void putAll(@NotNull LongIntMap longIntMap0) {
        Intrinsics.checkNotNullParameter(longIntMap0, "from");
