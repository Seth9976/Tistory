...
public final class MutableFloatFloatMap extends FloatFloatMap {
    ...
    public final float getOrPut(float f, @NotNull Function0 function00) {
    ...
    public final void plusAssign(@NotNull FloatFloatMap floatFloatMap0) {
    ...
    public final void putAll(@NotNull FloatFloatMap floatFloatMap0) {
        Intrinsics.checkNotNullParameter(floatFloatMap0, "from");
