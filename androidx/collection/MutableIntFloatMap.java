...
public final class MutableIntFloatMap extends IntFloatMap {
    ...
    public final float getOrPut(int v, @NotNull Function0 function00) {
    ...
    public final void plusAssign(@NotNull IntFloatMap intFloatMap0) {
    ...
    public final void putAll(@NotNull IntFloatMap intFloatMap0) {
        Intrinsics.checkNotNullParameter(intFloatMap0, "from");
