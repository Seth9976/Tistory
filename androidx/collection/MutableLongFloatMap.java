...
public final class MutableLongFloatMap extends LongFloatMap {
    ...
    public final float getOrPut(long v, @NotNull Function0 function00) {
    ...
    public final void plusAssign(@NotNull LongFloatMap longFloatMap0) {
    ...
    public final void putAll(@NotNull LongFloatMap longFloatMap0) {
        Intrinsics.checkNotNullParameter(longFloatMap0, "from");
