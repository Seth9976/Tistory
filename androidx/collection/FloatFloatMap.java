...
public abstract class FloatFloatMap {
    ...
    public final float getOrElse(float f, @NotNull Function0 function00) {
            ...
            for(int v1 = 0; true; ++v1) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L) {
                            int v6 = (v1 << 3) + v5;
                            v2 += Float.hashCode(arr_f1[v6]) ^ Float.hashCode(arr_f[v6]);
                        }
                        v3 >>= 8;
                    }
                    if(v4 != 8) {
    ...
    public static String joinToString$default(FloatFloatMap floatFloatMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        ...
        return floatFloatMap0.joinToString(charSequence0, charSequence5, charSequence4, v, charSequence3);
    }
