...
public final class MutableObjectIntMap extends ObjectIntMap {
    ...
    public final int getOrPut(Object object0, @NotNull Function0 function00) {
    ...
    public final void plusAssign(@NotNull ObjectIntMap objectIntMap0) {
    ...
    public final void putAll(@NotNull ObjectIntMap objectIntMap0) {
        Intrinsics.checkNotNullParameter(objectIntMap0, "from");
