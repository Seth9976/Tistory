...
public final class MutableIntObjectMap extends IntObjectMap {
    ...
    public final Object getOrPut(int v, @NotNull Function0 function00) {
    ...
    public final void plusAssign(@NotNull IntObjectMap intObjectMap0) {
    ...
    public final void putAll(@NotNull IntObjectMap intObjectMap0) {
        Intrinsics.checkNotNullParameter(intObjectMap0, "from");
