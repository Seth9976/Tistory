...
public class PagerTitleStrip extends ViewGroup {
    ...
    public PagerTitleStrip(@NonNull Context context0, @Nullable AttributeSet attributeSet0) {
        ...
        if(v != 0) {
            ...
            TextViewCompat.setTextAppearance(textView1, v);
            TextViewCompat.setTextAppearance(textView2, v);
        }
    ...
    public final void a(PagerAdapter pagerAdapter0, PagerAdapter pagerAdapter1) {
        a a0 = this.k;
        if(pagerAdapter0 != null) {
            pagerAdapter0.unregisterDataSetObserver(a0);
            this.l = null;
        }
        if(pagerAdapter1 != null) {
            pagerAdapter1.registerDataSetObserver(a0);
        ...
        if(viewPager0 != null) {
            this.e = -1;
            this.f = -1.0f;
            this.b(viewPager0.getCurrentItem(), pagerAdapter1);
            this.requestLayout();
        }
    }

    public final void b(int v, PagerAdapter pagerAdapter0) {
        if(pagerAdapter0 != null) {
        ...
        this.e = v;
        if(!this.j) {
            this.c(v, this.f, false);
        }
        this.i = false;
    }

    public void c(int v, float f, boolean z) {
        int v23;
        int v22;
        int v21;
        int v24;
        ...
        textView0.layout(v25, v21, v1 + v25, textView0.getMeasuredHeight() + v21);
    ...
    public void onAttachedToWindow() {
        ...
        this.a((this.l == null ? null : ((PagerAdapter)this.l.get())), ((ViewPager)viewParent0).getAdapter());
    }
    ...
    public void onLayout(boolean z, int v, int v1, int v2, int v3) {
        if(this.a != null) {
            this.c(this.e, (this.f >= 0.0f ? this.f : 0.0f), true);
        }
    }
    ...
    private static void setSingleLineAllCaps(TextView textView0) {
        ...
        c c0 = new c();  // 初始化器: Landroid/text/method/SingleLineTransformationMethod;-><init>()V
        c0.a = context0.getResources().getConfiguration().locale;
        textView0.setTransformationMethod(c0);
    }
