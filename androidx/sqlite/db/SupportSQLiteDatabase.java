...
public interface SupportSQLiteDatabase extends Closeable {
    ...
    void beginTransactionWithListener(@NotNull SQLiteTransactionListener arg1);

    void beginTransactionWithListenerNonExclusive(@NotNull SQLiteTransactionListener arg1);

    @NotNull
    SupportSQLiteStatement compileStatement(@NotNull String arg1);

    int delete(@NotNull String arg1, @Nullable String arg2, @Nullable Object[] arg3);
    ...
    default void execPerConnectionSQL(@NotNull String s, @SuppressLint({"ArrayReturn"}) @Nullable Object[] arr_object) {
        Intrinsics.checkNotNullParameter(s, "sql");
        throw new UnsupportedOperationException();
    }

    void execSQL(@NotNull String arg1) throws SQLException;

    void execSQL(@NotNull String arg1, @NotNull Object[] arg2) throws SQLException;
    ...
    long insert(@NotNull String arg1, int arg2, @NotNull ContentValues arg3) throws SQLException;
    ...
    @NotNull
    Cursor query(@NotNull SupportSQLiteQuery arg1);

    @RequiresApi(api = 16)
    @NotNull
    Cursor query(@NotNull SupportSQLiteQuery arg1, @Nullable CancellationSignal arg2);

    @NotNull
    Cursor query(@NotNull String arg1);

    @NotNull
    Cursor query(@NotNull String arg1, @NotNull Object[] arg2);

    @RequiresApi(api = 16)
    void setForeignKeyConstraintsEnabled(boolean arg1);

    void setLocale(@NotNull Locale arg1);
    ...
    int update(@NotNull String arg1, int arg2, @NotNull ContentValues arg3, @Nullable String arg4, @Nullable Object[] arg5);
