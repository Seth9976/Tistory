...
public final class p0 extends SuspendLambda implements Function2 {
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new p0(this.s, continuation0);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        try {
            flow0 = pageFetcherSnapshotState$Holder0.b.consumeAppendGenerationIdAsFlow();
        }
        finally {
            mutex1.unlock(null);
        }
        ...
        this.q = null;
        this.r = 2;
        return PageFetcherSnapshot.access$collectAsGenerationalViewportHints(pageFetcherSnapshot0, flow0, LoadType.APPEND, this) == object1 ? object1 : Unit.INSTANCE;
    }
}
