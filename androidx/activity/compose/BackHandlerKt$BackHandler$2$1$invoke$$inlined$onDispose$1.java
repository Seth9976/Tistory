...
public final class BackHandlerKt.BackHandler.2.1.invoke..inlined.onDispose.1 implements DisposableEffectResult {
    public final androidx.activity.compose.BackHandlerKt.BackHandler.backCallback.1.1 a;

    public BackHandlerKt.BackHandler.2.1.invoke..inlined.onDispose.1(androidx.activity.compose.BackHandlerKt.BackHandler.backCallback.1.1 backHandlerKt$BackHandler$backCallback$1$10) {
        this.a = backHandlerKt$BackHandler$backCallback$1$10;
        super();
    }
