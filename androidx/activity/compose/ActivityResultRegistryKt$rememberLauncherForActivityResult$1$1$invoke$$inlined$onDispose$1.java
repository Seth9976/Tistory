...
public final class ActivityResultRegistryKt.rememberLauncherForActivityResult.1.1.invoke..inlined.onDispose.1 implements DisposableEffectResult {
    ...
    public ActivityResultRegistryKt.rememberLauncherForActivityResult.1.1.invoke..inlined.onDispose.1(ActivityResultLauncherHolder activityResultLauncherHolder0) {
