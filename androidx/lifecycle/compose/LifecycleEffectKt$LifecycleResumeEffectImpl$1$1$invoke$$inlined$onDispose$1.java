...
public final class LifecycleEffectKt.LifecycleResumeEffectImpl.1.1.invoke..inlined.onDispose.1 implements DisposableEffectResult {
    ...
    public LifecycleEffectKt.LifecycleResumeEffectImpl.1.1.invoke..inlined.onDispose.1(LifecycleOwner lifecycleOwner0, LifecycleEventObserver lifecycleEventObserver0, ObjectRef ref$ObjectRef0) {
    ...
    public void dispose() {
        ...
        LifecyclePauseOrDisposeEffectResult lifecyclePauseOrDisposeEffectResult0 = (LifecyclePauseOrDisposeEffectResult)this.c.element;
