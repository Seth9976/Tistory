...
public final class LifecycleEffectKt.LifecycleStartEffectImpl.1.1.invoke..inlined.onDispose.1 implements DisposableEffectResult {
    public final LifecycleOwner a;
    public final LifecycleEventObserver b;
    public final ObjectRef c;

    public LifecycleEffectKt.LifecycleStartEffectImpl.1.1.invoke..inlined.onDispose.1(LifecycleOwner lifecycleOwner0, LifecycleEventObserver lifecycleEventObserver0, ObjectRef ref$ObjectRef0) {
    ...
    public void dispose() {
        ...
        LifecycleStopOrDisposeEffectResult lifecycleStopOrDisposeEffectResult0 = (LifecycleStopOrDisposeEffectResult)this.c.element;
