...
public final class e {
    ...
    public final c a(Class class0, Method[] arr_method) {
        ...
        for(int v = 0; v < arr_class.length; ++v) {
            ...
            for(Object object0: c1.b.entrySet()) {
                e.b(hashMap0, ((d)((Map.Entry)object0).getKey()), ((Event)((Map.Entry)object0).getValue()), class0);
            }
        }
        if(arr_method == null) {
        ...
        for(int v1 = 0; v1 < arr_method.length; ++v1) {
            ...
            if(onLifecycleEvent0 != null) {
                ...
                e.b(hashMap0, new d(method0, v2), lifecycle$Event0, class0);
                z = true;
            }
        }
        c c2 = new c(hashMap0);
    ...
    public static void b(HashMap hashMap0, d d0, Event lifecycle$Event0, Class class0) {
        Event lifecycle$Event1 = (Event)hashMap0.get(d0);
        if(lifecycle$Event1 != null && lifecycle$Event0 != lifecycle$Event1) {
            throw new IllegalArgumentException("Method " + d0.b.getName() + " in " + class0.getName() + " already declared with different @OnLifecycleEvent value: previous value " + lifecycle$Event1 + ", new value " + lifecycle$Event0);
        }
        if(lifecycle$Event1 == null) {
            hashMap0.put(d0, lifecycle$Event0);
        }
    }
}
