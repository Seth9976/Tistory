...
public final class ViewTreeViewModelStoreOwner {
    @JvmName(name = "get")
    @Nullable
    public static final ViewModelStoreOwner get(@NotNull View view0) {
        Intrinsics.checkNotNullParameter(view0, "<this>");
        return (ViewModelStoreOwner)SequencesKt___SequencesKt.firstOrNull(SequencesKt___SequencesKt.mapNotNull(SequencesKt__SequencesKt.generateSequence(view0, r0.y), t0.w));
    }

    @JvmName(name = "set")
    public static final void set(@NotNull View view0, @Nullable ViewModelStoreOwner viewModelStoreOwner0) {
        Intrinsics.checkNotNullParameter(view0, "<this>");
