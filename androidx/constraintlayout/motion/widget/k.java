...
public final class k {
    ...
    public k(MotionLayout motionLayout0) {
    ...
    public final void a(Canvas canvas0, int v, int v1, MotionController motionController0) {
        int v7;
        float f3;
        float f2;
        Paint paint1;
        ...
        if(view0 == null) {
            ...
            v4 = view0.getWidth();
            v5 = motionController0.b.getHeight();
        }
        int v6 = 1;
        while(v6 < v1 - 1) {
            if(v != 4 || arr_v[v6 - 1] != 0) {
                ...
                this.d.lineTo(f - 10.0f, f1);
                this.d.close();
                p p0 = (p)motionController0.u.get(v6 - 1);
                Paint paint0 = this.i;
                if(v == 4) {
                    int v8 = arr_v[v6 - 1];
                    if(v8 == 1) {
                        ...
                        f3 = f;
                        v7 = v6;
                        this.e(canvas0, f - 0.0f, f1 - 0.0f, v4, v5);
                        goto label_63;
                    }
                    paint1 = paint0;
                    f2 = f1;
                ...
                if(v == 6) {
                    this.e(canvas0, f3 - 0.0f, f2 - 0.0f, v4, v5);
                }
                canvas0.drawPath(this.d, paint1);
            }
            else {
