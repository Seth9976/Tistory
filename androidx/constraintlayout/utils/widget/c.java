    ...
    public final void a(ImageView imageView0) {
        ...
        if(f5 != 1.0f) {
            ...
            if(Float.compare(f6, 66.0f) >= 0) {
                ...
                f9 = f8;
                f10 = ((float)Math.log(f6 - 10.0f)) * 138.517731f - 305.0448f;
            }
            else {
                f9 = f8;
                f10 = 0.0f;
            ...
            arr_f[4] = 0.0f;
            arr_f[5] = 0.0f;
            arr_f[6] = Math.min(255.0f, Math.max(f9, 0.0f)) / 228.012512f;
            arr_f[7] = 0.0f;
            arr_f[8] = 0.0f;
            arr_f[9] = 0.0f;
            arr_f[10] = 0.0f;
            arr_f[11] = 0.0f;
            arr_f[12] = Math.min(255.0f, Math.max(f10, 0.0f)) / 205.93042f;
            arr_f[13] = 0.0f;
            arr_f[14] = 0.0f;
            arr_f[15] = 0.0f;
            arr_f[16] = 0.0f;
