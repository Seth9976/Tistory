...
public class Guideline extends View {
    ...
    public void setGuidelineBegin(int v) {
        ...
        if(this.a && constraintLayout$LayoutParams0.guideBegin == v) {
            return;
        }
    ...
    public void setGuidelineEnd(int v) {
        LayoutParams constraintLayout$LayoutParams0 = (LayoutParams)this.getLayoutParams();
        if(this.a && constraintLayout$LayoutParams0.guideEnd == v) {
            return;
        }
    ...
    public void setGuidelinePercent(float f) {
        LayoutParams constraintLayout$LayoutParams0 = (LayoutParams)this.getLayoutParams();
        if(this.a && constraintLayout$LayoutParams0.guidePercent == f) {
            return;
        }
