...
public class Placeholder extends View {
    ...
    public void setContentId(int v) {
        ...
        if(view0 != null) {
            ...
            ((LayoutParams)this.b.getLayoutParams()).isInPlaceholder = false;
            this.b = null;
        }
        this.a = v;
        if(v != -1) {
    ...
    public void updatePostMeasure(ConstraintLayout constraintLayout0) {
        ...
        constraintLayout$LayoutParams1.widget.setVisibility(0);
        DimensionBehaviour constraintWidget$DimensionBehaviour0 = DimensionBehaviour.FIXED;
        if(constraintLayout$LayoutParams0.widget.getHorizontalDimensionBehaviour() != constraintWidget$DimensionBehaviour0) {
            constraintLayout$LayoutParams0.widget.setWidth(constraintLayout$LayoutParams1.widget.getWidth());
        }
        if(constraintLayout$LayoutParams0.widget.getVerticalDimensionBehaviour() != constraintWidget$DimensionBehaviour0) {
            constraintLayout$LayoutParams0.widget.setHeight(constraintLayout$LayoutParams1.widget.getHeight());
        }
        constraintLayout$LayoutParams1.widget.setVisibility(8);
    }
    ...
    public void updatePreLayout(ConstraintLayout constraintLayout0) {
        ...
        this.b = view0;
        if(view0 != null) {
            ((LayoutParams)view0.getLayoutParams()).isInPlaceholder = true;
