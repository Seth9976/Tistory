...
public final class n implements MeasurePolicy {
    ...
    public n(Measurer measurer0, u u0, int v, MutableState mutableState0) {
        this.a = measurer0;
        this.b = u0;
        this.c = v;
    ...
    public final MeasureResult measure-3p2s80s(MeasureScope measureScope0, List list0, long v) {
        ...
        this.d.getValue();
        return MeasureScope.layout$default(measureScope0, IntSize.getWidth-impl(v1), IntSize.getHeight-impl(v1), null, new m(this.a, list0, 0), 4, null);
    }
