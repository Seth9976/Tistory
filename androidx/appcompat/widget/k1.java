...
public final class k1 {
    ...
    static {
        k1.l = new RectF();
        k1.m = new ConcurrentHashMap();
        new ConcurrentHashMap();
    }

    public k1(TextView textView0) {
        this.a = 0;
        this.b = false;
        this.c = -1.0f;
        this.d = -1.0f;
    ...
    public final int c(RectF rectF0) {
        ...
        while(v3 <= v1) {
            ...
            StaticLayout staticLayout0 = g1.a(charSequence2, ((Layout.Alignment)k1.e(textView0, "getLayoutAlignment", Layout.Alignment.ALIGN_NORMAL)), Math.round(rectF0.right), v6, textView0, this.h, this.k);
            if(v6 != -1 && (staticLayout0.getLineCount() > v6 || staticLayout0.getLineEnd(staticLayout0.getLineCount() - 1) != charSequence2.length()) || ((float)staticLayout0.getHeight()) > rectF0.bottom) {
                v2 = v4 - 1;
                v1 = v2;
            }
            else {
    ...
    public static Method d(String s) {
        try {
            ConcurrentHashMap concurrentHashMap0 = k1.m;
    ...
    public static Object e(TextView textView0, String s, Object object0) {
        try {
            return k1.d(s).invoke(textView0, null);
        }
        catch(Exception exception0) {
    ...
    public final void g(float f, int v) {
        ...
        if(f1 != textView0.getPaint().getTextSize()) {
            ...
            boolean z = f1.a(textView0);
            if(textView0.getLayout() != null) {
                try {
                    this.b = false;
                    Method method0 = k1.d("nullLayouts");
                    if(method0 != null) {
