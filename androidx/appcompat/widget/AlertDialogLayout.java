...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    public static int c(View view0) {
        ...
        return !(view0 instanceof ViewGroup) || ((ViewGroup)view0).getChildCount() != 1 ? 0 : AlertDialogLayout.c(((ViewGroup)view0).getChildAt(0));
    }
        ...
        for(int v3 = 0; v3 < v2; ++v3) {
            ...
            if(view3.getVisibility() != 8) {
                ...
                if(v4 == id.topPanel) {
                    ...
                    if(v4 != id.contentPanel && v4 != id.customPanel || view2 != null) {
