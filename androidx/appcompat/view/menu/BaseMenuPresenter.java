...
public abstract class BaseMenuPresenter implements MenuPresenter {
    ...
    public void addItemView(View view0, int v) {
    ...
    public ItemView createItemView(ViewGroup viewGroup0) {
        return (ItemView)this.mSystemInflater.inflate(this.c, viewGroup0, false);
    }
    ...
    public MenuView getMenuView(ViewGroup viewGroup0) {
        if(this.mMenuView == null) {
            MenuView menuView0 = (MenuView)this.mSystemInflater.inflate(this.b, viewGroup0, false);
    ...
    public void onCloseMenu(MenuBuilder menuBuilder0, boolean z) {
        Callback menuPresenter$Callback0 = this.a;
    ...
    public void setCallback(Callback menuPresenter$Callback0) {
        this.a = menuPresenter$Callback0;
    }
