...
public final class q implements ActionMode.Callback {
    ...
    public q(TextView textView0, ActionMode.Callback actionMode$Callback0) {
    ...
    public final boolean onPrepareActionMode(ActionMode actionMode0, Menu menu0) {
        ...
        if(context0 instanceof Activity) {
            for(Object object0: packageManager0.queryIntentActivities(new Intent().setAction("android.intent.action.PROCESS_TEXT").setType("text/plain"), 0)) {
                ...
                if("net.daum.android.tistoryapp".equals(resolveInfo0.activityInfo.packageName) || resolveInfo0.activityInfo.exported && (resolveInfo0.activityInfo.permission == null || context0.checkSelfPermission(resolveInfo0.activityInfo.permission) == 0)) {
