...
public final class h extends SuspendLambda implements Function2 {
    ...
    public h(State state0, MosaicAndBlurBitmapLoader mosaicAndBlurBitmapLoader0, Continuation continuation0) {
        this.p = state0;
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(this.o) {
            case 0: {
                ...
                Flow flow0 = SnapshotStateKt.snapshotFlow(new l(this.p, 19));
                g g0 = new g(this.q, null);
                this.o = 1;
                return FlowKt.collectLatest(flow0, g0, this) == object1 ? object1 : Unit.INSTANCE;
            }
            case 1: {
                ResultKt.throwOnFailure(object0);
