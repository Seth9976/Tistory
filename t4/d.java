...
public final class d extends SuspendLambda implements Function2 {
    ...
    public d(CoroutineContext coroutineContext0, LazyPagingItems lazyPagingItems0, Continuation continuation0) {
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new d(this.p, this.q, continuation0);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(this.o) {
            case 0: {
                ...
                if(z) {
                    this.o = 1;
                    if(lazyPagingItems0.collectPagingData$paging_compose_release(this) == object1) {
                        return object1;
                    }
                }
                else {
                    c c0 = new c(lazyPagingItems0, null);
                    this.o = 2;
