...
public final class d1 extends Lambda implements Function2 {
    ...
    public d1(WindowInsets windowInsets0, Function3 function30) {
    ...
    public final Object invoke(Object object0, Object object1) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(0xEAFB52A2, v, -1, "androidx.compose.material.BottomNavigation.<anonymous> (BottomNavigation.kt:114)");
        }
        Modifier modifier0 = SelectableGroupKt.selectableGroup(SizeKt.defaultMinSize-VpY3zN4$default(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), this.w), 0.0f, 56.0f, 1, null));
        ((Composer)object0).startReplaceableGroup(693286680);
        MeasurePolicy measurePolicy0 = RowKt.rowMeasurePolicy(Arrangement.INSTANCE.getSpaceBetween(), Alignment.Companion.getTop(), ((Composer)object0), 6);
