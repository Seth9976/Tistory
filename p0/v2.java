...
public final class v2 extends SuspendLambda implements Function2 {
    ...
    public v2(Animatable animatable0, float f, boolean z, w2 w20, Interaction interaction0, Continuation continuation0) {
        this.p = animatable0;
        this.q = f;
        this.r = z;
        this.s = w20;
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new v2(this.p, this.q, this.r, this.s, this.t, continuation0);
    }

    @Override  // kotlin.jvm.functions.Function2
    public final Object invoke(Object object0, Object object1) {
        return ((v2)this.create(((CoroutineScope)object0), ((Continuation)object1))).invokeSuspend(Unit.INSTANCE);
    }
            ...
            case 0: {
                ...
                if(!Dp.equals-impl0(f, f1)) {
                    if(this.r) {
                        ...
                        if(Dp.equals-impl0(f2, w20.b)) {
                            pressInteraction$Press0 = new Press(0L, null);
                        }
                        else if(Dp.equals-impl0(f2, w20.d)) {
                            pressInteraction$Press0 = new Enter();
                        }
                        else if(Dp.equals-impl0(f2, w20.e)) {
