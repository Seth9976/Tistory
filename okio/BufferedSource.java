...
public interface BufferedSource extends ReadableByteChannel, Source {
    ...
    long indexOf(@NotNull ByteString arg1) throws IOException;

    long indexOf(@NotNull ByteString arg1, long arg2) throws IOException;

    long indexOfElement(@NotNull ByteString arg1) throws IOException;

    long indexOfElement(@NotNull ByteString arg1, long arg2) throws IOException;
    ...
    boolean rangeEquals(long arg1, @NotNull ByteString arg2) throws IOException;

    boolean rangeEquals(long arg1, @NotNull ByteString arg2, int arg3, int arg4) throws IOException;

    int read(@NotNull byte[] arg1) throws IOException;

    int read(@NotNull byte[] arg1, int arg2, int arg3) throws IOException;

    long readAll(@NotNull Sink arg1) throws IOException;
    ...
    void readFully(@NotNull Buffer arg1, long arg2) throws IOException;

    void readFully(@NotNull byte[] arg1) throws IOException;
    ...
    @NotNull
    String readString(long arg1, @NotNull Charset arg2) throws IOException;

    @NotNull
    String readString(@NotNull Charset arg1) throws IOException;
    ...
    int select(@NotNull Options arg1) throws IOException;

    @Nullable
    Object select(@NotNull TypedOptions arg1) throws IOException;
