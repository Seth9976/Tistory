...
public final class -SegmentedByteString {
    ...
    public static final void commonCopyInto(@NotNull SegmentedByteString segmentedByteString0, int v, @NotNull byte[] arr_b, int v1, int v2) {
        ...
        for(int v4 = -SegmentedByteString.segment(segmentedByteString0, v); v < v3; ++v4) {
            ...
            ArraysKt___ArraysJvmKt.copyInto(segmentedByteString0.getSegments$okio()[v4], arr_b, v1, v7, v7 + v6);
            v1 += v6;
            v += v6;
        }
    }
    ...
    public static final boolean commonEquals(@NotNull SegmentedByteString segmentedByteString0, @Nullable Object object0) {
        Intrinsics.checkNotNullParameter(segmentedByteString0, "<this>");
        return object0 == segmentedByteString0 || object0 instanceof ByteString && ((ByteString)object0).size() == segmentedByteString0.size() && segmentedByteString0.rangeEquals(0, ((ByteString)object0), 0, segmentedByteString0.size());
    }
    ...
    public static final ByteString commonSubstring(@NotNull SegmentedByteString segmentedByteString0, int v, int v1) {
        ...
        if(v2 <= segmentedByteString0.size()) {
            ...
            byte[][] arr2_b = (byte[][])ArraysKt___ArraysJvmKt.copyOfRange(segmentedByteString0.getSegments$okio(), v4, v5 + 1);
    ...
    public static final byte[] commonToByteArray(@NotNull SegmentedByteString segmentedByteString0) {
        ...
        for(int v1 = 0; v < arr2_b.length; v1 = v4) {
            ...
            int v5 = v4 - v1;
            ArraysKt___ArraysJvmKt.copyInto(segmentedByteString0.getSegments$okio()[v], arr_b, v2, v3, v3 + v5);
            v2 += v5;
            ++v;
        }
        return arr_b;
    ...
    public static final void forEachSegment(@NotNull SegmentedByteString segmentedByteString0, @NotNull Function3 function30) {
        Intrinsics.checkNotNullParameter(segmentedByteString0, "<this>");
        ...
        for(int v1 = 0; v < arr2_b.length; v1 = v3) {
            ...
            function30.invoke(segmentedByteString0.getSegments$okio()[v], v2, ((int)(v3 - v1)));
            ++v;
        }
    }
