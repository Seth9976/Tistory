...
public final class Buffer implements Cloneable, ByteChannel, BufferedSink, BufferedSource {
    @Metadata(d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\t\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000B\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0010\u0012\n\u0002\b\u0006\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\r\u0010\u0005\u001A\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\u0015\u0010\t\u001A\u00020\u00042\u0006\u0010\b\u001A\u00020\u0007¢\u0006\u0004\b\t\u0010\nJ\u0015\u0010\f\u001A\u00020\u00072\u0006\u0010\u000B\u001A\u00020\u0007¢\u0006\u0004\b\f\u0010\rJ\u0015\u0010\u000F\u001A\u00020\u00072\u0006\u0010\u000E\u001A\u00020\u0004¢\u0006\u0004\b\u000F\u0010\u0010J\u000F\u0010\u0012\u001A\u00020\u0011H\u0016¢\u0006\u0004\b\u0012\u0010\u0003R\u0018\u0010\u0014\u001A\u0004\u0018\u00010\u00138\u0006@\u0006X\u0087\u000E¢\u0006\u0006\n\u0004\b\u0014\u0010\u0015R\u0016\u0010\u0017\u001A\u00020\u00168\u0006@\u0006X\u0087\u000E¢\u0006\u0006\n\u0004\b\u0017\u0010\u0018R$\u0010 \u001A\u0004\u0018\u00010\u00198\u0000@\u0000X\u0080\u000E¢\u0006\u0012\n\u0004\b\u001A\u0010\u001B\u001A\u0004\b\u001C\u0010\u001D\"\u0004\b\u001E\u0010\u001FR\u0016\u0010\b\u001A\u00020\u00078\u0006@\u0006X\u0087\u000E¢\u0006\u0006\n\u0004\b\b\u0010!R\u0018\u0010#\u001A\u0004\u0018\u00010\"8\u0006@\u0006X\u0087\u000E¢\u0006\u0006\n\u0004\b#\u0010$R\u0016\u0010%\u001A\u00020\u00048\u0006@\u0006X\u0087\u000E¢\u0006\u0006\n\u0004\b%\u0010&R\u0016\u0010\'\u001A\u00020\u00048\u0006@\u0006X\u0087\u000E¢\u0006\u0006\n\u0004\b\'\u0010&¨\u0006("}, d2 = {"Lokio/Buffer$UnsafeCursor;", "Ljava/io/Closeable;", "<init>", "()V", "", "next", "()I", "", "offset", "seek", "(J)I", "newSize", "resizeBuffer", "(J)J", "minByteCount", "expandBuffer", "(I)J", "", "close", "Lokio/Buffer;", "buffer", "Lokio/Buffer;", "", "readWrite", "Z", "Lokio/Segment;", "a", "Lokio/Segment;", "getSegment$okio", "()Lokio/Segment;", "setSegment$okio", "(Lokio/Segment;)V", "segment", "J", "", "data", "[B", "start", "I", "end", "okio"}, k = 1, mv = {1, 9, 0}, xi = 0x30)
    ...
    public final ByteString a(String s) {
        ...
        Intrinsics.checkNotNullExpressionValue(arr_b, "digest(...)");
        return new ByteString(arr_b);
    }

    public final ByteString b(String s, ByteString byteString0) {
        try {
    ...
    public final void c(InputStream inputStream0, long v, boolean z) {
        while(true) {
            if(v <= 0L && !z) {
                return;
            }
    ...
    @JvmOverloads
    @NotNull
    public final Buffer copyTo(@NotNull OutputStream outputStream0) throws IOException {
    ...
    @JvmOverloads
    @NotNull
    public final Buffer copyTo(@NotNull OutputStream outputStream0, long v) throws IOException {
        Intrinsics.checkNotNullParameter(outputStream0, "out");
    ...
    @JvmOverloads
    @NotNull
    public final Buffer copyTo(@NotNull OutputStream outputStream0, long v, long v1) throws IOException {
        Intrinsics.checkNotNullParameter(outputStream0, "out");
        -SegmentedByteString.checkOffsetAndCount(this.a, v, v1);
        if(v1 == 0L) {
            return this;
        }
        Segment segment0;
        ...
        while(v1 > 0L) {
            ...
            outputStream0.write(segment0.data, v4, v5);
            v1 -= (long)v5;
    ...
    public final Buffer copyTo(@NotNull Buffer buffer0, long v) {
        ...
        return this.copyTo(buffer0, v, this.a - v);
    }

    @NotNull
    public final Buffer copyTo(@NotNull Buffer buffer0, long v, long v1) {
        Intrinsics.checkNotNullParameter(buffer0, "out");
        -SegmentedByteString.checkOffsetAndCount(this.size(), v, v1);
        if(v1 != 0L) {
    ...
    public boolean equals(@Nullable Object object0) {
        if(this != object0) {
            if(!(object0 instanceof Buffer) || this.size() != ((Buffer)object0).size()) {
                return false;
            }
            if(this.size() != 0L) {
                Segment segment0 = this.head;
    ...
    @Override  // okio.BufferedSource
    public long indexOf(@NotNull ByteString byteString0) throws IOException {
        Intrinsics.checkNotNullParameter(byteString0, "bytes");
        return this.indexOf(byteString0, 0L);
    }

    @Override  // okio.BufferedSource
    public long indexOf(@NotNull ByteString byteString0, long v) throws IOException {
        int v6;
        long v1 = 0L;
        Intrinsics.checkNotNullParameter(byteString0, "bytes");
        ...
        if(segment0 != null) {
            if(Long.compare(this.size() - v, v) < 0) {
                ...
                while(v1 < v4) {
                    ...
                    for(v6 = (int)(((long)segment0.pos) + v - v1); v6 < v5; ++v6) {
                        if(arr_b1[v6] == v2 && -Buffer.rangeEquals(segment0, v6 + 1, arr_b, 1, v3)) {
            ...
            while(v1 < v10) {
                ...
                while(v6 < v11) {
                    if(arr_b3[v6] != v8 || !-Buffer.rangeEquals(segment0, v6 + 1, arr_b2, 1, v9)) {
                        ++v6;
                        continue;
                    }
                    return ((long)(v6 - segment0.pos)) + v1;
    ...
    public boolean rangeEquals(long v, @NotNull ByteString byteString0, int v1, int v2) {
        Intrinsics.checkNotNullParameter(byteString0, "bytes");
        if(Long.compare(v, 0L) >= 0 && v1 >= 0 && v2 >= 0 && this.size() - v >= ((long)v2) && byteString0.size() - v1 >= v2) {
    ...
    @Override
    public int read(@NotNull ByteBuffer byteBuffer0) throws IOException {
    ...
    @Override  // okio.BufferedSource
    public long readAll(@NotNull Sink sink0) throws IOException {
    ...
    @NotNull
    public final Buffer readFrom(@NotNull InputStream inputStream0) throws IOException {
        Intrinsics.checkNotNullParameter(inputStream0, "input");
        this.c(inputStream0, 0x7FFFFFFFFFFFFFFFL, true);
        return this;
    }

    @NotNull
    public final Buffer readFrom(@NotNull InputStream inputStream0, long v) throws IOException {
        Intrinsics.checkNotNullParameter(inputStream0, "input");
        if(v < 0L) {
            throw new IllegalArgumentException(q.n(v, "byteCount < 0: ").toString());
        }
        this.c(inputStream0, v, false);
        return this;
    }

    @Override  // okio.BufferedSource
    public void readFully(@NotNull Buffer buffer0, long v) throws EOFException {
        Intrinsics.checkNotNullParameter(buffer0, "sink");
        if(this.size() >= v) {
            buffer0.write(this, v);
            return;
    ...
    @Override  // okio.BufferedSource
    public void readFully(@NotNull byte[] arr_b) throws EOFException {
        Intrinsics.checkNotNullParameter(arr_b, "sink");
    ...
    @Override  // okio.BufferedSource
    @NotNull
    public String readString(long v, @NotNull Charset charset0) throws EOFException {
    ...
    public String readString(@NotNull Charset charset0) {
        Intrinsics.checkNotNullParameter(charset0, "charset");
        return this.readString(this.a, charset0);
    }
    ...
    public final ByteString sha256() {
        return this.a("SHA-256");
    }

    @NotNull
    public final ByteString sha512() {
        return this.a("SHA-512");
    }
    ...
    @Override
    public int write(@NotNull ByteBuffer byteBuffer0) throws IOException {
    ...
    @NotNull
    public Buffer write(@NotNull Source source0, long v) throws IOException {
    ...
    @Override  // okio.BufferedSink
    public long writeAll(@NotNull Source source0) throws IOException {
        Intrinsics.checkNotNullParameter(source0, "source");
        long v = 0L;
        long v1;
    ...
    @JvmOverloads
    @NotNull
    public final Buffer writeTo(@NotNull OutputStream outputStream0) throws IOException {
        Intrinsics.checkNotNullParameter(outputStream0, "out");
    ...
    @JvmOverloads
    @NotNull
    public final Buffer writeTo(@NotNull OutputStream outputStream0, long v) throws IOException {
        Intrinsics.checkNotNullParameter(outputStream0, "out");
        -SegmentedByteString.checkOffsetAndCount(this.a, 0L, v);
        Segment segment0 = this.head;
        while(v > 0L) {
            Intrinsics.checkNotNull(segment0);
            int v1 = (int)Math.min(v, segment0.limit - segment0.pos);
            outputStream0.write(segment0.data, segment0.pos, v1);
            int v2 = segment0.pos + v1;
            segment0.pos = v2;
            this.a -= (long)v1;
            v -= (long)v1;
