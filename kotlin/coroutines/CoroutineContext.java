...
public interface CoroutineContext {
    ...
    public static final class DefaultImpls {
        @NotNull
        public static CoroutineContext plus(@NotNull CoroutineContext coroutineContext0, @NotNull CoroutineContext coroutineContext1) {
            Intrinsics.checkNotNullParameter(coroutineContext1, "context");
            return coroutineContext1 == EmptyCoroutineContext.INSTANCE ? coroutineContext0 : ((CoroutineContext)coroutineContext1.fold(coroutineContext0, b.w));
        }
    }
    ...
    public interface Element extends CoroutineContext {
        ...
        public static final class kotlin.coroutines.CoroutineContext.Element.DefaultImpls {
            public static Object fold(@NotNull Element coroutineContext$Element0, Object object0, @NotNull Function2 function20) {
                Intrinsics.checkNotNullParameter(function20, "operation");
                return function20.invoke(object0, coroutineContext$Element0);
            }

            @Nullable
            public static Element get(@NotNull Element coroutineContext$Element0, @NotNull Key coroutineContext$Key0) {
            ...
            @NotNull
            public static CoroutineContext minusKey(@NotNull Element coroutineContext$Element0, @NotNull Key coroutineContext$Key0) {
                Intrinsics.checkNotNullParameter(coroutineContext$Key0, "key");
            ...
            @NotNull
            public static CoroutineContext plus(@NotNull Element coroutineContext$Element0, @NotNull CoroutineContext coroutineContext0) {
        ...
        Object fold(Object arg1, @NotNull Function2 arg2);
    ...
    @NotNull
    CoroutineContext plus(@NotNull CoroutineContext arg1);
}
