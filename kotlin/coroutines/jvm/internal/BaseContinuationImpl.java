...
public abstract class BaseContinuationImpl implements Serializable, Continuation, CoroutineStackFrame {
    ...
    public BaseContinuationImpl(@Nullable Continuation continuation0) {
        this.completion = continuation0;
    }

    @NotNull
    public Continuation create(@Nullable Object object0, @NotNull Continuation continuation0) {
        Intrinsics.checkNotNullParameter(continuation0, "completion");
        throw new UnsupportedOperationException("create(Any?;Continuation) has not been overridden");
    }

    @NotNull
    public Continuation create(@NotNull Continuation continuation0) {
        Intrinsics.checkNotNullParameter(continuation0, "completion");
    ...
    @Nullable
    public abstract Object invokeSuspend(@NotNull Object arg1);
