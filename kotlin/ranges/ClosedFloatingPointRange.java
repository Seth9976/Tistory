...
public interface ClosedFloatingPointRange extends ClosedRange {
    ...
    public static final class DefaultImpls {
        public static boolean contains(@NotNull ClosedFloatingPointRange closedFloatingPointRange0, @NotNull Comparable comparable0) {
        ...
        public static boolean isEmpty(@NotNull ClosedFloatingPointRange closedFloatingPointRange0) {
    ...
    boolean lessThanOrEquals(@NotNull Comparable arg1, @NotNull Comparable arg2);
}
