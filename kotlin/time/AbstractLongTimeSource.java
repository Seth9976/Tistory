...
public abstract class AbstractLongTimeSource implements WithComparableMarks {
    ...
    public AbstractLongTimeSource(@NotNull DurationUnit durationUnit0) {
        Intrinsics.checkNotNullParameter(durationUnit0, "unit");
        super();
        this.a = durationUnit0;
        this.b = c.lazy(new j(this, 25));
    }

    public static final long access$adjustedRead(AbstractLongTimeSource abstractLongTimeSource0) {
        return abstractLongTimeSource0.read() - ((Number)abstractLongTimeSource0.b.getValue()).longValue();
    }
    ...
    public ComparableTimeMark markNow() {
        return new b(this.read() - ((Number)this.b.getValue()).longValue(), this, 0L);
    }
