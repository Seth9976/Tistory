...
public final class OverridingUtilTypeSystemContext implements ClassicTypeSystemContext {
    public final Map a;
    public final TypeConstructorEquality b;
    public final KotlinTypeRefiner c;
    public final KotlinTypePreparator d;
    public final Function2 e;

    public OverridingUtilTypeSystemContext(@Nullable Map map0, @NotNull TypeConstructorEquality kotlinTypeChecker$TypeConstructorEquality0, @NotNull KotlinTypeRefiner kotlinTypeRefiner0, @NotNull KotlinTypePreparator kotlinTypePreparator0, @Nullable Function2 function20) {
        ...
        super();
        this.a = map0;
        this.b = kotlinTypeChecker$TypeConstructorEquality0;
        this.c = kotlinTypeRefiner0;
        this.d = kotlinTypePreparator0;
        this.e = function20;
    }
    ...
    public boolean areEqualTypeConstructors(@NotNull TypeConstructorMarker typeConstructorMarker0, @NotNull TypeConstructorMarker typeConstructorMarker1) {
        ...
        if(!DefaultImpls.areEqualTypeConstructors(this, typeConstructorMarker0, typeConstructorMarker1) && !this.b.equals(((TypeConstructor)typeConstructorMarker0), ((TypeConstructor)typeConstructorMarker1))) {
            Map map0 = this.a;
            if(map0 != null) {
                TypeConstructor typeConstructor0 = (TypeConstructor)map0.get(((TypeConstructor)typeConstructorMarker0));
                TypeConstructor typeConstructor1 = (TypeConstructor)map0.get(((TypeConstructor)typeConstructorMarker1));
                return typeConstructor0 != null && Intrinsics.areEqual(typeConstructor0, ((TypeConstructor)typeConstructorMarker1)) || typeConstructor1 != null && Intrinsics.areEqual(typeConstructor1, ((TypeConstructor)typeConstructorMarker0));
            }
            return false;
        }
        return true;
    ...
    public TypeCheckerState newTypeCheckerState(boolean z, boolean z1) {
        return this.e == null ? ClassicTypeCheckerStateKt.createClassicTypeCheckerState(z, z1, this, this.d, this.c) : new TypeCheckerState(z1, this, this.d, this.c) {
            public final OverridingUtilTypeSystemContext j;

            {
                this.j = overridingUtilTypeSystemContext0;
            ...
            public boolean customIsSubtypeOf(@NotNull KotlinTypeMarker kotlinTypeMarker0, @NotNull KotlinTypeMarker kotlinTypeMarker1) {
                ...
                return ((Boolean)this.j.e.invoke(kotlinTypeMarker0, kotlinTypeMarker1)).booleanValue();
            }
        };
    }
