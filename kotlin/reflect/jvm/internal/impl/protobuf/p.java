...
public final class p implements Comparable, Map.Entry {
    public final Comparable a;
    public Object b;
    public final l c;

    public p(l l0, Comparable comparable0, Object object0) {
        this.c = l0;
        this.a = comparable0;
        this.b = object0;
    }
    ...
    public final int compareTo(Object object0) {
        return this.a.compareTo(((p)object0).a);
    }
    ...
    public final String toString() {
        ...
        return b.q(new StringBuilder(s1.length() + (s.length() + 1)), s, "=", s1);
    }
}
