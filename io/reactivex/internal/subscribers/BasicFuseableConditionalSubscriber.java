...
public abstract class BasicFuseableConditionalSubscriber implements ConditionalSubscriber, QueueSubscription {
    ...
    protected final ConditionalSubscriber downstream;
    protected QueueSubscription qs;
    protected int sourceMode;
    protected Subscription upstream;

    public BasicFuseableConditionalSubscriber(ConditionalSubscriber conditionalSubscriber0) {
        this.downstream = conditionalSubscriber0;
    }
