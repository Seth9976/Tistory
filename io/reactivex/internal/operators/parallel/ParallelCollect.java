...
public final class ParallelCollect extends ParallelFlowable {
    ...
    public ParallelCollect(ParallelFlowable parallelFlowable0, Callable callable0, BiConsumer biConsumer0) {
    ...
    public void subscribe(Subscriber[] arr_subscriber) {
        ...
        for(int v1 = 0; v1 < arr_subscriber.length; ++v1) {
            ...
            arr_subscriber1[v1] = new a(arr_subscriber[v1], object0, this.c, 0);
        }
