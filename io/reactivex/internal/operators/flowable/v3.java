...
public final class v3 extends BasicQueueSubscription {
    public final long a;
    public long b;
    ...
    public v3(Subscriber subscriber0, long v, long v1, int v2) {
        this.d = v2;
        super();
        this.b = v;
        this.a = v1;
