...
public final class x1 extends AtomicReference implements MaybeObserver, Disposable {
    public final int a;
    public final AtomicInteger b;

    public x1(AtomicInteger atomicInteger0, int v) {
        this.a = v;
    ...
    public final void onComplete() {
        if(this.a != 0) {
            ...
            g10.d.delete(this);
            int v = g10.get();
            AtomicInteger atomicInteger0 = g10.e;
            if(v != 0 || !g10.compareAndSet(0, 1)) {
        ...
        y10.f.delete(this);
        int v1 = y10.get();
        AtomicInteger atomicInteger1 = y10.g;
        int v2 = y10.d;
        if(v1 != 0 || !y10.compareAndSet(0, 1)) {
            ...
            if(atomicInteger1.decrementAndGet() == 0) {
                z1 = true;
            }
            SpscLinkedArrayQueue spscLinkedArrayQueue1 = (SpscLinkedArrayQueue)y10.j.get();
            if(z1 && (spscLinkedArrayQueue1 == null || spscLinkedArrayQueue1.isEmpty())) {
                Throwable throwable1 = y10.h.terminate();
                Subscriber subscriber0 = y10.b;
                if(throwable1 != null) {
