...
public final class o extends Lambda implements Function2 {
    ...
    public o(int v, Modifier modifier0, PagerState pagerState0, boolean z, float f, PaddingValues paddingValues0, Horizontal alignment$Horizontal0, FlingBehavior flingBehavior0, Function1 function10, boolean z1, Function4 function40, int v1, int v2, int v3) {
        this.w = v;
        this.x = modifier0;
        this.y = pagerState0;
        this.z = z;
