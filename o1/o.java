...
public final class o extends Lambda implements Function1 {
    ...
    public o(FocusTargetNode focusTargetNode0, FocusTargetNode focusTargetNode1, int v, Function1 function10) {
        this.w = focusTargetNode0;
        this.x = focusTargetNode1;
        this.y = v;
        this.z = function10;
        super(1);
    }
    ...
    public final Object invoke(Object object0) {
        boolean z = OneDimensionalFocusSearchKt.f(this.w, this.x, this.y, this.z);
