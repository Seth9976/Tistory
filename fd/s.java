...
public final class s extends q {
    ...
    public s(ConditionalSubscriber conditionalSubscriber0, int v, SpscArrayQueue spscArrayQueue0, Worker scheduler$Worker0) {
        super(v, spscArrayQueue0, scheduler$Worker0);
        this.k = conditionalSubscriber0;
    }
    ...
    public final void run() {
        ...
        ConditionalSubscriber conditionalSubscriber0 = this.k;
        int v1 = this.b;
        int v2 = 1;
        while(true) {
            long v3 = this.h.get();
            ...
            if(v5 == 0) {
                ...
                if(this.f) {
                    ...
                    if(throwable1 != null) {
                        spscArrayQueue0.clear();
                        conditionalSubscriber0.onError(throwable1);
                        this.d.dispose();
                        return;
                    }
