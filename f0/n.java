...
public final class n extends Lambda implements Function2 {
    ...
    public n(PagerState pagerState0, Modifier modifier0, PaddingValues paddingValues0, PageSize pageSize0, int v, float f, Vertical alignment$Vertical0, TargetedFlingBehavior targetedFlingBehavior0, boolean z, boolean z1, Function1 function10, NestedScrollConnection nestedScrollConnection0, SnapPosition snapPosition0, Function4 function40, int v1, int v2, int v3) {
        this.w = pagerState0;
        this.x = modifier0;
