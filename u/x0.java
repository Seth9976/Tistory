...
public final class x0 extends Lambda implements Function3 {
    ...
    public x0(boolean z, String s, Role role0, Function0 function00) {
        this.w = z;
        this.x = s;
        this.y = role0;
        this.z = function00;
    ...
    public final Object invoke(Object object0, Object object1, Object object2) {
        ...
        ((Composer)object1).startReplaceGroup(0xD2EF1E09);
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(0xD2EF1E09, v, -1, "androidx.compose.foundation.clickable.<anonymous> (Clickable.kt:112)");
        }
        ...
        if(((Indication)object3) instanceof IndicationNodeFactory) {
            ((Composer)object1).startReplaceGroup(0x24C8CFF8);
            ((Composer)object1).endReplaceGroup();
            mutableInteractionSource0 = null;
        }
        else {
            ((Composer)object1).startReplaceGroup(0x24CA75BD);
        ...
        Modifier modifier1 = ClickableKt.clickable-O2vRcR0(Modifier.Companion, mutableInteractionSource0, ((Indication)object3), this.w, this.x, this.y, this.z);
        if(ComposerKt.isTraceInProgress()) {
