...
public final class e extends SuspendLambda implements Function2 {
    ...
    public e(AbstractClickableNode abstractClickableNode0, Press pressInteraction$Press0, Continuation continuation0) {
        ...
        switch(this.o) {
            case 0: {
                ...
                if(mutableInteractionSource0 != null) {
                    this.o = 1;
                    if(mutableInteractionSource0.emit(this.q, this) == object1) {
                        return object1;
                    }
                }
