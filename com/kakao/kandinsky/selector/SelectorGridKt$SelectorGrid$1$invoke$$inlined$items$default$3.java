...
public final class SelectorGridKt.SelectorGrid.1.invoke..inlined.items.default.3 extends Lambda implements Function2 {
    public final Function2 w;
    public final List x;

    public SelectorGridKt.SelectorGrid.1.invoke..inlined.items.default.3(Function2 function20, List list0) {
        this.w = function20;
        this.x = list0;
        super(2);
    }
