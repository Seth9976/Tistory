...
@SourceDebugExtension({"SMAP\nLazyGridDsl.kt\nKotlin\n*S Kotlin\n*F\n+ 1 LazyGridDsl.kt\nandroidx/compose/foundation/lazy/grid/LazyGridDslKt$items$5\n+ 2 SelectorGrid.kt\ncom/kakao/kandinsky/selector/SelectorGridKt$SelectorGrid$1\n*L\n1#1,569:1\n25#2,5:570\n*E\n"})
public final class SelectorGridKt.SelectorGrid.1.invoke..inlined.items.default.5 extends Lambda implements Function4 {
    public final List w;
    public final Function4 x;

    public SelectorGridKt.SelectorGrid.1.invoke..inlined.items.default.5(List list0, Function4 function40) {
        this.w = list0;
        this.x = function40;
        super(4);
    }
    ...
    public final void invoke(@NotNull LazyGridItemScope lazyGridItemScope0, int v, @Nullable Composer composer0, int v1) {
        ...
        Object object0 = this.w.get(v);
        Modifier modifier0 = AspectRatioKt.aspectRatio$default(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), 1.0f, false, 2, null);
        this.x.invoke(modifier0, object0, composer0, 6);
        if(ComposerKt.isTraceInProgress()) {
