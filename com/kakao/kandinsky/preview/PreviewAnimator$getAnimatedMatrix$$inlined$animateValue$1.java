...
public final class PreviewAnimator.getAnimatedMatrix..inlined.animateValue.1 extends Lambda implements Function3 {
    public static final PreviewAnimator.getAnimatedMatrix..inlined.animateValue.1 INSTANCE;

    static {
        PreviewAnimator.getAnimatedMatrix..inlined.animateValue.1.INSTANCE = new PreviewAnimator.getAnimatedMatrix..inlined.animateValue.1();
    }

    public PreviewAnimator.getAnimatedMatrix..inlined.animateValue.1() {
        super(3);
    }
