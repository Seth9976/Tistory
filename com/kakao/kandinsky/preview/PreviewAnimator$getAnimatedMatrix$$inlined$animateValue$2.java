...
public final class PreviewAnimator.getAnimatedMatrix..inlined.animateValue.2 extends Lambda implements Function3 {
    public static final PreviewAnimator.getAnimatedMatrix..inlined.animateValue.2 INSTANCE;

    static {
        PreviewAnimator.getAnimatedMatrix..inlined.animateValue.2.INSTANCE = new PreviewAnimator.getAnimatedMatrix..inlined.animateValue.2();
    }

    public PreviewAnimator.getAnimatedMatrix..inlined.animateValue.2() {
        super(3);
    }
