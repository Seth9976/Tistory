...
public final class StickerListKt.StickerList.4.1.invoke..inlined.items.default.4 extends Lambda implements Function1 {
    public final Function1 w;
    public final List x;

    public StickerListKt.StickerList.4.1.invoke..inlined.items.default.4(Function1 function10, List list0) {
        this.w = function10;
        this.x = list0;
        super(1);
    }
