...
@Metadata(d1 = {"\u0000\u001E\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000E\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u001A\u001E\u0010\u0000\u001A\u00020\u0001*\u00020\u00022\u0006\u0010\u0003\u001A\u00020\u00042\b\b\u0002\u0010\u0005\u001A\u00020\u0006H\u0000\u001A\u001E\u0010\u0007\u001A\u00020\b*\u00020\u00022\u0006\u0010\u0003\u001A\u00020\u00042\b\b\u0002\u0010\u0005\u001A\u00020\u0006H\u0000¨\u0006\t"}, d2 = {"getApplicationInfoCompat", "Landroid/content/pm/ApplicationInfo;", "Landroid/content/pm/PackageManager;", "packageName", "", "flags", "", "getPackageInfoCompat", "Landroid/content/pm/PackageInfo;", "editortracker_release"}, k = 2, mv = {1, 9, 0}, xi = 0x30)
public final class PackageManagerKt {
    @NotNull
    public static final ApplicationInfo getApplicationInfoCompat(@NotNull PackageManager packageManager0, @NotNull String s, int v) {
        ...
        if(Build.VERSION.SDK_INT >= 33) {
            applicationInfo0 = packageManager0.getApplicationInfo(s, PackageManager.ApplicationInfoFlags.of(v));
            Intrinsics.checkNotNull(applicationInfo0);
    ...
    public static ApplicationInfo getApplicationInfoCompat$default(PackageManager packageManager0, String s, int v, int v1, Object object0) {
        if((v1 & 2) != 0) {
            v = 0;
        }
        return PackageManagerKt.getApplicationInfoCompat(packageManager0, s, v);
    }
