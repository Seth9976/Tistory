...
public class LogBuilder {
    ...
    public LogBuilder(@NonNull TiaraTracker tiaraTracker0, String s) {
    ...
    public void actionType(@NonNull ActionType actionType0) {
    ...
    public LogBuilder location(boolean z, double f, double f1, Map map0) {
        ...
        try {
            s = "";
            s = GeoHash.geoHashStringWithCharacterPrecision(f, f1, 6);
        }
    ...
    @NonNull
    private Map mergeMap(@NonNull Map map0, @Nullable Map map1) {
        if(map1 != null) {
            map0.putAll(map1);
        }
        return map0;
