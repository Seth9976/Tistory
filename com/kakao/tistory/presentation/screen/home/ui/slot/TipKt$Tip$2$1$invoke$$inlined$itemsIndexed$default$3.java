...
@SourceDebugExtension({"SMAP\nLazyDsl.kt\nKotlin\n*S Kotlin\n*F\n+ 1 LazyDsl.kt\nandroidx/compose/foundation/lazy/LazyDslKt$itemsIndexed$4\n+ 2 Tip.kt\ncom/kakao/tistory/presentation/screen/home/ui/slot/TipKt$Tip$2$1\n*L\n1#1,433:1\n92#2,5:434\n*E\n"})
public final class TipKt.Tip.2.1.invoke..inlined.itemsIndexed.default.3 extends Lambda implements Function4 {
    public final List a;

    public TipKt.Tip.2.1.invoke..inlined.itemsIndexed.default.3(List list0) {
        this.a = list0;
        super(4);
    }
    ...
    public final void invoke(@NotNull LazyItemScope lazyItemScope0, int v, @Nullable Composer composer0, int v1) {
        ...
        Tip homeSlotUiStateContent$Tip0 = (Tip)this.a.get(v);
        composer0.startReplaceGroup(0x6C64F492);
        TipKt.access$TipEntry-RPmYEkk(homeSlotUiStateContent$Tip0, BackgroundColorList.INSTANCE.getSequential-vNxB06k(v), composer0, 0);
