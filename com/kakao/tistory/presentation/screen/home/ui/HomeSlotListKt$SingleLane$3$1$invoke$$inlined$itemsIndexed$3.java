...
@SourceDebugExtension({"SMAP\nLazyDsl.kt\nKotlin\n*S Kotlin\n*F\n+ 1 LazyDsl.kt\nandroidx/compose/foundation/lazy/LazyDslKt$itemsIndexed$4\n+ 2 HomeSlotList.kt\ncom/kakao/tistory/presentation/screen/home/ui/HomeSlotListKt$SingleLane$3$1\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n*L\n1#1,433:1\n171#2,4:434\n176#2:439\n148#3:438\n*S KotlinDebug\n*F\n+ 1 HomeSlotList.kt\ncom/kakao/tistory/presentation/screen/home/ui/HomeSlotListKt$SingleLane$3$1\n*L\n174#1:438\n*E\n"})
public final class HomeSlotListKt.SingleLane.3.1.invoke..inlined.itemsIndexed.3 extends Lambda implements Function4 {
    public final List a;
    public final State b;

    public HomeSlotListKt.SingleLane.3.1.invoke..inlined.itemsIndexed.3(List list0, State state0) {
        this.a = list0;
        this.b = state0;
        super(4);
    }
    ...
    public final void invoke(@NotNull LazyItemScope lazyItemScope0, int v, @Nullable Composer composer0, int v1) {
        ...
        HomeSlotUiState homeSlotUiState0 = (HomeSlotUiState)this.a.get(v);
        composer0.startReplaceGroup(-154670906);
        HomeSlotListKt.access$HomeSlot(homeSlotUiState0, composer0, 0);
        composer0.startReplaceGroup(0x4A067641);
        if(!(homeSlotUiState0 instanceof Today) && v != CollectionsKt__CollectionsKt.getLastIndex(HomeSlotListKt.access$SingleLane$lambda$2(this.b))) {
            b.a(10.0f, Modifier.Companion, composer0, 6);
        }
