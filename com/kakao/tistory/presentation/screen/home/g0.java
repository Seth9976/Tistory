...
public final class g0 extends SuspendLambda implements Function2 {
    ...
    public g0(HomeViewModel homeViewModel0, HomeIntent homeIntent0, Continuation continuation0) {
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new g0(this.b, this.c, continuation0);
    }

    @Override  // kotlin.jvm.functions.Function2
    public final Object invoke(Object object0, Object object1) {
        CoroutineScope coroutineScope0 = (CoroutineScope)object0;
        return new g0(this.b, this.c, ((Continuation)object1)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(this.a) {
            case 0: {
                ...
                String s = ((OnClickFollow)this.c).getBlogName();
                this.a = 1;
                object0 = this.b.j.invoke(s, this);
                if(object0 == object1) {
                    return object1;
                }
                break;
        ...
        if(((Result)object0) instanceof Success) {
            homeViewModel0.sendEvent(new ShowToast(null, Boxing.boxInt(string.blog_follow_toast), 1, null));
            return Unit.INSTANCE;
        }
        if(((Result)object0) instanceof Fail) {
            homeViewModel0.sendIntent(new FollowFail(((OnClickFollow)homeIntent0).getBlogName(), true));
        }
        return Unit.INSTANCE;
    }
}
