...
public final class BlogSwitchBottomSheetKt.BlogList.2.invoke..inlined.itemsIndexed.default.3 extends Lambda implements Function4 {
    public final List a;
    public final int b;
    public final Blog c;
    public final Blog d;
    ...
    public BlogSwitchBottomSheetKt.BlogList.2.invoke..inlined.itemsIndexed.default.3(List list0, int v, Blog blog0, Blog blog1, PaddingValues paddingValues0, Function2 function20) {
        this.a = list0;
        this.b = v;
        this.c = blog0;
        this.d = blog1;
    ...
    public final void invoke(@NotNull LazyItemScope lazyItemScope0, int v, @Nullable Composer composer0, int v1) {
        ...
        composer0.startReplaceGroup(0xCF9ADE3B);
        c c0 = new c(this.f, this.b + v, ((Blog)object0));
        BlogSwitchBottomSheetKt.access$BlogListItem(((Blog)object0), this.c, this.d, this.e, c0, composer0, 584);
