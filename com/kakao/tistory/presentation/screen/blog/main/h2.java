...
public final class h2 extends SuspendLambda implements Function2 {
    ...
    public h2(BlogMainViewModel blogMainViewModel0, String s, Continuation continuation0) {
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new h2(this.b, this.c, continuation0);
    }

    @Override  // kotlin.jvm.functions.Function2
    public final Object invoke(Object object0, Object object1) {
        CoroutineScope coroutineScope0 = (CoroutineScope)object0;
        return new h2(this.b, this.c, ((Continuation)object1)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        if(((Result)object0) instanceof Success) {
            blogMainViewModel0.sendIntent(new UpdateRecentNotice(((PagingModel)((Success)(((Result)object0))).getData()).getItems()));
        }
