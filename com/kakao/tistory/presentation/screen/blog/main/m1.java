...
public final class m1 extends SuspendLambda implements Function2 {
    ...
    public m1(BlogMainViewModel blogMainViewModel0, String s, Continuation continuation0) {
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new m1(this.b, this.c, continuation0);
    }

    @Override  // kotlin.jvm.functions.Function2
    public final Object invoke(Object object0, Object object1) {
        CoroutineScope coroutineScope0 = (CoroutineScope)object0;
        return new m1(this.b, this.c, ((Continuation)object1)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(this.a) {
            case 0: {
                ...
                this.a = 1;
                object0 = this.b.j.invoke(this.c, this);
                if(object0 == object1) {
                    return object1;
                }
                break;
        ...
        if(((Result)object0) instanceof Success) {
            BlogFollowEvent blogFollowEvent0 = new BlogFollowEvent(s, true);
            ChannelBus.INSTANCE.send(blogFollowEvent0);
            blogMainViewModel0.sendEvent(new ShowToast(null, Boxing.boxInt(string.blog_follow_toast), 1, null));
            return Unit.INSTANCE;
        }
        if(((Result)object0) instanceof Fail) {
            blogMainViewModel0.sendIntent(new ShowErrorDialog(((Fail)(((Result)object0))).getErrorModel()));
            blogMainViewModel0.sendIntent(new ChangeFollow(false));
        }
        return Unit.INSTANCE;
    }
}
