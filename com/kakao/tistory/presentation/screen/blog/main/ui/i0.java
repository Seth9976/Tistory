...
public final class i0 extends Lambda implements Function2 {
    public final ParticipationStatus a;
    public final int b;

    public i0(ParticipationStatus blogMainChallenge$ParticipationStatus0, int v) {
        this.a = blogMainChallenge$ParticipationStatus0;
        this.b = v;
        super(2);
    }
