...
@SourceDebugExtension({"SMAP\nLazyDsl.kt\nKotlin\n*S Kotlin\n*F\n+ 1 LazyDsl.kt\nandroidx/compose/foundation/lazy/LazyDslKt$itemsIndexed$4\n+ 2 BlogMainCategoryBottomSheet.kt\ncom/kakao/tistory/presentation/screen/blog/main/ui/BlogMainCategoryBottomSheetKt$BlogMainCategoryBottomSheet$2$1$1\n*L\n1#1,433:1\n88#2,7:434\n*E\n"})
public final class BlogMainCategoryBottomSheetKt.BlogMainCategoryBottomSheet.2.1.1.invoke..inlined.itemsIndexed.default.3 extends Lambda implements Function4 {
    public final List a;
    public final BlogMainCategoryItem b;
    public final Function0 c;
    public final List d;

    public BlogMainCategoryBottomSheetKt.BlogMainCategoryBottomSheet.2.1.1.invoke..inlined.itemsIndexed.default.3(List list0, BlogMainCategoryItem blogMainCategoryItem0, Function0 function00, List list1) {
        this.a = list0;
    ...
    public final void invoke(@NotNull LazyItemScope lazyItemScope0, int v, @Nullable Composer composer0, int v1) {
        ...
        composer0.startReplaceGroup(0x2A9828F2);
        boolean z = v != CollectionsKt__CollectionsKt.getLastIndex(this.d);
        BlogMainCategoryBottomSheetKt.access$Category(((BlogMainCategoryItem)object0), this.b.getId(), this.c, z, composer0, 0);
