...
import com.kakao.tistory.presentation.screen.revenue.RevenueScreenKt;
import kotlin.Unit;
...
public final class c extends Lambda implements Function4 {
    ...
    public c(NavController navController0, String s, NavActions navActions0) {
    ...
    public final void a(AnimatedContentScope animatedContentScope0, NavBackStackEntry navBackStackEntry0, Composer composer0, int v) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2100801169, v, -1, "com.kakao.tistory.presentation.screen.blog.navigation.blogScreen.<anonymous>.<anonymous> (BlogNavigation.kt:141)");
        }
        ...
        composer0.endReplaceGroup();
        RevenueScreenKt.RevenueScreen(this.c, ((BlogViewModel)viewModel0), null, composer0, 0x40, 4);
        if(ComposerKt.isTraceInProgress()) {
