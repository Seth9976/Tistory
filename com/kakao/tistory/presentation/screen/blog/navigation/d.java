...
import com.kakao.tistory.presentation.screen.blog.noticeList.BlogNoticeListScreenKt;
import kotlin.Unit;
...
public final class d extends Lambda implements Function4 {
    ...
    public d(NavController navController0, String s, NavActions navActions0) {
    ...
    public final void a(AnimatedContentScope animatedContentScope0, NavBackStackEntry navBackStackEntry0, Composer composer0, int v) {
        ...
        if(ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(0x48494DF0, v, -1, "com.kakao.tistory.presentation.screen.blog.navigation.blogScreen.<anonymous>.<anonymous> (BlogNavigation.kt:147)");
        }
        ...
        composer0.endReplaceGroup();
        BlogNoticeListScreenKt.BlogNoticeScreen(this.c, ((BlogViewModel)viewModel0), null, composer0, 0x40, 4);
        if(ComposerKt.isTraceInProgress()) {
