...
public final class h extends Lambda implements Function0 {
    ...
    public h(NoticeBottomSheet noticeBottomSheet0, State state0) {
    ...
    public final Object invoke() {
        BlogNoticeListScreenKt.access$BlogNoticeScreen$lambda$1(this.b).getModifyNotice().invoke(((Modify)this.a).getBlogName(), ((Modify)this.a).getId(), Boolean.valueOf(((Modify)this.a).getModifiable()));
