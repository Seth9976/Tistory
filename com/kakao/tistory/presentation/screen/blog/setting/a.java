...
public final class a extends SuspendLambda implements Function2 {
    ...
    public a(ViewState viewState0, NavActions navActions0, State state0, Continuation continuation0) {
        this.a = viewState0;
        this.b = navActions0;
        this.c = state0;
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new a(this.a, this.b, this.c, continuation0);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        if(viewState0 instanceof Success) {
            BlogSettingScreenKt.access$BlogSettingScreen$lambda$1(this.c).getChangeBlogInfo().invoke(((Success)this.a).getItem());
        }
        return Unit.INSTANCE;
    }
}
