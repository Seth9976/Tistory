...
public final class d3 extends Lambda implements Function2 {
    ...
    public d3(String s, boolean z, boolean z1, AppBarHomeAsUpButtonType tistoryToolbar$AppBarHomeAsUpButtonType0, Function0 function00, Integer integer0, Integer integer1, Function0 function01, int v, int v1) {
        this.a = s;
        this.b = z;
        this.c = z1;
