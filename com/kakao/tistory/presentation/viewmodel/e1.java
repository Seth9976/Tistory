...
public final class e1 extends SuspendLambda implements Function2 {
    ...
    public e1(EditorViewModel editorViewModel0, boolean z, String s, long v, String s1, Integer integer0, EntryVisibilityType entryVisibilityType0, String s2, String s3, long v1, String s4, List list0, Integer integer1, Continuation continuation0) {
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new e1(this.b, this.c, this.d, this.e, this.f, this.g, this.h, this.i, this.j, this.k, this.l, this.m, this.n, continuation0);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(this.a) {
            case 0: {
                ...
                this.a = 1;
                object2 = this.b.g.modifyEntry(this.d, this.e, this.f, this.g, this.h, this.i, this.j, Boxing.boxLong(this.k), ((int)this.c), this.l, this.m, this.n, (editorChallenge0 == null ? null : editorChallenge0.getChallengeCode()), this);
                if(object2 == object1) {
                    return object1;
                }
                break;
        ...
        if(((Result)object2) instanceof Success) {
            ...
            Logger.INSTANCE.log("modify entry : " + ((Success)(((Result)object2))));
