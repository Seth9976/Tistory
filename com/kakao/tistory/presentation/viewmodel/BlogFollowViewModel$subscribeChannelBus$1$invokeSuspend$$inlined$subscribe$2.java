...
@SourceDebugExtension({"SMAP\nChannelBus.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ChannelBus.kt\ncom/kakao/tistory/presentation/common/eventbus/ChannelBus$subscribe$2\n+ 2 BlogFollowViewModel.kt\ncom/kakao/tistory/presentation/viewmodel/BlogFollowViewModel$subscribeChannelBus$1\n*L\n1#1,39:1\n108#2,4:40\n*E\n"})
public final class BlogFollowViewModel.subscribeChannelBus.1.invokeSuspend..inlined.subscribe.2 implements FlowCollector {
    public final BlogFollowViewModel a;

    public BlogFollowViewModel.subscribeChannelBus.1.invokeSuspend..inlined.subscribe.2(BlogFollowViewModel blogFollowViewModel0) {
