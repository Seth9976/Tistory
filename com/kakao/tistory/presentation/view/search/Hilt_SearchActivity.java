...
public abstract class Hilt_SearchActivity extends TistoryComposeActivity implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if(!this.j) {
            this.j = true;
            ((SearchActivity_GeneratedInjector)this.generatedComponent()).injectSearchActivity(((SearchActivity)this));
        }
    }
}
