...
public abstract class Hilt_KakaoLoginActivity extends TistoryActivity implements GeneratedComponentManagerHolder {
    public volatile ActivityComponentManager g;
    public final Object h;
    public boolean i;

    public Hilt_KakaoLoginActivity() {
        this.h = new Object();
        this.i = false;
    ...
    public void inject() {
        if(!this.i) {
            this.i = true;
            ((KakaoLoginActivity_GeneratedInjector)this.generatedComponent()).injectKakaoLoginActivity(((KakaoLoginActivity)this));
        }
    }
}
