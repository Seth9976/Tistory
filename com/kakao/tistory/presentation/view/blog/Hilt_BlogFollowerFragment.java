...
public abstract class Hilt_BlogFollowerFragment extends TistoryComposeFragment implements GeneratedComponentManagerHolder {
    ...
    public Hilt_BlogFollowerFragment() {
        this.i = new Object();
        this.j = false;
    }
    ...
    public void inject() {
        if(!this.j) {
            this.j = true;
            ((BlogFollowerFragment_GeneratedInjector)this.generatedComponent()).injectBlogFollowerFragment(((BlogFollowerFragment)this));
        }
    }
