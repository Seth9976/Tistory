...
public abstract class Hilt_BlogFollowingFragment extends TistoryComposeFragment implements GeneratedComponentManagerHolder {
    ...
    public Hilt_BlogFollowingFragment() {
        this.i = new Object();
        this.j = false;
    }
    ...
    public void inject() {
        if(!this.j) {
            this.j = true;
            ((BlogFollowingFragment_GeneratedInjector)this.generatedComponent()).injectBlogFollowingFragment(((BlogFollowingFragment)this));
        }
    }
