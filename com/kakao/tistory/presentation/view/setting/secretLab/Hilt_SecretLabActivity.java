...
public abstract class Hilt_SecretLabActivity extends TistoryToolbarComposeActivity implements GeneratedComponentManagerHolder {
    public volatile ActivityComponentManager p;
    public final Object q;
    public boolean r;

    public Hilt_SecretLabActivity() {
        this.q = new Object();
        this.r = false;
    ...
    public void inject() {
        if(!this.r) {
            this.r = true;
            ((SecretLabActivity_GeneratedInjector)this.generatedComponent()).injectSecretLabActivity(((SecretLabActivity)this));
        }
    }
}
