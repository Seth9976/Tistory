...
public final class SettingDefaultBlogActivity.Content.2.1.invoke..inlined.items.default.4 extends Lambda implements Function4 {
    public final List a;
    public final SettingDefaultBlogActivity b;
    public final State c;

    public SettingDefaultBlogActivity.Content.2.1.invoke..inlined.items.default.4(List list0, SettingDefaultBlogActivity settingDefaultBlogActivity0, State state0) {
        this.a = list0;
    ...
    public final void invoke(@NotNull LazyItemScope lazyItemScope0, int v, @Nullable Composer composer0, int v1) {
        ...
        composer0.startReplaceGroup(0x52F9CF9);
        ...
        this.b.BlogItem(modifier0, ((Blog)object0), Intrinsics.areEqual((blog0 == null ? null : blog0.getName()), ((Blog)object0).getName()), new s(SettingDefaultBlogActivity.access$getDefaultBlogViewModel(this.b)), composer0, 0x8040, 0);
