...
public abstract class Hilt_UsedAccountFragment extends TistoryComposeFragment implements GeneratedComponentManagerHolder {
    ...
    public Hilt_UsedAccountFragment() {
        this.i = new Object();
        this.j = false;
    }
    ...
    public void inject() {
        if(!this.j) {
            this.j = true;
            ((UsedAccountFragment_GeneratedInjector)this.generatedComponent()).injectUsedAccountFragment(((UsedAccountFragment)this));
        }
    }
