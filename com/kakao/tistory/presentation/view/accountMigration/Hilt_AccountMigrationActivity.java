...
public abstract class Hilt_AccountMigrationActivity extends TistoryActivity implements GeneratedComponentManagerHolder {
    public volatile ActivityComponentManager g;
    public final Object h;
    public boolean i;

    public Hilt_AccountMigrationActivity() {
        this.h = new Object();
        this.i = false;
    ...
    public void inject() {
        if(!this.i) {
            this.i = true;
            ((AccountMigrationActivity_GeneratedInjector)this.generatedComponent()).injectAccountMigrationActivity(((AccountMigrationActivity)this));
        }
    }
}
