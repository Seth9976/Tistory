...
public abstract class Hilt_LoginFragment extends TistoryComposeFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if(!this.j) {
            this.j = true;
            ((LoginFragment_GeneratedInjector)this.generatedComponent()).injectLoginFragment(((LoginFragment)this));
        }
    }
