...
public final class RefererEtcListFragment.Content.1.invoke..inlined.items.default.2 extends Lambda implements Function1 {
    public final Function1 a;
    public final List b;

    public RefererEtcListFragment.Content.1.invoke..inlined.items.default.2(Function1 function10, List list0) {
        this.a = function10;
        this.b = list0;
        super(1);
    }
