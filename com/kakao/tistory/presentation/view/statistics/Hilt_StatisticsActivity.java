...
public abstract class Hilt_StatisticsActivity extends TistoryToolbarActivity implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if(!this.q) {
            this.q = true;
            ((StatisticsActivity_GeneratedInjector)this.generatedComponent()).injectStatisticsActivity(((StatisticsActivity)this));
        }
    }
}
