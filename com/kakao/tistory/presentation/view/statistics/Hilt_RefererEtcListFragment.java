...
public abstract class Hilt_RefererEtcListFragment extends TistoryComposeFragment implements GeneratedComponentManagerHolder {
    ...
    public Hilt_RefererEtcListFragment() {
        this.i = new Object();
        this.j = false;
    }
    ...
    public void inject() {
        if(!this.j) {
            this.j = true;
            ((RefererEtcListFragment_GeneratedInjector)this.generatedComponent()).injectRefererEtcListFragment(((RefererEtcListFragment)this));
        }
    }
