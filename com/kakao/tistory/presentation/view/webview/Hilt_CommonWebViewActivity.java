...
public abstract class Hilt_CommonWebViewActivity extends TistoryActivity implements GeneratedComponentManagerHolder {
    public volatile ActivityComponentManager g;
    public final Object h;
    public boolean i;

    public Hilt_CommonWebViewActivity() {
        this.h = new Object();
        this.i = false;
        this.addOnContextAvailableListener(new d0(this));
    }
    ...
    public void inject() {
        if(!this.i) {
            this.i = true;
            ((CommonWebViewActivity_GeneratedInjector)this.generatedComponent()).injectCommonWebViewActivity(((CommonWebViewActivity)this));
        }
    }
}
