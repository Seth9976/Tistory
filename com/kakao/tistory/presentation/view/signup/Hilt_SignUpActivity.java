...
public abstract class Hilt_SignUpActivity extends TistoryComposeActivity implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if(!this.j) {
            this.j = true;
            ((SignUpActivity_GeneratedInjector)this.generatedComponent()).injectSignUpActivity(((SignUpActivity)this));
        }
    }
}
