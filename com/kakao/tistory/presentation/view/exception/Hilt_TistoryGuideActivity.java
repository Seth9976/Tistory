...
public abstract class Hilt_TistoryGuideActivity extends TistoryToolbarComposeActivity implements GeneratedComponentManagerHolder {
    public volatile ActivityComponentManager p;
    public final Object q;
    public boolean r;

    public Hilt_TistoryGuideActivity() {
        this.q = new Object();
        this.r = false;
    ...
    public void inject() {
        if(!this.r) {
            this.r = true;
            ((TistoryGuideActivity_GeneratedInjector)this.generatedComponent()).injectTistoryGuideActivity(((TistoryGuideActivity)this));
        }
    }
}
