...
@SourceDebugExtension({"SMAP\nLazyDsl.kt\nKotlin\n*S Kotlin\n*F\n+ 1 LazyDsl.kt\nandroidx/compose/foundation/lazy/LazyDslKt$itemsIndexed$4\n+ 2 CommentBottomSheet.kt\ncom/kakao/tistory/presentation/view/comment/CommentBottomSheetKt$CommentMenuList$1\n+ 3 Composer.kt\nandroidx/compose/runtime/ComposerKt\n*L\n1#1,433:1\n94#2,4:434\n99#2:444\n1223#3,6:438\n*S KotlinDebug\n*F\n+ 1 CommentBottomSheet.kt\ncom/kakao/tistory/presentation/view/comment/CommentBottomSheetKt$CommentMenuList$1\n*L\n97#1:438,6\n*E\n"})
public final class CommentBottomSheetKt.CommentMenuList.1.invoke..inlined.itemsIndexed.default.3 extends Lambda implements Function4 {
    public final List a;
    public final List b;
    public final Function1 c;

    public CommentBottomSheetKt.CommentMenuList.1.invoke..inlined.itemsIndexed.default.3(List list0, List list1, Function1 function10) {
        this.a = list0;
        this.b = list1;
        this.c = function10;
        super(4);
    ...
    public final void invoke(@NotNull LazyItemScope lazyItemScope0, int v, @Nullable Composer composer0, int v1) {
        ...
        CommentMenuItem commentMenuItem0 = (CommentMenuItem)this.a.get(v);
        composer0.startReplaceGroup(-2009663504);
        String s = StringResources_androidKt.stringResource(commentMenuItem0.getTitleResId(), composer0, 0);
        boolean z = v != CollectionsKt__CollectionsKt.getLastIndex(this.b);
        composer0.startReplaceGroup(0x8043EA41);
        boolean z1 = composer0.changed(this.c);
        boolean z2 = composer0.changed(commentMenuItem0);
        m m0 = composer0.rememberedValue();
        if(z1 || z2 || m0 == Composer.Companion.getEmpty()) {
            m0 = new m(this.c, commentMenuItem0);
            composer0.updateRememberedValue(m0);
        }
        composer0.endReplaceGroup();
        CommentBottomSheetKt.access$CommentMenuItem(s, z, m0, composer0, 0);
        composer0.endReplaceGroup();
        if(ComposerKt.isTraceInProgress()) {
