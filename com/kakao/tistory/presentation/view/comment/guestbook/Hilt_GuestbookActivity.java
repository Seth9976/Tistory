...
public abstract class Hilt_GuestbookActivity extends CommentActivity implements GeneratedComponentManagerHolder {
    public volatile ActivityComponentManager h;
    public final Object i;
    public boolean j;

    public Hilt_GuestbookActivity() {
        this.i = new Object();
        this.j = false;
    ...
    public void inject() {
        if(!this.j) {
            this.j = true;
            ((GuestbookActivity_GeneratedInjector)this.generatedComponent()).injectGuestbookActivity(((GuestbookActivity)this));
        }
    }
}
