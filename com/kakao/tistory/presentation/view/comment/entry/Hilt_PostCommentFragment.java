...
public abstract class Hilt_PostCommentFragment extends CommentFragment implements GeneratedComponentManagerHolder {
    ...
    public Hilt_PostCommentFragment() {
        this.l = new Object();
        this.m = false;
    }
    ...
    public void inject() {
        if(!this.m) {
            this.m = true;
            ((PostCommentFragment_GeneratedInjector)this.generatedComponent()).injectPostCommentFragment(((PostCommentFragment)this));
        }
    }
