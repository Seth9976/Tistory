...
public abstract class Hilt_EntryPasswordDialogFragment extends BaseDialogFragment implements GeneratedComponentManagerHolder {
    ...
    public Hilt_EntryPasswordDialogFragment() {
        this.d = new Object();
        this.e = false;
    }
    ...
    public void inject() {
        if(!this.e) {
            this.e = true;
            ((EntryPasswordDialogFragment_GeneratedInjector)this.generatedComponent()).injectEntryPasswordDialogFragment(((EntryPasswordDialogFragment)this));
        }
    }
