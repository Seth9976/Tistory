...
public abstract class Hilt_LeaveActivity extends TistoryToolbarComposeActivity implements GeneratedComponentManagerHolder {
    public volatile ActivityComponentManager p;
    public final Object q;
    public boolean r;

    public Hilt_LeaveActivity() {
        this.q = new Object();
        this.r = false;
    ...
    public void inject() {
        if(!this.r) {
            this.r = true;
            ((LeaveActivity_GeneratedInjector)this.generatedComponent()).injectLeaveActivity(((LeaveActivity)this));
        }
    }
}
