...
public final class f1 extends Lambda implements Function0 {
    ...
    public f1(CommentModifyModel commentModifyModel0, TextFieldValue textFieldValue0) {
    ...
    public final Object invoke() {
        this.a.getOnClickCancel().invoke(Boolean.valueOf(!Intrinsics.areEqual(this.b.getText(), "")));
