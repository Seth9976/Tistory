...
public abstract class Hilt_SplashActivity extends TistoryActivity implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if(!this.i) {
            this.i = true;
            ((SplashActivity_GeneratedInjector)this.generatedComponent()).injectSplashActivity(((SplashActivity)this));
        }
    }
}
