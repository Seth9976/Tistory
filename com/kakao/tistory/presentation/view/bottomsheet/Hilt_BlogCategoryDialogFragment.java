...
public abstract class Hilt_BlogCategoryDialogFragment extends BaseBottomSheetDialogFragment implements GeneratedComponentManagerHolder {
    ...
    public Hilt_BlogCategoryDialogFragment() {
        this.d = new Object();
        this.e = false;
    }
    ...
    public void inject() {
        if(!this.e) {
            this.e = true;
            ((BlogCategoryDialogFragment_GeneratedInjector)this.generatedComponent()).injectBlogCategoryDialogFragment(((BlogCategoryDialogFragment)this));
        }
    }
