...
public abstract class Hilt_ReportDialogFragment extends BaseBottomSheetDialogFragment implements GeneratedComponentManagerHolder {
    ...
    public Hilt_ReportDialogFragment() {
        this.d = new Object();
        this.e = false;
    }
    ...
    public void inject() {
        if(!this.e) {
            this.e = true;
            ((ReportDialogFragment_GeneratedInjector)this.generatedComponent()).injectReportDialogFragment(((ReportDialogFragment)this));
        }
    }
