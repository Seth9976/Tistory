...
public abstract class Hilt_TopPostListActivity extends TistoryAppCompatActivity implements GeneratedComponentManagerHolder {
    public volatile ActivityComponentManager d;
    public final Object e;
    public boolean f;

    public Hilt_TopPostListActivity() {
        this.e = new Object();
        this.f = false;
    ...
    public void inject() {
        if(!this.f) {
            this.f = true;
            ((TopPostListActivity_GeneratedInjector)this.generatedComponent()).injectTopPostListActivity(((TopPostListActivity)this));
        }
    }
}
