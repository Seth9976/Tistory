...
public final class p0 extends Lambda implements Function1 {
    ...
    public p0(EditorActivity editorActivity0) {
    ...
    public final Object invoke(Object object0) {
        ...
        String s = this.a.getString(string.label_dialog_editor_save_draft_complete);
        Intrinsics.checkNotNullExpressionValue(s, "getString(...)");
        View view0 = EditorActivity.access$getDataBinding(this.a).getRoot();
        ...
        EditorActivity.access$getDraftViewModel(this.a).requestRefresh();
