...
public abstract class Hilt_EditorSettingFragment extends TistoryComposeFragment implements GeneratedComponentManagerHolder {
    ...
    public Hilt_EditorSettingFragment() {
        this.i = new Object();
        this.j = false;
    }
    ...
    public void inject() {
        if(!this.j) {
            this.j = true;
            ((EditorSettingFragment_GeneratedInjector)this.generatedComponent()).injectEditorSettingFragment(((EditorSettingFragment)this));
        }
    }
