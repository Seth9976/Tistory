...
public abstract class Hilt_EditorTagFragment extends TistoryComposeFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if(!this.j) {
            this.j = true;
            ((EditorTagFragment_GeneratedInjector)this.generatedComponent()).injectEditorTagFragment(((EditorTagFragment)this));
        }
    }
