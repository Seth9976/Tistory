...
public abstract class Hilt_RefererKeywordListActivity extends TistoryToolbarComposeActivity implements GeneratedComponentManagerHolder {
    public volatile ActivityComponentManager p;
    public final Object q;
    public boolean r;

    public Hilt_RefererKeywordListActivity() {
        this.q = new Object();
        this.r = false;
    ...
    public void inject() {
        if(!this.r) {
            this.r = true;
            ((RefererKeywordListActivity_GeneratedInjector)this.generatedComponent()).injectRefererKeywordListActivity(((RefererKeywordListActivity)this));
        }
    }
}
