...
@SourceDebugExtension({"SMAP\nLazyDsl.kt\nKotlin\n*S Kotlin\n*F\n+ 1 LazyDsl.kt\nandroidx/compose/foundation/lazy/LazyDslKt$items$4\n+ 2 RefererKeywordListActivity.kt\ncom/kakao/tistory/presentation/view/home/RefererKeywordListActivity$Content$1\n*L\n1#1,433:1\n82#2,2:434\n*E\n"})
public final class RefererKeywordListActivity.Content.1.invoke..inlined.items.default.4 extends Lambda implements Function4 {
    public final List a;
    public final RefererKeywordListActivity b;

    public RefererKeywordListActivity.Content.1.invoke..inlined.items.default.4(List list0, RefererKeywordListActivity refererKeywordListActivity0) {
        this.a = list0;
    ...
    public final void invoke(@NotNull LazyItemScope lazyItemScope0, int v, @Nullable Composer composer0, int v1) {
        ...
        RefererKeywordItem statisticsItem$RefererKeywordItem0 = (RefererKeywordItem)this.a.get(v);
        composer0.startReplaceGroup(0xB41B5A09);
        RefererKeywordListActivity.access$KeywordItem(this.b, statisticsItem$RefererKeywordItem0, composer0, 72);
