...
public abstract class Hilt_BlogActivity extends TistoryAppCompatActivity implements GeneratedComponentManagerHolder {
    ...
    public Hilt_BlogActivity() {
        this.e = new Object();
        this.f = false;
        this.addOnContextAvailableListener(new k(this));
    }
    ...
    public void inject() {
        if(!this.f) {
            this.f = true;
            ((BlogActivity_GeneratedInjector)this.generatedComponent()).injectBlogActivity(((BlogActivity)this));
        }
    }
}
