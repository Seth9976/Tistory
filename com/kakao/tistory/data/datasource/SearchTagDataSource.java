...
public final class SearchTagDataSource extends BaseSearchDataSource {
    ...
    public Object loadItems(int v, boolean z, int v1, @NotNull Function2 function20, @NotNull Function1 function10, @NotNull Continuation continuation0) {
        SearchTagDataSource searchTagDataSource0;
        l l0;
        ...
        switch(l0.g) {
            case 0: {
                ...
                l0.d = z;
                l0.g = 1;
                object0 = this.b.getPostsFromTags(this.c, this.d, v1, v, (this.e == null ? "accuracy" : this.e), l0);
                if(object0 == object1) {
                    return object1;
                }
                searchTagDataSource0 = this;
                break;
            }
            case 1: {
                z = l0.d;
        ...
        if(((Result)object0) instanceof Success) {
            function20.invoke(searchTagDataSource0.convertEntryItems(((ItemListModel)((Success)(((Result)object0))).getData()), z), ((ItemListModel)((Success)(((Result)object0))).getData()).getNextPage());
