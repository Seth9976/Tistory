...
public final class UnPinGuestBookCommentUseCase {
    ...
    public final Object invoke(@NotNull String s, long v, @NotNull Continuation continuation0) {
        return this.a.unpinGuestBookComment(s, v, continuation0);
    }
}
