...
public final class DeleteGuestbookUseCase {
    ...
    public final Object invoke(@NotNull String s, long v, @NotNull Continuation continuation0) {
        return this.a.deleteGuestbook(s, v, continuation0);
    }
}
