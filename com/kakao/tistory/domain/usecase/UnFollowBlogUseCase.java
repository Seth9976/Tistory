    ...
    public final Object invoke(@NotNull String s, @NotNull Continuation continuation0) {
        ...
        switch(k0.c) {
            case 0: {
                ...
                k0.c = 1;
                object0 = this.a.deleteFollowBlog(s, k0);
                if(object0 == object1) {
                    return object1;
                }
                break;
        ...
        return ((Result)object0) instanceof Fail && Intrinsics.areEqual("EXCEPTION_UNKNOWN_STATUS", "CAN_NOT_FOLLOW_BLOG") ? new Success(Unit.INSTANCE) : ((Result)object0);
    }
}
