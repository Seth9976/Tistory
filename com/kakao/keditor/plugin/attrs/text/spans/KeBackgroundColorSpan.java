...
public final class KeBackgroundColorSpan extends BackgroundColorSpan implements KeAttributeSpan {
    ...
    public void updateDrawState(@NotNull TextPaint textPaint0) {
        ...
        String s = b.f(1, "#%06X", "format(...)", new Object[]{((int)(0xFFFFFF & this.getBackgroundColor()))});
        ColorType colorType0 = ColorType.Companion.getTypeByString(s);
        if(colorType0 != null) {
            textPaint0.bgColor = ContextCompat.getColor(this.context, colorType0.getColorRes());
            return;
        }
        textPaint0.bgColor = this.getBackgroundColor();
    }
}
