...
@Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000E\n\u0002\b\f\n\u0002\u0010\u000B\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\b\u0086\b\u0018\u00002\u00020\u0001B\u001D\u0012\u0006\u0010\u0002\u001A\u00020\u0003\u0012\u0006\u0010\u0004\u001A\u00020\u0003\u0012\u0006\u0010\u0005\u001A\u00020\u0003¢\u0006\u0002\u0010\u0006J\t\u0010\u000B\u001A\u00020\u0003HÆ\u0003J\t\u0010\f\u001A\u00020\u0003HÆ\u0003J\t\u0010\r\u001A\u00020\u0003HÆ\u0003J\'\u0010\u000E\u001A\u00020\u00002\b\b\u0002\u0010\u0002\u001A\u00020\u00032\b\b\u0002\u0010\u0004\u001A\u00020\u00032\b\b\u0002\u0010\u0005\u001A\u00020\u0003HÆ\u0001J\u0013\u0010\u000F\u001A\u00020\u00102\b\u0010\u0011\u001A\u0004\u0018\u00010\u0012HÖ\u0003J\u000E\u0010\u0013\u001A\u00020\u00032\u0006\u0010\u0014\u001A\u00020\u0015J\t\u0010\u0016\u001A\u00020\u0017HÖ\u0001J\t\u0010\u0018\u001A\u00020\u0003HÖ\u0001R\u0011\u0010\u0005\u001A\u00020\u0003¢\u0006\b\n\u0000\u001A\u0004\b\u0007\u0010\bR\u0011\u0010\u0002\u001A\u00020\u0003¢\u0006\b\n\u0000\u001A\u0004\b\t\u0010\bR\u0011\u0010\u0004\u001A\u00020\u0003¢\u0006\b\n\u0000\u001A\u0004\b\n\u0010\b¨\u0006\u0019"}, d2 = {"Lcom/kakao/keditor/plugin/itemspec/grammarcheck/SingleGrammarCheck;", "Ljava/io/Serializable;", "input", "", "output", "etype", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", "getEtype", "()Ljava/lang/String;", "getInput", "getOutput", "component1", "component2", "component3", "copy", "equals", "", "other", "", "getErrorMessage", "context", "Landroid/content/Context;", "hashCode", "", "toString", "keditor_release"}, k = 1, mv = {1, 9, 0}, xi = 0x30)
public final class SingleGrammarCheck implements Serializable {
    @NotNull
    ...
    @NotNull
    public final String getErrorMessage(@NotNull Context context0) {
        String s;
        Intrinsics.checkNotNullParameter(context0, "context");
        switch(this.etype) {
            case "no_error": {
                s = context0.getString(string.grammar_info_error_no_error);
                break;
            }
            case "space": {
                s = context0.getString(string.grammar_info_error_space);
                break;
            }
            case "space_spell": {
                s = context0.getString(string.grammar_info_error_space_spell);
                break;
            }
            case "spell": {
                s = context0.getString(string.grammar_info_error_spell);
                break;
            }
            default: {
                s = context0.getString(string.grammar_info_error_doubt);
            }
        }
    ...
    @Override
    public int hashCode() {
        return this.etype.hashCode() + q.c(this.input.hashCode() * 0x1F, 0x1F, this.output);
    }

    @Override
    @NotNull
    public String toString() {
        return a.o(b.w("SingleGrammarCheck(input=", this.input, ", output=", this.output, ", etype="), this.etype, ")");
    }
}
