package com.kakao.keditor.plugin.pluginspec.codeblock;
...
import com.kakao.keditor.plugin.pluginspec.codeblock.editor.CodeBlockEditorActivity;
...
public final class CodeBlockPluginSpec implements ActivityResultHandler, EditorSupporter, PluginSpec {
    ...
    public CodeBlockPluginSpec() {
        this.itemSpecKeys = k.listOf("codeblock");
        this.toolbarOverlayMenuItem = new ToolbarOverlayMenuItem(id.ke_overlay_code_block, drawable.ke_toolbar_btn_menu_item_code_block, string.cd_add_code_block, string.plugin_more_code_block, null, 16, null);
        ...
        this.editorOpener = new IntentLauncher() {
            ...
            public Intent getEditorIntent(AppCompatActivity appCompatActivity0, KeditorItem keditorItem0) {
                return this.getEditorIntent(appCompatActivity0, ((CodeBlockItem)keditorItem0));
            }

            @NotNull
            public Intent getEditorIntent(@NotNull AppCompatActivity appCompatActivity0, @Nullable CodeBlockItem codeBlockItem0) {
                Intrinsics.checkNotNullParameter(appCompatActivity0, "activity");
                Intent intent0 = new Intent(appCompatActivity0, CodeBlockEditorActivity.class);
                CodeBlockPluginSpec codeBlockPluginSpec0 = CodeBlockPluginSpec.this;
                if(codeBlockItem0 != null) {
                    intent0.putExtra("data", codeBlockItem0);
                }
                ItemSpecs itemSpecs0 = codeBlockPluginSpec0.getItemSpecs();
                ArrayList arrayList0 = null;
                RootItemSpec rootItemSpec0 = itemSpecs0 == null ? null : itemSpecs0.byType("codeblock");
                CodeBlockItemSpec codeBlockItemSpec0 = rootItemSpec0 instanceof CodeBlockItemSpec ? ((CodeBlockItemSpec)rootItemSpec0) : null;
                if(codeBlockItemSpec0 != null) {
                    arrayList0 = codeBlockItemSpec0.getSupportedLanguages();
                }
                intent0.putExtra("languages", arrayList0);
                return intent0;
            }
        };
        this.editorResultHandler = new com.kakao.keditor.plugin.pluginspec.codeblock.CodeBlockPluginSpec.editorResultHandler.1();

        @Metadata(d1 = {"\u0000\u001D\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u001A\u0010\u0002\u001A\u00020\u00032\u0006\u0010\u0004\u001A\u00020\u00052\b\u0010\u0006\u001A\u0004\u0018\u00010\u0007H\u0016¨\u0006\b"}, d2 = {"com/kakao/keditor/plugin/pluginspec/codeblock/CodeBlockPluginSpec$editorResultHandler$1", "Lcom/kakao/keditor/plugin/EditorResultHandler;", "onEditorResult", "", "resultCode", "", "data", "Landroid/content/Intent;", "keditor_release"}, k = 1, mv = {1, 9, 0}, xi = 0x30)
        public final class com.kakao.keditor.plugin.pluginspec.codeblock.CodeBlockPluginSpec.editorResultHandler.1 implements EditorResultHandler {
            ...
            public void onEditorResult(int v, @Nullable Intent intent0) {
                ...
                if(intent0 != null) {
                    CodeBlockItem codeBlockItem0 = (CodeBlockItem)IntentKt.getSerializableExtraCompat(intent0, "data", CodeBlockItem.class);
                    if(codeBlockItem0 != null) {
                        if(intent0.getBooleanExtra("is_edit_flag", false)) {
                            ReplaceItems viewRequest$ReplaceItems0 = new ReplaceItems(0, k.listOf(codeBlockItem0), 0, false, 13, null);
                            KeEvent.INSTANCE.postInScope(viewRequest$ReplaceItems0);
                            RequestFocus viewRequest$RequestFocus0 = new RequestFocus(0, false, 3, null);
                            KeEvent.INSTANCE.postInScope(viewRequest$RequestFocus0);
                            return;
                        }
                        AddKeditorItems viewRequest$AddKeditorItems0 = new AddKeditorItems(k.listOf(codeBlockItem0), 0, false, false, 14, null);
    ...
    public List createKeditorItems(int v) {
        ...
        if(itemSpecs0 != null) {
            RootItemSpec rootItemSpec0 = itemSpecs0.byType("codeblock");
    ...
    public void onRequest(@NotNull PluginSpecRequest pluginSpecRequest0) {
        ...
        if(pluginSpecRequest0 instanceof EditKeditorItem) {
            ...
            if(activity0 != null) {
                ...
                com.kakao.keditor.plugin.EditorSupporter.DefaultImpls.openEditor$default(this, activity0, null, ((CodeBlockItem)keditorItem0), 2, null);
            }
        }
    }
    ...
    public void openEditor(Activity activity0, EventFlow eventFlow0, KeditorItem keditorItem0) {
        this.openEditor(activity0, eventFlow0, ((CodeBlockItem)keditorItem0));
    }

    public void openEditor(@NotNull Activity activity0, @Nullable EventFlow eventFlow0, @Nullable CodeBlockItem codeBlockItem0) {
        com.kakao.keditor.plugin.EditorSupporter.DefaultImpls.openEditor(this, activity0, eventFlow0, codeBlockItem0);
    }
    ...
    public void runIconClick() {
        ...
        Keditor.clickEvent$default(Keditor.INSTANCE, "moremenu", "codeblock", null, 4, null);
    }
