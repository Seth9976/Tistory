package com.kakao.keditor.plugin.pluginspec.paragraph;
...
public final class ParagraphPluginSpec implements PluginSpec {
    ...
    public ParagraphPluginSpec() {
        this.itemSpecKeys = CollectionsKt__CollectionsKt.listOf(new String[]{"paragraph", "heading"});
        this.contextMenuResource = drawable.ke_toolbar_btn_text_t;
        this.contextMenuDescription = string.cd_set_text_style;
    }
    ...
    public List createKeditorItems(int v) {
        return k.listOf(Companion.newInstance$default(ParagraphItem.Companion, false, false, 3, null));
    }
    ...
    public void runIconClick() {
        ...
        Keditor.clickEvent$default(Keditor.INSTANCE, "toolbar", "paragraph", null, 4, null);
    }
