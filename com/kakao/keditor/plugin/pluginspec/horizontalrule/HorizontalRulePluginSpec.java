package com.kakao.keditor.plugin.pluginspec.horizontalrule;
...
public final class HorizontalRulePluginSpec implements PluginSpec {
    ...
    public HorizontalRulePluginSpec() {
        this.itemSpecKeys = k.listOf("horizontalRule");
        this.toolbarOverlayMenuItem = new ToolbarOverlayMenuItem(id.ke_overlay_horizontal_rule, drawable.ke_toolbar_btn_menu_item_horizontal_line, string.cd_add_horizontal_rule, string.plugin_more_horizontal_rule, null, 16, null);
    }
    ...
    public List createKeditorItems(int v) {
        ...
        if(itemSpecs0 != null) {
            RootItemSpec rootItemSpec0 = itemSpecs0.byType("horizontalRule");
    ...
    public void runIconClick() {
        AddKeditorItems viewRequest$AddKeditorItems0 = new AddKeditorItems(DefaultImpls.createKeditorItems$default(this, 0, 1, null), 0, false, false, 14, null);
        KeEvent.INSTANCE.postInScope(viewRequest$AddKeditorItems0);
        Keditor.clickEvent$default(Keditor.INSTANCE, "moremenu", "horizontalRule", null, 4, null);
    }
