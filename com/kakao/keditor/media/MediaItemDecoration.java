...
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J(\u0010\u0003\u001A\u00020\u00042\u0006\u0010\u0005\u001A\u00020\u00062\u0006\u0010\u0007\u001A\u00020\b2\u0006\u0010\t\u001A\u00020\n2\u0006\u0010\u000B\u001A\u00020\fH\u0016¨\u0006\r"}, d2 = {"Lcom/kakao/keditor/media/MediaItemDecoration;", "Landroidx/recyclerview/widget/RecyclerView$ItemDecoration;", "()V", "getItemOffsets", "", "outRect", "Landroid/graphics/Rect;", "view", "Landroid/view/View;", "recyclerView", "Landroidx/recyclerview/widget/RecyclerView;", "state", "Landroidx/recyclerview/widget/RecyclerView$State;", "keditor_release"}, k = 1, mv = {1, 9, 0}, xi = 0x30)
public final class MediaItemDecoration extends ItemDecoration {
    @NotNull
    public static final MediaItemDecoration INSTANCE;

    static {
        MediaItemDecoration.INSTANCE = new MediaItemDecoration();
    }
    ...
    public void getItemOffsets(@NotNull Rect rect0, @NotNull View view0, @NotNull RecyclerView recyclerView0, @NotNull State recyclerView$State0) {
        ...
        if(v1 != -1 && v1 <= v && ((KeditorItem)keditorAdapter0.get(v1)) instanceof MediaItem) {
            rect0.top = UnitConversionKt.dp2pxRoundDown(5.0f);
            rect0.bottom = UnitConversionKt.dp2pxRoundDown(5.0f);
            if(v1 > 0 && ((KeditorItem)keditorAdapter0.get(v1 - 1)) instanceof MediaItem) {
                rect0.top = 0;
            }
        }
    }
