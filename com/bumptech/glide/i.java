...
public abstract class i {
    public static Registry a(Glide glide0, List list0, AppGlideModule appGlideModule0) {
        ...
        Context context0 = glide0.d.getApplicationContext();
        GlideExperiments glideExperiments0 = glide0.d.getExperiments();
        ...
        List list1 = registry0.getImageHeaderParsers();
        ByteBufferGifDecoder byteBufferGifDecoder0 = new ByteBufferGifDecoder(context0, list1, bitmapPool0, arrayPool0);
        ...
        if(v < 28 || !glideExperiments0.isEnabled(d.class)) {
        ...
        if(v >= 28) {
            registry0.append("Animation", class2, class1, AnimatedImageDecoder.streamDecoder(list1, arrayPool0));
            registry0.append("Animation", class0, class1, AnimatedImageDecoder.byteBufferDecoder(list1, arrayPool0));
        }
        ...
        Registry registry3 = registry2.append("Bitmap", AssetFileDescriptor.class, class3, resourceDecoder1).append(class3, class3, Factory.getInstance()).append("Bitmap", class3, class3, new UnitBitmapDecoder()).append(class3, bitmapEncoder0);
        ...
        StreamGifDecoder streamGifDecoder0 = new StreamGifDecoder(list1, byteBufferGifDecoder0, arrayPool0);
