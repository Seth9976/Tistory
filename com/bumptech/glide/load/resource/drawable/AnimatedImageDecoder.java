...
public final class AnimatedImageDecoder {
    ...
    public AnimatedImageDecoder(List list0, ArrayPool arrayPool0) {
        this.a = list0;
        this.b = arrayPool0;
    }
    ...
    public static a a(ImageDecoder.Source imageDecoder$Source0, int v, int v1, Options options0) {
        ...
        return new a(((AnimatedImageDrawable)drawable0), 0);
    }

    public static ResourceDecoder byteBufferDecoder(List list0, ArrayPool arrayPool0) {
        return new b(new AnimatedImageDecoder(list0, arrayPool0), 0);
    }

    public static ResourceDecoder streamDecoder(List list0, ArrayPool arrayPool0) {
        return new b(new AnimatedImageDecoder(list0, arrayPool0), 1);
    }
}
