...
public class RangeSlider extends BaseSlider {
    public interface OnChangeListener extends BaseOnChangeListener {
        void onValueChange(@NonNull RangeSlider arg1, float arg2, boolean arg3);

        @Override  // com.google.android.material.slider.BaseOnChangeListener
        default void onValueChange(@NonNull Object object0, float f, boolean z) {
            this.onValueChange(((RangeSlider)object0), f, z);
        }
    }

    public interface OnSliderTouchListener extends BaseOnSliderTouchListener {
        void onStartTrackingTouch(@NonNull RangeSlider arg1);

        @Override  // com.google.android.material.slider.BaseOnSliderTouchListener
        default void onStartTrackingTouch(@NonNull Object object0) {
            this.onStartTrackingTouch(((RangeSlider)object0));
        }

        void onStopTrackingTouch(@NonNull RangeSlider arg1);

        @Override  // com.google.android.material.slider.BaseOnSliderTouchListener
        default void onStopTrackingTouch(@NonNull Object object0) {
            this.onStopTrackingTouch(((RangeSlider)object0));
        }
    }
    ...
    public RangeSlider(@NonNull Context context0, @Nullable AttributeSet attributeSet0, int v) {
        ...
        TypedArray typedArray0 = ThemeEnforcement.obtainStyledAttributes(context0, attributeSet0, styleable.RangeSlider, v, BaseSlider.j0, new int[0]);
        if(typedArray0.hasValue(styleable.RangeSlider_values)) {
            int v2 = typedArray0.getResourceId(styleable.RangeSlider_values, 0);
            TypedArray typedArray1 = typedArray0.getResources().obtainTypedArray(v2);
            ArrayList arrayList0 = new ArrayList();
            for(int v1 = 0; v1 < typedArray1.length(); ++v1) {
                arrayList0.add(typedArray1.getFloat(v1, -1.0f));
            }
            this.setValues(arrayList0);
        }
        this.o0 = typedArray0.getDimension(styleable.RangeSlider_minSeparation, 0.0f);
        typedArray0.recycle();
    }
    ...
    public void onRestoreInstanceState(@Nullable Parcelable parcelable0) {
        super.onRestoreInstanceState(((f)parcelable0).getSuperState());
        this.o0 = ((f)parcelable0).a;
        this.p0 = ((f)parcelable0).b;
        this.setSeparationUnit(((f)parcelable0).b);
    }

    @Override  // com.google.android.material.slider.BaseSlider
    @NonNull
    public Parcelable onSaveInstanceState() {
        Parcelable parcelable0 = new f(super.onSaveInstanceState());
        parcelable0.a = this.o0;
        parcelable0.b = this.p0;
        return parcelable0;
    }
