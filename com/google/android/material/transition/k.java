...
public final class k extends Drawable {
    ...
    public final void d(float f) {
        ...
        float f4;
        this.L = f;
        this.m.setAlpha(((int)(this.r ? p.c(0.0f, 255.0f, f) : p.c(255.0f, 0.0f, f))));
        float f1 = this.p;
        ...
        j j0 = this.A;
        float f6 = (float)(((Float)Preconditions.checkNotNull(j0.b.a)));
        float f7 = (float)(((Float)Preconditions.checkNotNull(j0.b.b)));
        float f8 = this.b.width();
        float f9 = this.b.height();
        float f10 = this.f.width();
        float f11 = this.f.height();
        g g0 = this.C.evaluate(f, f6, f7, f8, f9, f10, f11);
        this.H = g0;
        RectF rectF0 = this.w;
        rectF0.set(f2 - g0.c / 2.0f, f3, g0.c / 2.0f + f2, g0.d + f3);
        ...
        RectF rectF2 = this.z;
        rectF2.set(this.y);
        float f13 = (float)(((Float)Preconditions.checkNotNull(j0.c.a)));
        float f14 = (float)(((Float)Preconditions.checkNotNull(j0.c.b)));
        boolean z = this.C.shouldMaskStartBounds(this.H);
        this.C.applyMask((z ? rectF1 : rectF2), (z ? p.d(0.0f, 1.0f, f13, f14, f, false) : 1.0f - p.d(0.0f, 1.0f, f13, f14, f, false)), this.H);
        ...
        h h0 = this.n;
        h0.getClass();
        float f15 = j0.d.getStart();
        float f16 = j0.d.getEnd();
        ShapeAppearanceModel shapeAppearanceModel0 = this.c;
        if(Float.compare(f, f15) >= 0) {
            shapeAppearanceModel0 = Float.compare(f, f16) <= 0 ? (shapeAppearanceModel0.getTopLeftCornerSize().getCornerSize(rectF0) != 0.0f || shapeAppearanceModel0.getTopRightCornerSize().getCornerSize(rectF0) != 0.0f || shapeAppearanceModel0.getBottomRightCornerSize().getCornerSize(rectF0) != 0.0f || shapeAppearanceModel0.getBottomLeftCornerSize().getCornerSize(rectF0) != 0.0f ? shapeAppearanceModel0 : this.g).toBuilder().setTopLeftCornerSize(new AbsoluteCornerSize(p.d(shapeAppearanceModel0.getTopLeftCornerSize().getCornerSize(rectF0), this.g.getTopLeftCornerSize().getCornerSize(rectF2), f15, f16, f, false))).setTopRightCornerSize(new AbsoluteCornerSize(p.d(shapeAppearanceModel0.getTopRightCornerSize().getCornerSize(rectF0), this.g.getTopRightCornerSize().getCornerSize(rectF2), f15, f16, f, false))).setBottomLeftCornerSize(new AbsoluteCornerSize(p.d(shapeAppearanceModel0.getBottomLeftCornerSize().getCornerSize(rectF0), this.g.getBottomLeftCornerSize().getCornerSize(rectF2), f15, f16, f, false))).setBottomRightCornerSize(new AbsoluteCornerSize(p.d(shapeAppearanceModel0.getBottomRightCornerSize().getCornerSize(rectF0), this.g.getBottomRightCornerSize().getCornerSize(rectF2), f15, f16, f, false))).build() : this.g;
        }
        h0.e = shapeAppearanceModel0;
        h0.d.calculatePath(shapeAppearanceModel0, 1.0f, rectF1, h0.b);
        h0.d.calculatePath(h0.e, 1.0f, rectF2, h0.c);
        h0.a.op(h0.b, h0.c, Path.Op.UNION);
        this.J = p.c(this.d, this.h, f);
        ...
        float f21 = (float)(((Float)Preconditions.checkNotNull(j0.a.a)));
        float f22 = (float)(((Float)Preconditions.checkNotNull(j0.a.b)));
    ...
    public final void draw(Canvas canvas0) {
        ...
        if(this.u && this.J > 0.0f) {
            canvas0.save();
            canvas0.clipPath(h0.a, Region.Op.DIFFERENCE);
            if(Build.VERSION.SDK_INT > 28) {
                ShapeAppearanceModel shapeAppearanceModel0 = h0.e;
                ...
                this.v.setShapeAppearanceModel(h0.e);
                this.v.draw(canvas0);
            }
            canvas0.restore();
        }
        canvas0.clipPath(h0.a);
