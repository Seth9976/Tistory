...
public final class FadeThroughProvider implements VisibilityAnimatorProvider {
    ...
    public Animator createAppear(@NonNull ViewGroup viewGroup0, @NonNull View view0) {
        ...
        ((ValueAnimator)animator0).addUpdateListener(new f(view0, 0.0f, f, f1, 1.0f, 1));
        animator0.addListener(new e(5, f, view0));
        return animator0;
    }
    ...
    public Animator createDisappear(@NonNull ViewGroup viewGroup0, @NonNull View view0) {
        ...
        float f1 = this.a;
        Animator animator0 = ValueAnimator.ofFloat(new float[]{0.0f, 1.0f});
        ((ValueAnimator)animator0).addUpdateListener(new f(view0, f, 0.0f, 0.0f, f1, 1));
        animator0.addListener(new e(5, f, view0));
        return animator0;
    }
