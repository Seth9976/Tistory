...
public final class j {
    ...
    public final void a(float f, float f1, float f2, boolean z, boolean z1) {
        ...
        this.b(f, z, z1, f1, f2, f3);
    }

    public final void b(float f, boolean z, boolean z1, float f1, float f2, float f3) {
        if(f2 <= 0.0f) {
            return;
        }
        ...
        k k0 = new k(1.401298E-45f, f, f1, f2, f3, z1);
        if(z) {
            if(this.d == null) {
                this.d = k0;
    ...
    public final l d() {
        ...
        for(int v = 0; true; ++v) {
            ...
            arrayList0.add(new k(((float)v) * f + (this.d.b - ((float)this.f) * f), k0.b, k0.c, k0.d, k0.f, k0.e));
        }
