...
public final class a {
    ...
    public a(int v, float f, float f1, float f2, int v1, float f3, int v2, float f4, int v3, float f5) {
        float f13;
        this.a = v;
        float f6 = MathUtils.clamp(f, f1, f2);
        this.b = f6;
        this.c = v1;
        this.e = f3;
        this.d = v2;
    ...
    public final String toString() {
        StringBuilder stringBuilder0 = new StringBuilder("Arrangement [priority=");
        stringBuilder0.append(this.a);
        stringBuilder0.append(", smallCount=");
        stringBuilder0.append(this.c);
        stringBuilder0.append(", smallSize=");
        stringBuilder0.append(this.b);
        stringBuilder0.append(", mediumCount=");
        stringBuilder0.append(this.d);
        stringBuilder0.append(", mediumSize=");
        stringBuilder0.append(this.e);
        stringBuilder0.append(", largeCount=");
        stringBuilder0.append(this.g);
        stringBuilder0.append(", largeSize=");
        stringBuilder0.append(this.f);
        stringBuilder0.append(", cost=");
        return androidx.room.a.h(this.h, "]", stringBuilder0);
    }
}
