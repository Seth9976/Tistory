...
public class FlowLayout extends ViewGroup {
    ...
    public int getRowIndex(@NonNull View view0) {
    ...
    public void onMeasure(int v, int v1) {
        ...
        for(int v11 = 0; v11 < this.getChildCount(); ++v11) {
            ...
            if(view0.getVisibility() != 8) {
                ...
                if(view0.getMeasuredWidth() + (v7 + v13) <= v6 - v9 || this.isSingleLine()) {
                    v15 = v7;
                }
                else {
                ...
                int v16 = view0.getMeasuredWidth() + (v15 + v13);
                int v17 = view0.getMeasuredHeight();
                if(v16 > v12) {
                    v12 = v16;
                }
                int v18 = view0.getMeasuredWidth() + (v13 + v14) + this.b + v15;
        ...
        int v19 = this.getPaddingRight() + v12;
        int v20 = this.getPaddingBottom() + v8;
        if(v3 == 0x80000000) {
            v2 = Math.min(v19, v2);
        }
