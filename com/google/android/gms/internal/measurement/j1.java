...
public abstract class j1 {
    ...
    public static void a(StringBuilder stringBuilder0, int v, String s, Object object0) {
        if(object0 instanceof List) {
            for(Object object1: ((List)object0)) {
                j1.a(stringBuilder0, v, s, object1);
            }
            return;
        }
        if(object0 instanceof Map) {
            for(Object object2: ((Map)object0).entrySet()) {
                j1.a(stringBuilder0, v, s, ((Map.Entry)object2));
            }
            return;
        }
        stringBuilder0.append('\n');
        j1.b(v, stringBuilder0);
        if(!s.isEmpty()) {
        ...
        if(object0 instanceof String) {
            stringBuilder0.append(": \"");
            stringBuilder0.append(n0.b(zzje.zzm(((String)object0))));
            stringBuilder0.append('\"');
            return;
        }
        if(object0 instanceof zzje) {
            stringBuilder0.append(": \"");
            stringBuilder0.append(n0.b(((zzje)object0)));
            stringBuilder0.append('\"');
            return;
        }
        if(object0 instanceof zzkf) {
            stringBuilder0.append(" {");
            j1.c(((zzkf)object0), stringBuilder0, v + 2);
            stringBuilder0.append("\n");
            j1.b(v, stringBuilder0);
            stringBuilder0.append("}");
            return;
        ...
        if(object0 instanceof Map.Entry) {
            stringBuilder0.append(" {");
            j1.a(stringBuilder0, v + 2, "key", ((Map.Entry)object0).getKey());
            j1.a(stringBuilder0, v + 2, "value", ((Map.Entry)object0).getValue());
            stringBuilder0.append("\n");
            j1.b(v, stringBuilder0);
            stringBuilder0.append("}");
            return;
    ...
    public static void b(int v, StringBuilder stringBuilder0) {
        while(true) {
            ...
            stringBuilder0.append(j1.a, 0, v1);
            v -= v1;
        }
    }

    public static void c(zzkf zzkf0, StringBuilder stringBuilder0, int v) {
        boolean z;
        HashSet hashSet0 = new HashSet();
        HashMap hashMap0 = new HashMap();
        TreeMap treeMap0 = new TreeMap();
        Method[] arr_method = zzkf0.getClass().getDeclaredMethods();
        ...
        for(Object object0: treeMap0.entrySet()) {
            ...
            if(s.endsWith("List") && !s.endsWith("OrBuilderList") && !s.equals("List")) {
                ...
                if(method1 != null && method1.getReturnType().equals(List.class)) {
                    j1.a(stringBuilder0, v, s.substring(0, s.length() - 4), zzkf.c(method1, zzkf0, new Object[0]));
                    continue;
                }
            }
            if(s.endsWith("Map") && !s.equals("Map")) {
                ...
                if(method2 != null && method2.getReturnType().equals(Map.class) && !method2.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method2.getModifiers())) {
                    j1.a(stringBuilder0, v, s.substring(0, s.length() - 3), zzkf.c(method2, zzkf0, new Object[0]));
                    continue;
                }
            }
            if(hashSet0.contains("set" + s) && (!s.endsWith("Bytes") || !treeMap0.containsKey("get" + s.substring(0, s.length() - 5)))) {
                ...
                if(method3 != null) {
                    Object object1 = zzkf.c(method3, zzkf0, new Object[0]);
                    if(method4 == null) {
                        if(object1 instanceof Boolean) {
                            ...
                            if(object1 instanceof zzje) {
                                z = object1.equals(zzje.zzb);
                            label_58:
                                if(z) {
                                    continue;
                                }
                            }
                            else if(object1 instanceof zzlm) {
                                if(object1 == ((zzlm)object1).zzbS()) {
                                    continue;
                                }
                            }
                    ...
                    label_65:
                        if(((Boolean)zzkf.c(method4, zzkf0, new Object[0])).booleanValue()) {
                            goto label_66;
                        }
                        continue;
                    }
        ...
        if(!(zzkf0 instanceof zzkc)) {
            zzmp zzmp0 = zzkf0.zzc;
            if(zzmp0 != null) {
                for(int v1 = 0; v1 < zzmp0.a; ++v1) {
                    j1.a(stringBuilder0, v, String.valueOf(zzmp0.b[v1] >>> 3), zzmp0.c[v1]);
                }
            }
            return;
        }
        zzkc zzkc0 = (zzkc)zzkf0;
        throw null;
    }
}
