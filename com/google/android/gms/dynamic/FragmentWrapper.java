...
public final class FragmentWrapper extends Stub {
    ...
    public static FragmentWrapper wrap(@Nullable Fragment fragment0) {
        if(fragment0 != null) {
            FragmentWrapper fragmentWrapper0 = new FragmentWrapper();  // 初始化器: Lcom/google/android/gms/dynamic/IFragmentWrapper$Stub;-><init>()V
            fragmentWrapper0.a = fragment0;
            return fragmentWrapper0;
        }
        return null;
    }
    ...
    public final IFragmentWrapper zze() {
        return FragmentWrapper.wrap(this.a.getParentFragment());
    }

    @Override  // com.google.android.gms.dynamic.IFragmentWrapper
    @Nullable
    public final IFragmentWrapper zzf() {
        return FragmentWrapper.wrap(this.a.getTargetFragment());
    }
