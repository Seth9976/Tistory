...
public final class ByteArrayBuilder extends PrimitiveArrayBuilder {
    ...
    public void ensureCapacity$kotlinx_serialization_core(int v) {
        byte[] arr_b = this.a;
        if(arr_b.length < v) {
            byte[] arr_b1 = Arrays.copyOf(arr_b, c.coerceAtLeast(v, arr_b.length * 2));
