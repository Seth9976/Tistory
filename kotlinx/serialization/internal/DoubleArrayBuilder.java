...
public final class DoubleArrayBuilder extends PrimitiveArrayBuilder {
    ...
    public double[] build$kotlinx_serialization_core() {
        double[] arr_f = Arrays.copyOf(this.a, this.getPosition$kotlinx_serialization_core());
    ...
    public void ensureCapacity$kotlinx_serialization_core(int v) {
        double[] arr_f = this.a;
        if(arr_f.length < v) {
            double[] arr_f1 = Arrays.copyOf(arr_f, c.coerceAtLeast(v, arr_f.length * 2));
