...
public final class ReferenceArraySerializer extends CollectionLikeSerializer {
    ...
    public ReferenceArraySerializer(@NotNull KClass kClass0, @NotNull KSerializer kSerializer0) {
        ...
        this.b = kClass0;
        this.c = new ArrayClassDesc(kSerializer0.getDescriptor());
    }
    ...
    public ArrayList toBuilder(@NotNull Object[] arr_object) {
        Intrinsics.checkNotNullParameter(arr_object, "<this>");
        return new ArrayList(ArraysKt___ArraysJvmKt.asList(arr_object));
    }
    ...
    public Object[] toResult(@NotNull ArrayList arrayList0) {
        Intrinsics.checkNotNullParameter(arrayList0, "<this>");
        return PlatformKt.toNativeArrayImpl(arrayList0, this.b);
    }
}
