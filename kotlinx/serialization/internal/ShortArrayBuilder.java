...
public final class ShortArrayBuilder extends PrimitiveArrayBuilder {
    ...
    public void ensureCapacity$kotlinx_serialization_core(int v) {
        short[] arr_v = this.a;
        if(arr_v.length < v) {
            short[] arr_v1 = Arrays.copyOf(arr_v, c.coerceAtLeast(v, arr_v.length * 2));
