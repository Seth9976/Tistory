...
public final class LongArrayBuilder extends PrimitiveArrayBuilder {
    ...
    public void ensureCapacity$kotlinx_serialization_core(int v) {
        long[] arr_v = this.a;
        if(arr_v.length < v) {
            long[] arr_v1 = Arrays.copyOf(arr_v, c.coerceAtLeast(v, arr_v.length * 2));
