...
public final class ExtensionsKt {
    ...
    public static final PersistentCollection minus(@NotNull PersistentCollection persistentCollection0, @NotNull Iterable iterable0) {
        ...
        kotlinx.collections.immutable.PersistentCollection.Builder persistentCollection$Builder0 = persistentCollection0.builder();
    ...
    public static final PersistentList minus(@NotNull PersistentList persistentList0, @NotNull Iterable iterable0) {
        ...
        kotlinx.collections.immutable.PersistentList.Builder persistentList$Builder0 = persistentList0.builder();
    ...
    public static final PersistentMap minus(@NotNull PersistentMap persistentMap0, @NotNull Iterable iterable0) {
        ...
        kotlinx.collections.immutable.PersistentMap.Builder persistentMap$Builder0 = persistentMap0.builder();
    ...
    public static final PersistentMap persistentHashMapOf(@NotNull Pair[] arr_pair) {
        ...
        Intrinsics.checkNotNull(persistentHashMap0, "null cannot be cast to non-null type kotlinx.collections.immutable.PersistentMap<K of kotlinx.collections.immutable.ExtensionsKt.mutate, V of kotlinx.collections.immutable.ExtensionsKt.mutate>");
        kotlinx.collections.immutable.PersistentMap.Builder persistentMap$Builder0 = persistentHashMap0.builder();
    ...
    public static final PersistentSet persistentHashSetOf(@NotNull Object[] arr_object) {
        Intrinsics.checkNotNullParameter(arr_object, "elements");
        return PersistentHashSet.Companion.emptyOf$kotlinx_collections_immutable().addAll(ArraysKt___ArraysJvmKt.asList(arr_object));
    }
    ...
    public static final PersistentMap persistentMapOf(@NotNull Pair[] arr_pair) {
        Intrinsics.checkNotNullParameter(arr_pair, "pairs");
        PersistentOrderedMap persistentOrderedMap0 = PersistentOrderedMap.Companion.emptyOf$kotlinx_collections_immutable();
        Intrinsics.checkNotNull(persistentOrderedMap0, "null cannot be cast to non-null type kotlinx.collections.immutable.PersistentMap<K of kotlinx.collections.immutable.ExtensionsKt.mutate, V of kotlinx.collections.immutable.ExtensionsKt.mutate>");
        kotlinx.collections.immutable.PersistentMap.Builder persistentMap$Builder0 = persistentOrderedMap0.builder();
        x.putAll(persistentMap$Builder0, arr_pair);
        return persistentMap$Builder0.build();
    }
    ...
    public static final PersistentSet persistentSetOf(@NotNull Object[] arr_object) {
        Intrinsics.checkNotNullParameter(arr_object, "elements");
        return PersistentOrderedSet.Companion.emptyOf$kotlinx_collections_immutable().addAll(ArraysKt___ArraysJvmKt.asList(arr_object));
    }
    ...
    public static final ImmutableMap toImmutableMap(@NotNull Map map0) {
        ...
        if(immutableMap0 == null) {
            kotlinx.collections.immutable.PersistentMap.Builder persistentMap$Builder0 = map0 instanceof kotlinx.collections.immutable.PersistentMap.Builder ? ((kotlinx.collections.immutable.PersistentMap.Builder)map0) : null;
    ...
    public static final PersistentMap toPersistentHashMap(@NotNull Map map0) {
        ...
        if(persistentMap0 == null) {
            ...
            return persistentHashMap0 != null ? persistentHashMap0 : PersistentHashMap.Companion.emptyOf$kotlinx_collections_immutable().putAll(map0);
        }
    ...
    public static final PersistentSet toPersistentHashSet(@NotNull Iterable iterable0) {
        ...
        if(persistentSet0 == null) {
            ...
            return persistentHashSet0 != null ? persistentHashSet0 : ExtensionsKt.plus(PersistentHashSet.Companion.emptyOf$kotlinx_collections_immutable(), iterable0);
        }
    ...
    public static final PersistentList toPersistentList(@NotNull CharSequence charSequence0) {
        Intrinsics.checkNotNullParameter(charSequence0, "<this>");
        kotlinx.collections.immutable.PersistentList.Builder persistentList$Builder0 = ExtensionsKt.persistentListOf().builder();
    ...
    public static final PersistentList toPersistentList(@NotNull Iterable iterable0) {
        ...
        if(persistentList1 == null) {
            kotlinx.collections.immutable.PersistentList.Builder persistentList$Builder0 = iterable0 instanceof kotlinx.collections.immutable.PersistentList.Builder ? ((kotlinx.collections.immutable.PersistentList.Builder)iterable0) : null;
    ...
    public static final PersistentMap toPersistentMap(@NotNull Map map0) {
        ...
        if(persistentMap1 == null) {
            ...
            return persistentMap0 == null ? PersistentOrderedMap.Companion.emptyOf$kotlinx_collections_immutable().putAll(map0) : persistentMap0;
        }
    ...
    public static final PersistentSet toPersistentSet(@NotNull Iterable iterable0) {
        ...
        if(persistentSet1 == null) {
            ...
            return persistentSet0 == null ? ExtensionsKt.plus(PersistentOrderedSet.Companion.emptyOf$kotlinx_collections_immutable(), iterable0) : persistentSet0;
        }
