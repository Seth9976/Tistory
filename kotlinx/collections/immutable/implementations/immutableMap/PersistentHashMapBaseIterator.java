...
public abstract class PersistentHashMapBaseIterator implements Iterator, KMappedMarker {
    ...
    public PersistentHashMapBaseIterator(@NotNull TrieNode trieNode0, @NotNull TrieNodeBaseIterator[] arr_trieNodeBaseIterator) {
        ...
        this.c = true;
        arr_trieNodeBaseIterator[0].reset(trieNode0.getBuffer$kotlinx_collections_immutable(), trieNode0.entryCount$kotlinx_collections_immutable() * 2);
        this.b = 0;
        this.a();
    }
    ...
    public final void a() {
        ...
        for(int v = this.b; -1 < v; --v) {
            ...
            arr_trieNodeBaseIterator[v].reset(TrieNode.Companion.getEMPTY$kotlinx_collections_immutable().getBuffer$kotlinx_collections_immutable(), 0);
        }
        this.c = false;
    }
    ...
    public final int b(int v) {
        ...
        if(arr_trieNodeBaseIterator[v].hasNextNode()) {
            ...
            if(v == 6) {
                arr_trieNodeBaseIterator[7].reset(trieNode0.getBuffer$kotlinx_collections_immutable(), trieNode0.getBuffer$kotlinx_collections_immutable().length);
                return this.b(7);
            }
            arr_trieNodeBaseIterator[v + 1].reset(trieNode0.getBuffer$kotlinx_collections_immutable(), trieNode0.entryCount$kotlinx_collections_immutable() * 2);
            return this.b(v + 1);
        }
        return -1;
    }
