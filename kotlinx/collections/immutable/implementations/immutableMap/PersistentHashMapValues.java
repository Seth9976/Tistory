...
public final class PersistentHashMapValues extends AbstractCollection implements ImmutableCollection {
    ...
    public PersistentHashMapValues(@NotNull PersistentHashMap persistentHashMap0) {
    ...
    public Iterator iterator() {
        return new PersistentHashMapValuesIterator(this.a.getNode$kotlinx_collections_immutable());
    }
}
