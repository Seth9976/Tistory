...
public final class PersistentOrderedMapKeysIterator implements Iterator, KMappedMarker {
    ...
    public Object next() {
        this.a.next();
        return this.a.getNextKey$kotlinx_collections_immutable();
    }
