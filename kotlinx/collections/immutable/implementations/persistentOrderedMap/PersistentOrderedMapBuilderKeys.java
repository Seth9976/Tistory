...
public final class PersistentOrderedMapBuilderKeys extends AbstractMutableSet implements Set, KMutableSet {
    ...
    public PersistentOrderedMapBuilderKeys(@NotNull PersistentOrderedMapBuilder persistentOrderedMapBuilder0) {
    ...
    public boolean remove(Object object0) {
        PersistentOrderedMapBuilder persistentOrderedMapBuilder0 = this.a;
        if(persistentOrderedMapBuilder0.containsKey(object0)) {
            persistentOrderedMapBuilder0.remove(object0);
            return true;
        }
        return false;
    }
