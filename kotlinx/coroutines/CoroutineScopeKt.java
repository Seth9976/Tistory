...
public final class CoroutineScopeKt {
    @NotNull
    public static final CoroutineScope CoroutineScope(@NotNull CoroutineContext coroutineContext0) {
    ...
    @Nullable
    public static final Object coroutineScope(@NotNull Function2 function20, @NotNull Continuation continuation0) {
    ...
    @Nullable
    public static final Object currentCoroutineContext(@NotNull Continuation continuation0) {
    ...
    @NotNull
    public static final CoroutineScope plus(@NotNull CoroutineScope coroutineScope0, @NotNull CoroutineContext coroutineContext0) {
