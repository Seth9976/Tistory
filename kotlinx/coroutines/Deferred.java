...
public interface Deferred extends Job {
    ...
    public static final class DefaultImpls {
        public static Object fold(@NotNull Deferred deferred0, Object object0, @NotNull Function2 function20) {
            return kotlinx.coroutines.Job.DefaultImpls.fold(deferred0, object0, function20);
        }

        @Nullable
        public static Element get(@NotNull Deferred deferred0, @NotNull Key coroutineContext$Key0) {
            return kotlinx.coroutines.Job.DefaultImpls.get(deferred0, coroutineContext$Key0);
        }

        @NotNull
        public static CoroutineContext minusKey(@NotNull Deferred deferred0, @NotNull Key coroutineContext$Key0) {
            return kotlinx.coroutines.Job.DefaultImpls.minusKey(deferred0, coroutineContext$Key0);
        }

        @NotNull
        public static CoroutineContext plus(@NotNull Deferred deferred0, @NotNull CoroutineContext coroutineContext0) {
        ...
        @NotNull
        public static Job plus(@NotNull Deferred deferred0, @NotNull Job job0) {
            return job0;
        }
    }
