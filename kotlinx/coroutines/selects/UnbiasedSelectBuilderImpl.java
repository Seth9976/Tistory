...
public final class UnbiasedSelectBuilderImpl extends UnbiasedSelectImplementation {
    ...
    public UnbiasedSelectBuilderImpl(@NotNull Continuation continuation0) {
        super(continuation0.getContext());
        this.h = new CancellableContinuationImpl(IntrinsicsKt__IntrinsicsJvmKt.intercepted(continuation0), 1);
    }

    public static final CancellableContinuationImpl access$getCont$p(UnbiasedSelectBuilderImpl unbiasedSelectBuilderImpl0) {
        return unbiasedSelectBuilderImpl0.h;
    }
    ...
    public final Object initSelectResult() {
        CancellableContinuationImpl cancellableContinuationImpl0 = this.h;
        ...
        BuildersKt.launch$default(coroutineScope0, null, CoroutineStart.UNDISPATCHED, f0, 1, null);
        return cancellableContinuationImpl0.getResult();
    }
}
