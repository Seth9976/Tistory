...
public final class FlowKt__TransformKt.filterNotNull..inlined.unsafeTransform.1 implements Flow {
    ...
    public FlowKt__TransformKt.filterNotNull..inlined.unsafeTransform.1(Flow flow0) {
        this.a = flow0;
        super();
    }
    ...
    public Object collect(@NotNull FlowCollector flowCollector0, @NotNull Continuation continuation0) {
        kotlinx.coroutines.flow.FlowKt__TransformKt.filterNotNull..inlined.unsafeTransform.1.2 flowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$20 = new FlowCollector() {
            ...
            public final Object emit(Object object0, @NotNull Continuation continuation0) {
                ...
                if(continuation0 instanceof kotlinx.coroutines.flow.FlowKt__TransformKt.filterNotNull..inlined.unsafeTransform.1.2.1) {
                    ...
                    int v = flowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$2$10.p;
                    if((v & 0x80000000) == 0) {
                        ...
                        flowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$2$10.p = v ^ 0x80000000;
                    }
                }
                else {
                    flowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$2$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                ...
                Object object1 = flowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$2$10.o;
                Object object2 = a.getCOROUTINE_SUSPENDED();
                switch(flowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$2$10.p) {
                    case 0: {
                        ResultKt.throwOnFailure(object1);
                        if(object0 != null) {
                            flowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$2$10.p = 1;
                            if(this.a.emit(object0, flowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$2$10) == object2) {
                                return object2;
                            }
                        }
        ...
        Object object0 = this.a.collect(flowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$20, continuation0);
