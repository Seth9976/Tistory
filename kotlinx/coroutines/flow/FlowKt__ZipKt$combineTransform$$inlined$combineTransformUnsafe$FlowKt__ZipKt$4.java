...
public final class FlowKt__ZipKt.combineTransform..inlined.combineTransformUnsafe.FlowKt__ZipKt.4 extends SuspendLambda implements Function2 {
    ...
    public FlowKt__ZipKt.combineTransform..inlined.combineTransformUnsafe.FlowKt__ZipKt.4(Flow[] arr_flow, Continuation continuation0, Function6 function60) {
        this.q = arr_flow;
        this.r = function60;
    ...
    public final Continuation create(@Nullable Object object0, @NotNull Continuation continuation0) {
        Continuation continuation1 = new FlowKt__ZipKt.combineTransform..inlined.combineTransformUnsafe.FlowKt__ZipKt.4(this.q, continuation0, this.r);
    ...
    public final Object invoke(@NotNull FlowCollector flowCollector0, @Nullable Continuation continuation0) {
        return ((FlowKt__ZipKt.combineTransform..inlined.combineTransformUnsafe.FlowKt__ZipKt.4)this.create(flowCollector0, continuation0)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object object0) {
        ...
        switch(this.o) {
            case 0: {
                ...
                kotlinx.coroutines.flow.FlowKt__ZipKt.combineTransform..inlined.combineTransformUnsafe.FlowKt__ZipKt.4.1 flowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4$10 = new Function3(this.r) {
                    public int o;
                    ...
                    public final Object invoke(@NotNull FlowCollector flowCollector0, @NotNull Object[] arr_object, @Nullable Continuation continuation0) {
                        ...
                        flowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4$10.p = flowCollector0;
                        flowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4$10.q = arr_object;
                    ...
                    public final Object invokeSuspend(@NotNull Object object0) {
                        ...
                        switch(this.o) {
                            case 0: {
                                ResultKt.throwOnFailure(object0);
                                this.o = 1;
                                return this.r.invoke(this.p, this.q[0], this.q[1], this.q[2], this.q[3], this) == object1 ? object1 : Unit.INSTANCE;
                            }
                            case 1: {
                                ResultKt.throwOnFailure(object0);
                ...
                this.o = 1;
                return CombineKt.combineInternal(flowCollector0, this.q, i2.w, flowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4$10, this) == object1 ? object1 : Unit.INSTANCE;
            }
            case 1: {
                ResultKt.throwOnFailure(object0);
                return Unit.INSTANCE;
