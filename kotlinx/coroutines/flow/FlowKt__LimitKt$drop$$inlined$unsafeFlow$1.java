...
public final class FlowKt__LimitKt.drop..inlined.unsafeFlow.1 implements Flow {
    ...
    public FlowKt__LimitKt.drop..inlined.unsafeFlow.1(Flow flow0, int v) {
        this.a = flow0;
        this.b = v;
        super();
    }
    ...
    public Object collect(@NotNull FlowCollector flowCollector0, @NotNull Continuation continuation0) {
        w0 w00 = new w0(new IntRef(), this.b, flowCollector0);
        Object object0 = this.a.collect(w00, continuation0);
