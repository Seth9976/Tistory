...
public final class FlowKt__ReduceKt.singleOrNull..inlined.collectWhile.1 implements FlowCollector {
    public final ObjectRef a;

    public FlowKt__ReduceKt.singleOrNull..inlined.collectWhile.1(ObjectRef ref$ObjectRef0) {
    ...
    public Object emit(Object object0, @NotNull Continuation continuation0) {
        ...
        if(ref$ObjectRef0.element == symbol0) {
            ref$ObjectRef0.element = object0;
            return Unit.INSTANCE;
        }
        ref$ObjectRef0.element = symbol0;
