...
public final class FlowKt__MergeKt.flatMapMerge..inlined.map.1 implements Flow {
    ...
    public FlowKt__MergeKt.flatMapMerge..inlined.map.1(Flow flow0, Function2 function20) {
        this.a = flow0;
        this.b = function20;
        super();
    }
        ...
        kotlinx.coroutines.flow.FlowKt__MergeKt.flatMapMerge..inlined.map.1.2 flowKt__MergeKt$flatMapMerge$$inlined$map$1$20 = new FlowCollector() {
            ...
            public final Object emit(Object object0, @NotNull Continuation continuation0) {
                ...
                if(continuation0 instanceof kotlinx.coroutines.flow.FlowKt__MergeKt.flatMapMerge..inlined.map.1.2.1) {
                    ...
                    int v = flowKt__MergeKt$flatMapMerge$$inlined$map$1$2$10.p;
                    if((v & 0x80000000) == 0) {
                        ...
                        flowKt__MergeKt$flatMapMerge$$inlined$map$1$2$10.p = v ^ 0x80000000;
                    }
                }
                else {
                    flowKt__MergeKt$flatMapMerge$$inlined$map$1$2$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                ...
                Object object1 = flowKt__MergeKt$flatMapMerge$$inlined$map$1$2$10.o;
                Object object2 = a.getCOROUTINE_SUSPENDED();
                switch(flowKt__MergeKt$flatMapMerge$$inlined$map$1$2$10.p) {
                    case 0: {
                        ResultKt.throwOnFailure(object1);
                        FlowCollector flowCollector0 = this.b;
                        flowKt__MergeKt$flatMapMerge$$inlined$map$1$2$10.q = flowCollector0;
                        flowKt__MergeKt$flatMapMerge$$inlined$map$1$2$10.p = 1;
                        Object object3 = this.b.invoke(object0, flowKt__MergeKt$flatMapMerge$$inlined$map$1$2$10);
                        if(object3 == object2) {
                            return object2;
                        }
                        object1 = object3;
                    ...
                    case 1: {
                        flowCollector1 = flowKt__MergeKt$flatMapMerge$$inlined$map$1$2$10.q;
                        ResultKt.throwOnFailure(object1);
                        break;
                    }
                    case 2: {
                ...
                flowKt__MergeKt$flatMapMerge$$inlined$map$1$2$10.q = null;
                flowKt__MergeKt$flatMapMerge$$inlined$map$1$2$10.p = 2;
                return flowCollector1.emit(object1, flowKt__MergeKt$flatMapMerge$$inlined$map$1$2$10) == object2 ? object2 : Unit.INSTANCE;
            }
        };
        Object object0 = this.a.collect(flowKt__MergeKt$flatMapMerge$$inlined$map$1$20, continuation0);
