...
public final class FlowKt__ZipKt.combineTransform..inlined.combineTransformUnsafe.FlowKt__ZipKt.2 extends SuspendLambda implements Function2 {
    ...
    public FlowKt__ZipKt.combineTransform..inlined.combineTransformUnsafe.FlowKt__ZipKt.2(Flow[] arr_flow, Continuation continuation0, Function4 function40) {
        this.q = arr_flow;
        this.r = function40;
    ...
    public final Continuation create(@Nullable Object object0, @NotNull Continuation continuation0) {
        Continuation continuation1 = new FlowKt__ZipKt.combineTransform..inlined.combineTransformUnsafe.FlowKt__ZipKt.2(this.q, continuation0, this.r);
    ...
    public final Object invoke(@NotNull FlowCollector flowCollector0, @Nullable Continuation continuation0) {
        return ((FlowKt__ZipKt.combineTransform..inlined.combineTransformUnsafe.FlowKt__ZipKt.2)this.create(flowCollector0, continuation0)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object object0) {
        ...
        switch(this.o) {
            case 0: {
                ...
                kotlinx.coroutines.flow.FlowKt__ZipKt.combineTransform..inlined.combineTransformUnsafe.FlowKt__ZipKt.2.1 flowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2$10 = new Function3(this.r) {
                    public int o;
                    ...
                    public final Object invoke(@NotNull FlowCollector flowCollector0, @NotNull Object[] arr_object, @Nullable Continuation continuation0) {
                        ...
                        flowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2$10.p = flowCollector0;
                        flowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2$10.q = arr_object;
                ...
                this.o = 1;
                return CombineKt.combineInternal(flowCollector0, this.q, i2.w, flowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2$10, this) == object1 ? object1 : Unit.INSTANCE;
            }
            case 1: {
                ResultKt.throwOnFailure(object0);
                return Unit.INSTANCE;
