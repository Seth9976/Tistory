...
public abstract class AbstractTimeSource {
    ...
    public abstract void parkNanos(@NotNull Object arg1, long arg2);
    ...
    public abstract void unpark(@NotNull Thread arg1);

    public abstract void unregisterTimeLoopThread();

    @NotNull
    public abstract Runnable wrapTask(@NotNull Runnable arg1);
}
