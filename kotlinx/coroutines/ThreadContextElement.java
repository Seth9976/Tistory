...
public interface ThreadContextElement extends Element {
    ...
    public static final class DefaultImpls {
        public static Object fold(@NotNull ThreadContextElement threadContextElement0, Object object0, @NotNull Function2 function20) {
            return kotlin.coroutines.CoroutineContext.Element.DefaultImpls.fold(threadContextElement0, object0, function20);
        }

        @Nullable
        public static Element get(@NotNull ThreadContextElement threadContextElement0, @NotNull Key coroutineContext$Key0) {
            return kotlin.coroutines.CoroutineContext.Element.DefaultImpls.get(threadContextElement0, coroutineContext$Key0);
        }

        @NotNull
        public static CoroutineContext minusKey(@NotNull ThreadContextElement threadContextElement0, @NotNull Key coroutineContext$Key0) {
            return kotlin.coroutines.CoroutineContext.Element.DefaultImpls.minusKey(threadContextElement0, coroutineContext$Key0);
        }

        @NotNull
        public static CoroutineContext plus(@NotNull ThreadContextElement threadContextElement0, @NotNull CoroutineContext coroutineContext0) {
            return kotlin.coroutines.CoroutineContext.Element.DefaultImpls.plus(threadContextElement0, coroutineContext0);
        }
    }

    void restoreThreadContext(@NotNull CoroutineContext arg1, Object arg2);

    Object updateThreadContext(@NotNull CoroutineContext arg1);
}
