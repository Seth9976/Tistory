...
public final class BouncyCastleSocketAdapter implements SocketAdapter {
    ...
    public static final BouncyCastleSocketAdapter.Companion.factory.1 a;

    static {
        BouncyCastleSocketAdapter.Companion = new Companion(null);
        BouncyCastleSocketAdapter.a = new BouncyCastleSocketAdapter.Companion.factory.1();  // 初始化器: Ljava/lang/Object;-><init>()V
    }
